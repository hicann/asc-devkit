...
相关规则参见[L1与Fixpipe Buffer数据搬运](../../../../../docs/zh/api/SIMD-API/basic_api/data_move_guide/L1_Fixpipe_data_move.md)和
[随路量化](../../../../../docs/zh/api/SIMD-API/basic_api/cube_compute_ISASI/cube_store_key_features/accompanying_quantization.md)。
