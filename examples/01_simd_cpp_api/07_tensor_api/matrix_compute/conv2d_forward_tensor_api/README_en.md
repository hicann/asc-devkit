...
- Configure environment variables
  ...
  Refer to the CANN development kit [installation guide](https://gitcode.com/cann/asc-devkit/blob/master/docs/en/quick_start.md) to configure environment variables.
  ```bash
