...
## Overview
This example implements the Truncate operation based on the Reg programming interface, which truncates floating-point numbers in a RegTensor (the basic unit of Reg vector computation) to integer values. It primarily calls the Truncate API.
...
- Example specifications:
  ...
  <tr><td rowspan="1" align="center">Kernel Function Name</td><td colspan="4" align="center">truncate</td></tr>
  </table>
- Example implementation:
   The TruncateVF function calls the Truncate API for computation and writes the result back to UB
