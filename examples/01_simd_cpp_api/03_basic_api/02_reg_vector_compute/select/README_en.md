...
## Overview
This example implements the Select operation based on the Reg programming interface, primarily calling the Select API.
...
- Example implementation:
   The SelectVF function calls the Select API for computation and writes the result back to UB
