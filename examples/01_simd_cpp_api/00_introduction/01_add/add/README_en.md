...
Call the [printf](../../../../../docs/zh/api/Utils-API/tuning_interface/printf.md) interface at the location in the operator kernel-side implementation code where log information needs to be output.
