# Matmul Self-Managed CO1 Direct Invocation Example
## Overview
A Matmul example where the user manages CO1 (L0C Buffer) independently. The computation result C matrix is stored in the CO1 position, and then the basic API Fixpipe is called to transfer the result from CO1 to Global Memory.
