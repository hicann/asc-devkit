# PhiloxRandom Example

## Overview

This example uses the PhiloxRandom high-level API to implement random number generation, supporting the generation of a specified number of random numbers based on the Philox algorithm. It is applicable to scenarios that require high-quality random numbers.
...
│   ├── philoxrandom.asc        // Ascend C example implementation & invocation example
...
- Example function:  
  Based on the Philox random number generation algorithm, given a random seed, generate a specified number of random numbers.
- Example specifications:  
  <table>
  <caption>Table 1: Example Input/Output Specifications</caption>
  <tr><td rowspan="1" align="center">Example Type (OpType)</td><td colspan="4" align="center"> philoxrandom </td></tr>
...
- Example implementation:  
  This example implements a philoxrandom_custom example with a fixed output shape of dst[1, 1280].

  - Kernel implementation

    The computation logic includes the following steps:
    1. Allocate output space in Local Memory (Unified Buffer).
    2. Initialize the output space by clearing it.
    3. Use the PhiloxRandom high-level API to generate random numbers.
    4. Transfer the generated random numbers from Local Memory to Global Memory.
