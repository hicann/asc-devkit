...
- 样例实现：  
  本样例中实现的是固定shape为输入input_x[1, 256]，input_y[1, 256]，输出output_z[1, 256]的fill样例，所用API详细介绍请参考[Fill API文档](../../../../../docs/zh/api/SIMD-API/adv_api/tensor_transform/Fill-97.md)。
