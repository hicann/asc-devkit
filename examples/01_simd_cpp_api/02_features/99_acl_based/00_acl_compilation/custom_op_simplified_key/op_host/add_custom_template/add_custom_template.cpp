...
static ge::graphStatus GenSimplifiedKeyFunc(gert::TilingContext* context, ge::char_t* simplifiedKey)
{
    ...
    return strcpy_s(simplifiedKey, CUSTOM_SIMPLIFIED_KEY_MAX_LEN, key) == EOK ? ge::GRAPH_SUCCESS : ge::GRAPH_FAILED;
}
} // namespace optiling
