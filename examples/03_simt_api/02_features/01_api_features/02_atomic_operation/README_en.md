...
| ------------------------------------------------------------ | ---------------------------------------------------- |
| [histogram](./histogram) | A Histogram sample implemented using SIMT programming, demonstrating the usage of the [`asc_atomic_add()`](../../../../../docs/zh/api/SIMT-API/atomic_operations/asc_atomic_add.md) interface.|
