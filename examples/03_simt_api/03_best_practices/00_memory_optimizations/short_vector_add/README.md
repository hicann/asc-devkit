...
| 优化手段 | 核心原理              | 适用场景                                                                                                                                                                                                                                                                                                                                               |
|:-----|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 短向量  | 底层指令支持一次完成两个数据的计算 | 1、half/bfloat16_t类型元素进行[基本运算](../../../../../docs/zh/guide/编程指南/语言扩展层/SIMT-BuiltIn关键字.md#运算符)，更多短向量类型参见[完整类型列表](../../../../../docs/zh/api/SIMT-API/SIMT_programming_intro/extended_syntax/builtin_data_types.md#短向量类型) |
