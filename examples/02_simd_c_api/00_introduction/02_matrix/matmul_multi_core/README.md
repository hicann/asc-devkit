...
- 样例实现：
  ...
  - Kernel侧详细流程
    ...
    - 最后调用[`asc_sync_pipe`](../../../../../docs/zh/api/SIMD-API/c_api/sync/asc_sync_pipe.md)`(PIPE_ALL)`，确保当前核内相关流水任务完成。
