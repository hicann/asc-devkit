...
| [data_copy_ub2l1](./data_copy_ub2l1) | This example demonstrates using `asc_copy_ub2l1` to move matrix data from UB (Unified Buffer) to L1 (L1 Buffer), including UB-to-L1 matrix multiplication scenarios with non-aligned shapes and a GM->UB->L1 Buffer->UB->GM bidirectional data path scenario. | Ascend 950PR/Ascend 950DT |
