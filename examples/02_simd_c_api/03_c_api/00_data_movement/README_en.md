...
| [data_copy_ub2l1](./data_copy_ub2l1) | This example keeps the original Nz-input and ND-input UB (Unified Buffer) to L1 (L1 Buffer) matrix multiplication scenarios with a non-aligned shape, and adds a GM->UB->L1->UB->GM bidirectional-path scenario. | Ascend 950PR/Ascend 950DT |
