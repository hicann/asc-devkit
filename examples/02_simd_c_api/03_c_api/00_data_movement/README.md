...
| [data_copy_ub2l1](./data_copy_ub2l1) | 本样例展示矩阵乘计算中从UB（Unified Buffer）到L1（L1 Buffer）的数据搬运，包括直接连续搬运，以及先在UB中将ND格式的数据重排为Nz格式后再搬运到L1两种方式。 | Ascend 950PR/Ascend 950DT |
