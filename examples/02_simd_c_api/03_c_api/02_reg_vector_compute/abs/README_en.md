...
## Overview
This example implements the Abs operation based on the C API programming interface, primarily calling the [asc_abs](../../../../../docs/zh/api/SIMD-API/C-API/reg/arithmetic_compute/asc_abs.md) API.
...
│   ├── abs.asc                        // Ascend C example implementation & invocation example
...
- Example functionality:
  Computes the absolute value of each element in the vector. The vector has 256 elements and the data type is float. The computation formula is y = | x |.
- Example specifications:
  ...
  <tr><td rowspan="1" align="center">Kernel Function Name</td><td colspan="3" align="center">abs_custom</td></tr>
  </table>
- Example implementation:
  The abs_vf function calls the asc_abs API for computation and writes the result back to UB
