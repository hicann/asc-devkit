...
## Overview
This example implements the Duplicate operation (scalar fill mode) based on the C API programming interface, primarily calling the [asc_duplicate_scalar](../../../../../docs/zh/api/SIMD-API/C-API/reg/data_fill/asc_duplicate_scalar.md) API.
...
- Example specifications:
  ...
  <tr><td rowspan="1" align="center">Kernel Function Name</td><td colspan="3" align="center">duplicate_custom</td></tr>
  </table>
- Example implementation:
  The duplicate_vf function calls the asc_duplicate_scalar API for scalar filling:
  - Uses the asc_duplicate_scalar API to fill the scalar value into every element of dst vector data register
