...
## Overview
This example implements element-wise multiplication based on the C API programming interface, primarily calling the [asc_mul](../../../../../docs/zh/api/SIMD-API/C-API/reg/arithmetic_compute/asc_mul.md) API.
...
- Example specifications:
  ...
  <tr><td rowspan="1" align="center">Kernel Function Name</td><td colspan="3" align="center">mul_custom</td></tr>
  </table>

- Example implementation:
  The mul_vf function calls the asc_mul API for computation and writes the result back to UB.
