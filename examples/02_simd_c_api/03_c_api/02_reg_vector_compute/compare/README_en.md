...
## Overview
This example implements data comparison functionality across multiple scenarios using the [asc_gt](../../../../../docs/zh/api/SIMD-API/C-API/reg/compare_and_select/asc_gt.md) and asc_gt_scalar APIs based on the C API programming interface.
