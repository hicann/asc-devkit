...
- **Contribution Guide**: [docs/en/contributing/asc_adv_api_contributing.md](./docs/en/contributing/asc_adv_api_contributing.md)
...
- **Contribution Guide**: [docs/en/contributing/asc_basic_api_contributing.md](./docs/en/contributing/asc_basic_api_contributing.md)
...
- **Applicable Scenarios**: C language programming style scenarios
- **Contribution Guide**: [docs/en/contributing/asc_c_api_contributing.md](./docs/en/contributing/asc_c_api_contributing.md)
...
- **Documentation Writing Guide**: [docs/en/contributing/asc_doc_contributing.md](./docs/en/contributing/asc_doc_contributing.md) — Contribution scenarios, writing conventions, PR checklist
