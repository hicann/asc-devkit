...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-08-29T10:20:16.955Z pushedAt=2026-09-01T09:20:52.956Z -->
...
Compares the two components of two **bfloat16x2_t** values. If a component satisfies the condition that the first number is greater than the second number, the corresponding comparison result is 1.0; otherwise, it is 0.0. If any input component is nan, the comparison result of that component is 1.0.
...
-   Compares whether each component of the input data satisfies the condition that the first number is greater than the second number: if satisfied, the corresponding result is 1.0; otherwise, it is 0.0.
