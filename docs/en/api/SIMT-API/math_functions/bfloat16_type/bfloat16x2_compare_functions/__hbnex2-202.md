...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-08-29T10:11:11.351Z pushedAt=2026-09-01T09:20:52.930Z -->
...
Compares whether the two components of two `bfloat16x2_t` data are not equal, and returns true only when both components are not equal.
...
Returns the result of comparing whether all components of the input data are not equal.

-   true: All components of the input data are not equal.
-   false: Any component of the input data is equal. If any component of the input is NaN, the comparison result of that component is false.
