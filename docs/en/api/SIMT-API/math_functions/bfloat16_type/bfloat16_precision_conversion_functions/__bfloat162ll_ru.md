...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-08-29T07:33:08.112Z pushedAt=2026-08-29T09:42:03.782Z -->
...
Converts bfloat16 data to a 64-bit signed integer following the CAST_CEIL mode and returns the converted value.
...
Returns the 64-bit signed integer converted from the input following the **CAST\_CEIL** mode. Special scenarios are described as follows:
...
-   SIMT programming scenario:
    ...
    __global__ __launch_bounds__(1024) void kernel__bfloat162ll_ru(int64_t* dst, bfloat16_t* x)
    {
        ...
        dst[idx] = __bfloat162ll_ru(x[idx]);
    }
    ```
