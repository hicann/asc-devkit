...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-08-29T08:06:35.693Z pushedAt=2026-08-29T09:42:03.852Z -->
...
```
inline bfloat16x2_t __high2bfloat162(const bfloat16x2_t x)
```
...
The result of filling the high 16 bits of the input data into bfloat16x2.
...
-   SIMT programming scenario:
    ...
    __aicore__ void simt_high2bfloat162(bfloat16x2_t* input, bfloat16x2_t* output, uint32_t input_total_length)
    {
        ...
        output[idx] = __high2bfloat162(input[idx]);
    }
    __global__ __launch_bounds__(1024) void cast_kernel(bfloat16_t* input, bfloat16_t* output, uint32_t input_total_length)
    {
        simt_high2bfloat162((bfloat16x2_t*)input, (bfloat16x2_t*)output, input_total_length);
    }
    ```
...
-   SIMD and SIMT hybrid programming scenario:
    ...
    {
        asc_vf_call<simt_high2bfloat162>(dim3(1024), (__gm__ bfloat16x2_t*)input, (__gm__ bfloat16x2_t*)output, input_total_length);
    }
    ```
