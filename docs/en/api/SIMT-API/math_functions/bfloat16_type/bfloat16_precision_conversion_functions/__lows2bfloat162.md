...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-08-29T08:19:58.617Z pushedAt=2026-08-29T09:42:03.887Z -->
...
Extracts the lower 16 bits of two bfloat162 inputs respectively, fills them into a bfloat162, and returns the filled data.
...
Returns the result of extracting the lower 16 bits of two bfloat162 inputs respectively and filling them into a bfloat162.
...
-   SIMT programming scenario:
    ...
    __aicore__ void simt_lows2bfloat162(bfloat16x2_t* input1, bfloat16x2_t* input2, bfloat16x2_t* output, uint32_t input_total_length)
    {
        ...
        output[idx] = __lows2bfloat162(input1[idx], input2[idx]);
    }
    ...
    {
        simt_lows2bfloat162((bfloat16x2_t*)input1, (__gm__ bfloat16x2_t*)input2, (bfloat16x2_t*)output, input_total_length);
    }
    ```
