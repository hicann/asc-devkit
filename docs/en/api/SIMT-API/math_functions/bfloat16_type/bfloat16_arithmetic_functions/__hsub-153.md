...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-08-29T10:01:40.502Z pushedAt=2026-09-01T09:20:52.909Z -->
...
Computes the result of subtracting two bfloat16 data values and rounds the result following the CAST\_RINT mode.

## Function Prototype

```
bfloat16_t __hsub(const bfloat16_t x, const bfloat16_t y)
```
...
Returns the result of subtracting the input data. This API is not affected by the global saturation mode. The special values are as follows:
