...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-01T10:40:41.164Z pushedAt=2026-09-03T07:28:07.236Z -->
...
Converts the two components of **float8\_e5m2x2\_t** type data into floating-point numbers and returns the resulting **float2** type data.
...
Returns the **float2** type data converted from the **float8\_e5m2x2\_t** type input.
...
-   SIMD and SIMT hybrid programming scenario:
    ...
    __simt_vf__ __launch_bounds__(1024) inline void simt_e5m2x22float2(__gm__ float8_e5m2x2_t* input, __gm__ float2* output, uint32_t input_total_length)
    {
        ...
        // Each thread processes one float8_e5m2x2_t type data item, that is, two fp8_e5m2_t type data items. Therefore, threads with idx equal to or greater than half the input_total_length do not process data.
