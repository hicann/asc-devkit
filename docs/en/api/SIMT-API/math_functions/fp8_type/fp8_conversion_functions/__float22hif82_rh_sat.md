# \_\_float22hif82\_rh\_sat

<!-- md-trans-meta sourceCommit=2bc2b38d5648dc61f632186b01ba7f36c2295b13 translatedAt=2026-09-01T10:41:52.846Z pushedAt=2026-09-03T07:28:07.237Z -->
...
In saturation mode, converts the two components of **float2** type data to **hifloat8\_t** precision following the **CAST\_HYBRID** mode, and returns the converted **hifloat8x2\_t** type data.
...
Returns the hifloat8x2\_t data converted from the two input components in saturation mode using the CAST\_HYBRID mode.
...
-   SIMD and SIMT hybrid programming scenario:
    ...
    __simt_vf__ __launch_bounds__(1024) inline void simt_float22hif82_rh_sat(__gm__ float2* input, __gm__ hifloat8x2_t* output, uint32_t input_total_length)
    {
        ...
        output[idx] = __float22hif82_rh_sat(input[idx]);
    }
