...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-01T10:47:03.819Z pushedAt=2026-09-03T07:28:07.246Z -->
...
Converts the two components of **half2** type data to **hifloat8\_t** precision following the **CAST\_ROUND** mode, and returns the converted **hifloat8x2\_t** type data.
...
-   SIMD and SIMT hybrid programming scenario:
    ...
    ```
    // Using short vectors can improve data transfer efficiency.
    __simt_vf__ __launch_bounds__(1024) inline void simt_half22hif82_rna(__gm__ half2* input, __gm__ hifloat8x2_t* output, uint32_t input_total_length)
    {
        ...
        // Each thread processes one half2 datum (i.e., two half data items), so threads with idx equal to or greater than half the input_total_length do not process data.
