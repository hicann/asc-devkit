...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-08-28T09:02:57.736Z pushedAt=2026-08-29T02:54:47.369Z -->
...
Converts a floating-point number to a 64-bit signed integer following the **CAST\_ROUND** mode, and returns the converted value.

## Prototype

```
inline long long int __float2ll_rna(const float x)
```
