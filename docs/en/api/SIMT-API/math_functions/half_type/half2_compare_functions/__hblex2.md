...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-03T12:18:16.521Z pushedAt=2026-09-04T08:03:26.097Z -->
...
Compares the two components of two **half2** values and returns **true** only when both components satisfy the condition that the first number is less than or equal to the second number.
...
Returns the result of comparing whether all components of the inputs satisfy the condition that the first number is less than or equal to the second number.

-   **true**: All components satisfy the condition that the first number is less than or equal to the second number.
-   **false**: Any component does not satisfy the condition that the first number is less than or equal to the second number. If any component of any input is nan, the comparison result of that component is false.
