...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-03T12:31:32.365Z pushedAt=2026-09-04T08:03:26.161Z -->
...
Compares the two components of two **half2** values. If a component satisfies the condition that the first number is less than or equal to the second number, the corresponding comparison result is 1.0; otherwise, it is 0.0. If any input component is nan, the comparison result of that component is 1.0.
...
-   Compares each component of the input data to determine whether the first number is less than or equal to the second number: the corresponding result is 1.0 when the condition is met, and 0.0 when it is not.
