...
<!-- md-trans-meta sourceCommit=2bc2b38d5648dc61f632186b01ba7f36c2295b13 translatedAt=2026-09-04T00:48:06.061Z pushedAt=2026-09-04T11:39:11.879Z -->
...
In saturation mode, converts the two components of **float2** type data to half-precision floating-point numbers following the CAST\_TRUNC mode, and returns the converted **half2** type data.
...
Returns the **half2** type data obtained by converting the two input components to half-precision floating-point numbers following the CAST\_TRUNC mode in saturation mode.
