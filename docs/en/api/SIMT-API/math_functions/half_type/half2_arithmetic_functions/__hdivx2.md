...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-03T12:58:08.072Z pushedAt=2026-09-04T08:03:26.231Z -->
...
Computes the division result of each component of two half2 values and rounds the result following the CAST\_RINT mode.
...
The result of dividing each component of the input data. The divided components x and y satisfy the following conditions:
...
-   When x is ±0 and y is not 0, the sign of the return value is determined by the XOR of the signs of x and y, and the value is 0.
