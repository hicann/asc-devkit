...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-03T13:01:44.454Z pushedAt=2026-09-04T08:03:26.239Z -->
...
Computes the component-wise subtraction result of two **half2** values and rounds the result following the CAST\_RINT mode.
...
The result of subtracting the components of the input data. The subtracted components x and y satisfy the following conditions:
...
-   SIMD and SIMT hybrid programming scenario:
    ...
    {
        asc_vf_call<simt_hsubx2>(dim3(1024), (__gm__ half2*)x, (__gm__ half2*)y, (__gm__ half2*)dst, input_total_length);
    }
    ```
