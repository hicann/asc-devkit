...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-01T09:39:35.549Z pushedAt=2026-09-03T07:28:07.074Z -->
...
Obtains the floating-point number composed of the numeric part of the first input **x** and the sign part of the second input **y**.
...
-   When y>=0, returns the absolute value of x, Abs(x).
-   When y<0, returns the opposite of the absolute value of x, -Abs(x).
-   When y=nan, returns -Abs(x).
-   When y=-inf, returns -Abs(x).
-   When y=inf, returns Abs(x).
