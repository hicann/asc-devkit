...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-01T09:49:31.940Z pushedAt=2026-09-03T07:28:07.099Z -->
...
![](../../../figures/zh-cn_formulaimage_0000002486622044.png)
...
- SIMD and SIMT hybrid programming scenario:
    ...
    __global__ __vector__ void run_fabsf(__gm__ float *result, __gm__ const float *x, uint32_t count)
    {
        asc_vf_call<compute_fabsf_vf>(dim3(256), result, x, count);
    }
    ```
