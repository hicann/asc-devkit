...
<!-- md-trans-meta sourceCommit=0cee2461b8e1ee7e06c9f94e053822a0c511f387 translatedAt=2026-09-07T10:04:56.768Z pushedAt=2026-09-09T01:49:40.949Z -->

SIMD and SIMT hybrid programming provides a set of data types applicable to the Device side, including scalars, short vectors, and the dim3 structure.

## Scalar Types

Scalar types cover the Boolean type (bool), integer types (uint8/int8 through uint64/int64), and floating-point types (float8\_e4m3\_t, float8\_e5m2\_t, hifloat8\_t, half, bfloat16\_t, float).
...
The short vector type is a fixed-length vector type provided in the SIMD and SIMT hybrid programming model, used to simplify the representation and manipulation of vector data. This type is suitable for processing data containing multiple components, such as coordinates, colors, and vector operations.
