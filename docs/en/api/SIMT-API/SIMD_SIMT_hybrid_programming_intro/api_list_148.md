...
<!-- md-trans-meta sourceCommit=2c97acf47d28b2c9fa27e8b745084f6e4f3eedea translatedAt=2026-09-07T10:12:36.661Z pushedAt=2026-09-09T01:49:40.956Z -->
...
| --- | --- |
| [asc_atomic_add](../atomic_operations/asc_atomic_add.md) | Performs an atomic addition operation on the data in Unified Buffer or Global Memory with the specified data, that is, accumulates the specified data into the data in Unified Buffer or Global Memory. |
| [asc_atomic_sub](../atomic_operations/asc_atomic_sub.md) | Performs an atomic subtraction operation on the data in Unified Buffer or Global Memory with the specified data, that is, subtracts the specified data from the data in Unified Buffer or Global Memory. |
| [asc_atomic_exch](../atomic_operations/asc_atomic_exch.md) | Performs an atomic assignment operation on the Unified Buffer or Global Memory address, that is, assigns the specified data to the Unified Buffer or Global Memory address. |
| [asc_atomic_max](../atomic_operations/asc_atomic_max.md) | Performs an atomic maximum operation on the data in Unified Buffer or Global Memory, that is, assigns the maximum value between the data in Unified Buffer or Global Memory and the specified data to the Unified Buffer or Global Memory address. |
| [asc_atomic_min](../atomic_operations/asc_atomic_min.md) | Performs an atomic minimum operation on the data in Unified Buffer or Global Memory, that is, assigns the minimum value between the data in Unified Buffer or Global Memory and the specified data to the Unified Buffer or Global Memory address. |
| [asc_atomic_inc](../atomic_operations/asc_atomic_inc.md) | Performs an atomic increment-by-1 operation on the value at the address in Unified Buffer or Global Memory. If the value at the address is greater than or equal to the specified value val, assigns 0 to the address; otherwise, increments the value at the address by 1. |
| [asc_atomic_dec](../atomic_operations/asc_atomic_dec.md) | Performs an atomic decrement-by-1 operation on the value at the address in Unified Buffer or Global Memory. If the value at the address is equal to 0 or greater than the specified value val, assigns val to the address; otherwise, decrements the value at the address by 1. |
| [asc_atomic_cas](../atomic_operations/asc_atomic_cas.md) | Performs an atomic compare-and-assign operation on the value at the address in Unified Buffer or Global Memory. If the value at the address is equal to the specified value compare, assigns the specified value val to the address; otherwise, the value at the address remains unchanged. |
| [asc_atomic_and](../atomic_operations/asc_atomic_and.md) | Performs an atomic AND (&) operation on the value at the address in Unified Buffer or Global Memory with the specified value val, that is, assigns the result of the address value AND (&) val to Unified Buffer or Global Memory. |
| [asc_atomic_or](../atomic_operations/asc_atomic_or.md) | Performs an atomic OR (\|) operation on the value at the address in Unified Buffer or Global Memory with the specified value val, that is, assigns the result of the address value OR (\|) val to Unified Buffer or Global Memory. |
| [asc_atomic_xor](../atomic_operations/asc_atomic_xor.md) | Performs an atomic XOR (^) operation on the value at the address in Unified Buffer or Global Memory with the specified value val, that is, assigns the result of the address value XOR (^) val to Unified Buffer or Global Memory. |
...
**Table 8** fp8-type conversion functions

| Interface Name | Description |
| --- | --- |
| [__float22hif82_rna](../math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rna.md) | Returns the hifloat8x2_t value converted from the two input components using the CAST_ROUND mode. |
| [__float22hif82_rna_sat](../math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rna_sat.md) | Returns the hifloat8x2_t value converted from the two input components using the CAST_ROUND mode in saturation mode. |
| [__float22hif82_rh](../math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rh.md) | Returns the hifloat8x2_t value converted from the two input components using the CAST_HYBRID mode. |
| [__float22hif82_rh_sat](../math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rh_sat.md) | Returns the hifloat8x2_t value converted from the two input components using the CAST_HYBRID mode in saturation mode. |
| [__asc_cvt_float2_to_fp8x2](../math_functions/fp8_type/fp8_conversion_functions/__asc_cvt_float2_to_fp8x2.md) | Converts the two input components into __asc_fp8x2_storage_t using the CAST_RINT mode, according to the specified 8-bit floating-point type and the specified saturation mode. |
| [__half22hif82_rna](../math_functions/fp8_type/fp8_conversion_functions/__half22hif82_rna.md) | Returns the hifloat8x2_t value converted from the two input components using the CAST_ROUND mode. |
| [__half22hif82_rna_sat](../math_functions/fp8_type/fp8_conversion_functions/__half22hif82_rna_sat.md) | Returns the hifloat8x2_t value converted from the two input components using the CAST_ROUND mode in saturation mode. |
| [__half22hif82_rh](../math_functions/fp8_type/fp8_conversion_functions/__half22hif82_rh.md) | Returns the hifloat8x2_t value converted from the two input components using the CAST_HYBRID mode. |
| [__half22hif82_rh_sat](../math_functions/fp8_type/fp8_conversion_functions/__half22hif82_rh_sat.md) | Returns the hifloat8x2_t value converted from the two input components using the CAST_HYBRID mode in saturation mode. |
| [__hif822float2](../math_functions/fp8_type/fp8_conversion_functions/__hif822float2.md) | Returns the float2 value converted from the hifloat8x2_t input. |
| [__hif822half2](../math_functions/fp8_type/fp8_conversion_functions/__hif822half2.md) | Returns the half2 value converted from the hifloat8x2_t input. |
| [__e4m3x22float2](../math_functions/fp8_type/fp8_conversion_functions/__e4m3x22float2.md) | Returns the float2 value converted from the float8_e4m3x2_t input. |
| [__e5m2x22float2](../math_functions/fp8_type/fp8_conversion_functions/__e5m2x22float2.md) | Returns the float2 value converted from the float8_e5m2x2_t input. |

**Table 9**  half-type arithmetic functions
...
**Table 10**  half-type comparison functions
...
**Table 11**  half-type Math functions

| Interface Name | Description |
| --- | --- |
| [htanh](../math_functions/half_type/half_math_functions/htanh.md) | Obtains the hyperbolic tangent of the input. |
| [hexp](../math_functions/half_type/half_math_functions/hexp.md) | For a given input x, obtains e raised to the power of x. |
| [hexp2](../math_functions/half_type/half_math_functions/hexp2.md) | For a given input x, obtains 2 raised to the power of x. |
| [hexp10](../math_functions/half_type/half_math_functions/hexp10.md) | For a given input x, obtains 10 raised to the power of x. |
| [hlog](../math_functions/half_type/half_math_functions/hlog.md) | Obtains the natural logarithm (base e) of the input. |
| [hlog2](../math_functions/half_type/half_math_functions/hlog2.md) | Obtains the base-2 logarithm of the input. |
| [hlog10](../math_functions/half_type/half_math_functions/hlog10.md) | Obtains the base-10 logarithm of the input. |
| [hcos](../math_functions/half_type/half_math_functions/hcos.md) | Obtains the cosine of the input. |
| [hsin](../math_functions/half_type/half_math_functions/hsin.md) | Obtains the sine of the input. |
| [hsqrt](../math_functions/half_type/half_math_functions/hsqrt.md) | Obtains the square root of the input x. |
| [hrsqrt](../math_functions/half_type/half_math_functions/hrsqrt.md) | Obtains the reciprocal of the square root of the input x. |
| [hrcp](../math_functions/half_type/half_math_functions/hrcp.md) | Obtains the reciprocal of the input x. |
| [hrint](../math_functions/half_type/half_math_functions/hrint.md) | Obtains the integer closest to the input data. If two integers are equally close, obtains the even one. |
| [hfloor](../math_functions/half_type/half_math_functions/hfloor.md) | Obtains the largest integer value less than or equal to the input data. |
| [hceil](../math_functions/half_type/half_math_functions/hceil.md) | Obtains the smallest integer value greater than or equal to the input data. |
| [htrunc](../math_functions/half_type/half_math_functions/htrunc.md) | Obtains the integer obtained by truncating the floating-point number of the input. |

**Table 12**  half Type Precision Conversion Functions
...
**Table 13**  half2 type arithmetic functions
...
**Table 14**  half2 type comparison functions
...
**Table 15**  half2 Math functions

| Function | Description |
| --- | --- |
| [h2tanh](../math_functions/half_type/half2_math_functions/h2tanh.md) | Obtains the hyperbolic tangent of each element of the input. |
| [h2exp](../math_functions/half_type/half2_math_functions/h2exp.md) | Computes e raised to the power of each element of input x. |
| [h2exp2](../math_functions/half_type/half2_math_functions/h2exp2.md) | Computes 2 raised to the power of each element of input x. |
| [h2exp10](../math_functions/half_type/half2_math_functions/h2exp10.md) | Computes 10 raised to the power of each element of input x. |
| [h2log](../math_functions/half_type/half2_math_functions/h2log.md) | Obtains the logarithm to base e of each element of the input. |
| [h2log2](../math_functions/half_type/half2_math_functions/h2log2.md) | Obtains the logarithm to base 2 of each element of the input. |
| [h2log10](../math_functions/half_type/half2_math_functions/h2log10.md) | Obtains the logarithm to base 10 of each element of the input. |
| [h2cos](../math_functions/half_type/half2_math_functions/h2cos.md) | Obtains the cosine of each element of the input. |
| [h2sin](../math_functions/half_type/half2_math_functions/h2sin.md) | Obtains the sine of each element of the input. |
| [h2sqrt](../math_functions/half_type/half2_math_functions/h2sqrt.md) | Obtains the square root of each element of input x. |
| [h2rsqrt](../math_functions/half_type/half2_math_functions/h2rsqrt.md) | Obtains the reciprocal of the square root of each element of input x. |
| [h2rcp](../math_functions/half_type/half2_math_functions/h2rcp.md) | Obtains the reciprocal of each element of input x. |
| [h2rint](../math_functions/half_type/half2_math_functions/h2rint.md) | Rounds each element of the input to the nearest integer, rounding to even in case of ties. |
| [h2floor](../math_functions/half_type/half2_math_functions/h2floor.md) | Obtains the largest integer less than or equal to each element of the input. |
| [h2ceil](../math_functions/half_type/half2_math_functions/h2ceil.md) | Obtains the smallest integer greater than or equal to each element of the input. |
| [h2trunc](../math_functions/half_type/half2_math_functions/h2trunc.md) | Obtains the integer obtained by truncating each element of the input. |

**Table 16**  bfloat16 Arithmetic Functions

| Function | Description |
| --- | --- |
| [__habs](../math_functions/bfloat16_type/bfloat16_arithmetic_functions/__habs-150.md) | Obtains the absolute value of the input. |
| [__hfma](../math_functions/bfloat16_type/bfloat16_arithmetic_functions/__hfma-151.md) | Computes x * y + z for input x, y, and z. |
| [__hadd](../math_functions/bfloat16_type/bfloat16_arithmetic_functions/__hadd-152.md) | Computes the sum of two bfloat16 and rounds the result according to the CAST_RINT mode. |
| [__hsub](../math_functions/bfloat16_type/bfloat16_arithmetic_functions/__hsub-153.md) | Computes the difference between two bfloat16 and rounds the result according to the CAST_RINT mode. |
| [__hmul](../math_functions/bfloat16_type/bfloat16_arithmetic_functions/__hmul-154.md) | Computes the product of two bfloat16 and rounds the result according to the CAST_RINT mode. |
| [__hdiv](../math_functions/bfloat16_type/bfloat16_arithmetic_functions/__hdiv-155.md) | Computes the quotient of two bfloat16 and rounds the result according to the CAST_RINT mode. |
...
**Table 17**  bfloat16 Comparison Functions

| Function | Description |
| --- | --- |
| [__hmax](../math_functions/bfloat16_type/bfloat16_compare_functions/__hmax-158.md) | Obtains the maximum of two values. |
| [__hmin](../math_functions/bfloat16_type/bfloat16_compare_functions/__hmin-159.md) | Obtains the minimum of two values. |
| [__hisnan](../math_functions/bfloat16_type/bfloat16_compare_functions/__hisnan-160.md) | Determines whether a floating-point number is NaN. |
| [__hisinf](../math_functions/bfloat16_type/bfloat16_compare_functions/__hisinf-161.md) | Determines whether a floating-point number is infinity. |
| [__heq](../math_functions/bfloat16_type/bfloat16_compare_functions/__heq-162.md) | Compares whether two bfloat16 values are equal. Returns true if they are equal. |
...
| [__hle](../math_functions/bfloat16_type/bfloat16_compare_functions/__hle-164.md) | Compares two bfloat16 values. Returns true only if the first number is less than or equal to the second number. |
| [__hge](../math_functions/bfloat16_type/bfloat16_compare_functions/__hge-165.md) | Compares two bfloat16 values. Returns true only if the first number is greater than or equal to the second number. |
| [__hlt](../math_functions/bfloat16_type/bfloat16_compare_functions/__hlt-166.md) | Compares two bfloat16 values. Returns true only if the first number is less than the second number. |
| [__hgt](../math_functions/bfloat16_type/bfloat16_compare_functions/__hgt-167.md) | Compares two bfloat16 values. Returns true only if the first number is greater than the second number. |
| [__hequ](../math_functions/bfloat16_type/bfloat16_compare_functions/__hequ-168.md) | Compares whether two bfloat16 values are equal. Returns true if they are equal or if either input is NaN. |
| [__hneu](../math_functions/bfloat16_type/bfloat16_compare_functions/__hneu-169.md) | Compares whether two bfloat16 values are not equal. Returns true if they are not equal or if either input is NaN. |
| [__hleu](../math_functions/bfloat16_type/bfloat16_compare_functions/__hleu-170.md) | Compares two bfloat16 values. Returns true if the first number is less than or equal to the second number or if either input is NaN. |
| [__hgeu](../math_functions/bfloat16_type/bfloat16_compare_functions/__hgeu-171.md) | Compares two bfloat16 values. Returns true if the first number is greater than or equal to the second number or if either input is NaN. |
| [__hltu](../math_functions/bfloat16_type/bfloat16_compare_functions/__hltu-172.md) | Compares two bfloat16 values. Returns true if the first number is less than the second number or if either input is NaN. |
| [__hgtu](../math_functions/bfloat16_type/bfloat16_compare_functions/__hgtu-173.md) | Compares two bfloat16 values. Returns true if the first number is greater than the second number or if either input is NaN. |
| [__hmax_nan](../math_functions/bfloat16_type/bfloat16_compare_functions/__hmax_nan-174.md) | Obtains the maximum of two values. Returns NaN if either input is NaN. |
| [__hmin_nan](../math_functions/bfloat16_type/bfloat16_compare_functions/__hmin_nan-175.md) | Obtains the minimum of two values. Returns NaN if either input is NaN. |

**Table 18**  bfloat16 Math functions

| Function | Description |
| --- | --- |
| [htanh](../math_functions/bfloat16_type/bfloat16_math_functions/htanh-176.md) | Obtains the hyperbolic tangent of the input. |
| [hexp](../math_functions/bfloat16_type/bfloat16_math_functions/hexp-177.md) | Computes e raised to the power of x for input x. |
| [hexp2](../math_functions/bfloat16_type/bfloat16_math_functions/hexp2-178.md) | Computes 2 raised to the power of x for input x. |
| [hexp10](../math_functions/bfloat16_type/bfloat16_math_functions/hexp10-179.md) | Computes 10 raised to the power of x for input x. |
| [hlog](../math_functions/bfloat16_type/bfloat16_math_functions/hlog-180.md) | Obtains the logarithm to base e of the input. |
| [hlog2](../math_functions/bfloat16_type/bfloat16_math_functions/hlog2-181.md) | Obtains the logarithm to base 2 of the input. |
| [hlog10](../math_functions/bfloat16_type/bfloat16_math_functions/hlog10-182.md) | Obtains the logarithm to base 10 of the input. |
| [hcos](../math_functions/bfloat16_type/bfloat16_math_functions/hcos-183.md) | Obtains the cosine of the input. |
| [hsin](../math_functions/bfloat16_type/bfloat16_math_functions/hsin-184.md) | Obtains the sine of the input. |
| [hsqrt](../math_functions/bfloat16_type/bfloat16_math_functions/hsqrt-185.md) | Obtains the square root of input x. |
| [hrsqrt](../math_functions/bfloat16_type/bfloat16_math_functions/hrsqrt-186.md) | Obtains the reciprocal of the square root of input x. |
| [hrcp](../math_functions/bfloat16_type/bfloat16_math_functions/hrcp-187.md) | Obtains the reciprocal of input x. |
| [hrint](../math_functions/bfloat16_type/bfloat16_math_functions/hrint-188.md) | Rounds the input to the nearest integer, rounding to even in case of ties. |
| [hfloor](../math_functions/bfloat16_type/bfloat16_math_functions/hfloor-189.md) | Obtains the largest integer less than or equal to the input data. |
| [hceil](../math_functions/bfloat16_type/bfloat16_math_functions/hceil-190.md) | Obtains the smallest integer greater than or equal to the input data. |
| [htrunc](../math_functions/bfloat16_type/bfloat16_math_functions/htrunc-191.md) | Obtains the integer obtained by truncating the input data. |

**Table 19**  bfloat16-type precision conversion functions

| Interface | Description |
| --- | --- |
| [__float2bfloat16](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16.md) | Returns the **bfloat16** value converted following the **CAST_RINT** mode. |
| [__float2bfloat16_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_rn.md) | Returns the **bfloat16** value converted following the **CAST_RINT** mode. |
| [__float2bfloat16_rn_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_rn_sat.md) | In saturation mode, returns the **bfloat16** type converted following the **CAST_RINT** mode. |
| [__float22bfloat162_rn_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_rn_sat.md) | In saturation mode, returns the **bfloat16x2_t** value whose two components are converted following the **CAST_RINT** mode. |
| [__float2bfloat16_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_rz.md) | Returns the **bfloat16** value converted following the **CAST_TRUNC** mode. |
| [__float2bfloat16_rz_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_rz_sat.md) | In saturation mode, returns the **bfloat16** type converted following the **CAST_TRUNC** mode. |
| [__float22bfloat162_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_rz.md) | Returns the **bfloat16x2_t** value whose two components are converted following the **CAST_TRUNC** mode. |
| [__float22bfloat162_rz_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_rz_sat.md) | In saturation mode, returns the **bfloat16x2_t** value whose two components are converted following the **CAST_TRUNC** mode. |
| [__float2bfloat16_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_rd.md) | Returns the **bfloat16** value converted following the **CAST_FLOOR** mode. |
| [__float2bfloat16_rd_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_rd_sat.md) | In saturation mode, returns the **bfloat16** type converted following the **CAST_FLOOR** mode. |
| [__float22bfloat162_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_rd.md) | Returns the **bfloat16x2_t** value whose two components are converted following the **CAST_FLOOR** mode. |
| [__float22bfloat162_rd_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_rd_sat.md) | In saturation mode, returns the **bfloat16x2_t** value whose two components are converted following the **CAST_FLOOR** mode. |
| [__float2bfloat16_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_ru.md) | Returns the **bfloat16** value converted following the **CAST_CEIL** mode. |
| [__float2bfloat16_ru_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_ru_sat.md) | In saturation mode, returns the **bfloat16** type converted following the **CAST_CEIL** mode. |
| [__float22bfloat162_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_ru.md) | Returns the **bfloat16x2_t** value whose two components are converted following the **CAST_CEIL** mode. |
| [__float22bfloat162_ru_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_ru_sat.md) | In saturation mode, returns the **bfloat16x2_t** value whose two components are converted following the **CAST_CEIL** mode. |
| [__float2bfloat16_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_rna.md) | Returns the **bfloat16** value converted following the **CAST_ROUND** mode. |
| [__float2bfloat16_rna_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_rna_sat.md) | In saturation mode, returns the **bfloat16** type converted following the **CAST_ROUND** mode. |
| [__float22bfloat162_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_rna.md) | Returns the **bfloat16x2_t** value whose two components are converted following the **CAST_ROUND** mode. |
| [__float22bfloat162_rna_sat](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_rna_sat.md) | In saturation mode, returns the **bfloat16x2_t** value whose two components are converted following the **CAST_ROUND** mode. |
| [__half2bfloat16_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__half2bfloat16_rn.md) | Returns the **bfloat16** value converted following the **CAST_RINT** mode. |
| [__half2bfloat16_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__half2bfloat16_rz.md) | Returns the **bfloat16** value converted following the **CAST_TRUNC** mode. |
| [__half2bfloat16_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__half2bfloat16_rd.md) | Returns the **bfloat16** value converted following the **CAST_FLOOR** mode. |
| [__half2bfloat16_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__half2bfloat16_ru.md) | Returns the **bfloat16** value converted following the **CAST_CEIL** mode. |
| [__half2bfloat16_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__half2bfloat16_rna.md) | Returns the **bfloat16** value converted following the **CAST_ROUND** mode. |
| [__bfloat162float](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162float.md) | Returns the result of converting the input to a floating-point number. |
| [__bfloat162bfloat16_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162bfloat16_rn.md) | Returns the **bfloat16_t** type rounded following the **CAST_RINT** mode. |
| [__bfloat162bfloat16_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162bfloat16_rz.md) | Returns the **bfloat16_t** type rounded following the **CAST_TRUNC** mode. |
| [__bfloat162bfloat16_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162bfloat16_rd.md) | Returns the **bfloat16_t** type rounded following the **CAST_FLOOR** mode. |
| [__bfloat162bfloat16_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162bfloat16_ru.md) | Returns the **bfloat16_t** type rounded following the **CAST_CEIL** mode. |
| [__bfloat162bfloat16_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162bfloat16_rna.md) | Returns the **bfloat16_t** type rounded following the **CAST_ROUND** mode. |
| [__bfloat162uint_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162uint_rn.md) | Returns the unsigned integer converted following the **CAST_RINT** mode. |
| [__bfloat162uint_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162uint_rz.md) | Returns the unsigned integer converted following the **CAST_TRUNC** mode. |
| [__bfloat162uint_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162uint_rd.md) | Returns the unsigned integer converted following the **CAST_FLOOR** mode. |
| [__bfloat162uint_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162uint_ru.md) | Returns the unsigned integer converted following the **CAST_CEIL** mode. |
| [__bfloat162uint_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162uint_rna.md) | Returns the unsigned integer converted following the **CAST_ROUND** mode. |
| [__bfloat162int_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162int_rn.md) | Returns the signed integer converted following the **CAST_RINT** mode. |
| [__bfloat162int_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162int_rz.md) | Returns the signed integer converted following the **CAST_TRUNC** mode. |
| [__bfloat162int_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162int_rd.md) | Returns the signed integer converted following the **CAST_FLOOR** mode. |
| [__bfloat162int_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162int_ru.md) | Returns the signed integer converted following the **CAST_CEIL** mode. |
| [__bfloat162int_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162int_rna.md) | Returns the signed integer converted following the **CAST_ROUND** mode. |
| [__bfloat162ull_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ull_rn.md) | Returns the 64-bit unsigned integer converted following the **CAST_RINT** mode. |
| [__bfloat162ull_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ull_rz.md) | Returns the 64-bit unsigned integer converted following the **CAST_TRUNC** mode. |
| [__bfloat162ull_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ull_rd.md) | Returns the 64-bit unsigned integer converted following the **CAST_FLOOR** mode. |
| [__bfloat162ull_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ull_ru.md) | Returns the 64-bit unsigned integer converted following the **CAST_CEIL** mode. |
| [__bfloat162ull_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ull_rna.md) | Returns the 64-bit unsigned integer converted following the **CAST_ROUND** mode. |
| [__bfloat162ll_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ll_rn.md) | Returns the 64-bit signed integer converted following the **CAST_RINT** mode. |
| [__bfloat162ll_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ll_rz.md) | Returns the 64-bit signed integer converted following the **CAST_TRUNC** mode. |
| [__bfloat162ll_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ll_rd.md) | Returns the 64-bit signed integer converted following the **CAST_FLOOR** mode. |
| [__bfloat162ll_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ll_ru.md) | Returns the 64-bit signed integer converted following the **CAST_CEIL** mode. |
| [__bfloat162ll_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162ll_rna.md) | Returns the 64-bit signed integer converted following the **CAST_ROUND** mode. |
| [__uint2bfloat16_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__uint2bfloat16_rn.md) | Returns the **bfloat16** value converted following the **CAST_RINT** mode. |
| [__uint2bfloat16_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__uint2bfloat16_rz.md) | Returns the **bfloat16** value converted following the **CAST_TRUNC** mode. |
| [__uint2bfloat16_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__uint2bfloat16_rd.md) | Returns the **bfloat16** value converted following the **CAST_FLOOR** mode. |
| [__uint2bfloat16_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__uint2bfloat16_ru.md) | Returns the **bfloat16** value converted following the **CAST_CEIL** mode. |
| [__uint2bfloat16_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__uint2bfloat16_rna.md) | Returns the **bfloat16** value converted following the **CAST_ROUND** mode. |
| [__int2bfloat16_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__int2bfloat16_rn.md) | Returns the **bfloat16** value converted following the **CAST_RINT** mode. |
| [__int2bfloat16_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__int2bfloat16_rz.md) | Returns the **bfloat16** value converted following the **CAST_TRUNC** mode. |
| [__int2bfloat16_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__int2bfloat16_rd.md) | Returns the **bfloat16** value converted following the **CAST_FLOOR** mode. |
| [__int2bfloat16_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__int2bfloat16_ru.md) | Returns the **bfloat16** value converted following the **CAST_CEIL** mode. |
| [__int2bfloat16_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__int2bfloat16_rna.md) | Returns the **bfloat16** value converted following the **CAST_ROUND** mode. |
| [__ull2bfloat16_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ull2bfloat16_rn.md) | Returns the **bfloat16** value converted following the **CAST_RINT** mode. |
| [__ull2bfloat16_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ull2bfloat16_rz.md) | Returns the **bfloat16** value converted following the **CAST_TRUNC** mode. |
| [__ull2bfloat16_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ull2bfloat16_rd.md) | Returns the **bfloat16** value converted following the **CAST_FLOOR** mode. |
| [__ull2bfloat16_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ull2bfloat16_ru.md) | Returns the **bfloat16** value converted following the **CAST_CEIL** mode. |
| [__ull2bfloat16_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ull2bfloat16_rna.md) | Returns the **bfloat16** value converted following the **CAST_ROUND** mode. |
| [__ll2bfloat16_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ll2bfloat16_rn.md) | Returns the **bfloat16** value converted following the **CAST_RINT** mode. |
| [__ll2bfloat16_rz](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ll2bfloat16_rz.md) | Returns the **bfloat16** value converted following the **CAST_TRUNC** mode. |
| [__ll2bfloat16_rd](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ll2bfloat16_rd.md) | Returns the **bfloat16** value converted following the **CAST_FLOOR** mode. |
| [__ll2bfloat16_ru](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ll2bfloat16_ru.md) | Returns the **bfloat16** value converted following the **CAST_CEIL** mode. |
| [__ll2bfloat16_rna](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ll2bfloat16_rna.md) | Returns the **bfloat16** value converted following the **CAST_ROUND** mode. |
| [__float2bfloat162_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat162_rn.md) | Converts the **float** type to **bfloat16** type following the **CAST_RINT** mode, fills it into the high and low parts of **bfloat16x2**, and returns the resulting **bfloat16x2** type data. |
| [__floats2bfloat162_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__floats2bfloat162_rn.md) | Converts the input x and y to **bfloat16** type following the **CAST_RINT** mode respectively, fills them into the high and low parts of **bfloat16x2**, and returns the resulting **bfloat16x2** type data. |
| [__float22bfloat162_rn](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float22bfloat162_rn.md) | Converts the **float2** type to **bfloat16x2** type following the **CAST_RINT** mode and returns the resulting **bfloat16x2** type data. |
| [__bfloat162bfloat162](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162bfloat162.md) | Fills the input into the high and low components of **bfloat16x2** and returns the resulting **bfloat16x2** type data. |
| [__halves2bfloat162](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__halves2bfloat162.md) | Fills the input into the high and low components of **bfloat16x2** respectively and returns the resulting data. |
...
| [__high2bfloat162](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__high2bfloat162.md) | Fills the high 16 bits of the input into **bfloat16x2** and returns the result. |
| [__high2float](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__high2float.md) | Converts the high 16 bits of the input to **float** type and returns the result. |
| [__highs2bfloat162](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__highs2bfloat162.md) | Extracts the high 16 bits of the two **bfloat16x2** inputs respectively and fills them into **bfloat16x2**. Returns the resulting data. |
| [__low2bfloat16](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__low2bfloat16.md) | Returns the low 16 bits of the input. |
| [__low2bfloat162](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__low2bfloat162.md) | Fills the low 16 bits of the input into **bfloat16x2** and returns the result. |
| [__low2float](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__low2float.md) | Converts the low 16 bits of the input to a floating-point number and returns the result. |
| [__lowhigh2highlow](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__lowhigh2highlow.md) | Swaps the high and low 16 bits of the input and returns the result. |
| [__lows2bfloat162](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__lows2bfloat162.md) | Extracts the low 16 bits of the two **bfloat16x2** inputs respectively and fills them into **bfloat16x2**. Returns the resulting data. |
...
| [__ushort_as_bfloat16](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__ushort_as_bfloat16.md) | Reinterprets the bits of **unsigned short int** as **bfloat16**, that is, reads the bits stored in the **unsigned short int** in the **bfloat16** format. |

**Table 20**  bfloat16x2-type arithmetic functions
...
**Table 21**  bfloat16x2-type comparison functions
...
**Table 22**  bfloat16x2-type Math functions

| Interface Name | Description |
| --- | --- |
| [h2tanh](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2tanh-242.md) | Obtains the hyperbolic tangent of each element of the input. |
| [h2exp](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2exp-243.md) | Given input x, obtains e raised to the power of each element of x. |
| [h2exp2](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2exp2-244.md) | Given input x, obtains 2 raised to the power of each element of x. |
| [h2exp10](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2exp10-245.md) | Given input x, obtains 10 raised to the power of each element of x. |
| [h2log](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2log-246.md) | Obtains the natural logarithm (base e) of each element of the input. |
| [h2log2](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2log2-247.md) | Obtains the base-2 logarithm of each element of the input. |
| [h2log10](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2log10-248.md) | Obtains the base-10 logarithm of each element of the input. |
| [h2cos](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2cos-249.md) | Obtains the cosine of each element of the input. |
| [h2sin](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2sin-250.md) | Obtains the sine of each element of the input. |
| [h2sqrt](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2sqrt-251.md) | Obtains the square root of each element of the input x. |
| [h2rsqrt](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2rsqrt-252.md) | Obtains the reciprocal of the square root of each element of the input x. |
| [h2rcp](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2rcp-253.md) | Obtains the reciprocal of each element of the input x. |
| [h2rint](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2rint-254.md) | Obtains the integer closest to each element of the input. If two integers are equally close, obtains the even one. |
| [h2floor](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2floor-255.md) | Obtains the largest integer value less than or equal to each element of the input. |
| [h2ceil](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2ceil-256.md) | Obtains the smallest integer value greater than or equal to each element of the input. |
| [h2trunc](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2trunc-257.md) | Obtains the integer obtained by truncating the floating-point value of each element of the input. |

**Table 23**  float-type Math functions

| Interface Name | Description |
| --- | --- |
| [tanf](../math_functions/float_math_functions/tanf.md) | Obtains the trigonometric tangent of the input. |
| [tanhf](../math_functions/float_math_functions/tanhf.md) | Obtains the hyperbolic tangent of the input. |
| [tanpif](../math_functions/float_math_functions/tanpif.md) | Obtains the tangent of the input multiplied by π. |
| [atanf](../math_functions/float_math_functions/atanf.md) | Obtains the arctangent of the input. |
| [atan2f](../math_functions/float_math_functions/atan2f.md) | Obtains the arctangent value of y/x. |
| [atanhf](../math_functions/float_math_functions/atanhf.md) | Obtains the inverse hyperbolic tangent of the input. |
| [expf](../math_functions/float_math_functions/expf.md) | Given input x, obtains e raised to the power of x. |
| [exp2f](../math_functions/float_math_functions/exp2f.md) | Given input x, obtains 2 raised to the power of x. |
| [exp10f](../math_functions/float_math_functions/exp10f.md) | Given input x, obtains 10 raised to the power of x. |
| [expm1f](../math_functions/float_math_functions/expm1f.md) | Given input x, obtains e raised to the power of x minus 1. |
| [logf](../math_functions/float_math_functions/logf.md) | Obtains the natural logarithm (base e) of the input. |
| [log2f](../math_functions/float_math_functions/log2f.md) | Obtains the base-2 logarithm of the input. |
| [log10f](../math_functions/float_math_functions/log10f.md) | Obtains the base-10 logarithm of the input. |
| [log1pf](../math_functions/float_math_functions/log1pf.md) | Obtains the natural logarithm (base e) of the input plus 1. |
| [logbf](../math_functions/float_math_functions/logbf.md) | Calculates the base-2 logarithm of the input data, rounds the result down, and returns a floating-point number. |
| [ilogbf](../math_functions/float_math_functions/ilogbf.md) | Calculates the base-2 logarithm of the input data, rounds the result down, and returns an integer. |
| [cosf](../math_functions/float_math_functions/cosf.md) | Obtains the trigonometric cosine value of the input. |
| [coshf](../math_functions/float_math_functions/coshf.md) | Obtains the hyperbolic cosine value of the input. |
| [cospif](../math_functions/float_math_functions/cospif.md) | Obtains the cosine of the input value multiplied by π. |
| [acosf](../math_functions/float_math_functions/acosf.md) | Obtains the arccosine value of the input. |
| [acoshf](../math_functions/float_math_functions/acoshf.md) | Obtains the inverse hyperbolic cosine value of the input. |
| [sinf](../math_functions/float_math_functions/sinf.md) | Obtains the trigonometric sine value of the input. |
| [sinhf](../math_functions/float_math_functions/sinhf.md) | Obtains the hyperbolic sine value of the input. |
| [sinpif](../math_functions/float_math_functions/sinpif.md) | Obtains the sine of the input value multiplied by π. |
| [asinf](../math_functions/float_math_functions/asinf.md) | Obtains the arcsine value of the input. |
| [asinhf](../math_functions/float_math_functions/asinhf.md) | Obtains the inverse hyperbolic sine value of the input. |
| [sincosf](../math_functions/float_math_functions/sincosf.md) | Obtains the trigonometric sine and cosine values of the input. |
| [sincospif](../math_functions/float_math_functions/sincospif.md) | Obtains the trigonometric sine and cosine of the input value multiplied by π. |
| [frexpf](../math_functions/float_math_functions/frexpf.md) | Converts x into a signed number normalized to [1/2, 1) multiplied by an integral power of 2. |
...
| [sqrtf](../math_functions/float_math_functions/sqrtf.md) | Obtains the square root of the input x. |
| [rsqrtf](../math_functions/float_math_functions/rsqrtf.md) | Obtains the reciprocal of the square root of the input x. |
| [hypotf](../math_functions/float_math_functions/hypotf.md) | Obtains the square root of the sum of x^2 and y^2. |
| [rhypotf](../math_functions/float_math_functions/rhypotf.md) | Obtains the reciprocal of the square root of the sum of x^2 and y^2. |
| [powf](../math_functions/float_math_functions/powf.md) | Obtains the input x raised to the power of y. |
| [norm3df](../math_functions/float_math_functions/norm3df.md) | Obtains the square root of the sum of a^2, b^2, and c^2. |
| [rnorm3df](../math_functions/float_math_functions/rnorm3df.md) | Obtains the reciprocal of the square root of the sum of a^2, b^2, and c^2. |
| [norm4df](../math_functions/float_math_functions/norm4df.md) | Obtains the square root of the sum of a^2, b^2, c^2, and d^2. |
| [rnorm4df](../math_functions/float_math_functions/rnorm4df.md) | Obtains the reciprocal of the square root of the sum of a^2, b^2, c^2, and d^2. |
| [normf](../math_functions/float_math_functions/normf.md) | Obtains the square root of a[0]^2 + a[1]^2 +...+ a[n-1]^2. |
| [rnormf](../math_functions/float_math_functions/rnormf.md) | Obtains the reciprocal of the square root of the sum of squares of the first n elements of the input array a, i.e., 1 / sqrt(a[0]^2 + a[1]^2 + ... + a[n-1]^2). |
| [cbrtf](../math_functions/float_math_functions/cbrtf.md) | Obtains the cube root of the input x. |
| [rcbrtf](../math_functions/float_math_functions/rcbrtf.md) | Obtains the reciprocal of the cube root of the input x. |
| [erff](../math_functions/float_math_functions/erff.md) | Obtains the error function value of the input. |
| [erfcf](../math_functions/float_math_functions/erfcf.md) | Obtains the complementary error function value of the input. |
| [erfinvf](../math_functions/float_math_functions/erfinvf.md) | Obtains the inverse error function value of the input. |
| [erfcinvf](../math_functions/float_math_functions/erfcinvf.md) | Obtains the inverse complementary error function value of the input. |
| [erfcxf](../math_functions/float_math_functions/erfcxf.md) | Obtains the scaled complementary error function value of the input. |
| [tgammaf](../math_functions/float_math_functions/tgammaf.md) | Obtains the gamma function value of the input x. |
| [lgammaf](../math_functions/float_math_functions/lgammaf.md) | Obtains the absolute value of the gamma function of the input x and calculates its natural logarithm. |
| [cyl_bessel_i0f](../math_functions/float_math_functions/cyl_bessel_i0f.md) | Obtains the value of the regular modified cylindrical Bessel function of order 0 for the input x. |
| [cyl_bessel_i1f](../math_functions/float_math_functions/cyl_bessel_i1f.md) | Obtains the value of the regular modified cylindrical Bessel function of order 1 for the input x. |
| [normcdff](../math_functions/float_math_functions/normcdff.md) | Obtains the cumulative distribution function value of the standard normal distribution for the input x. |
| [normcdfinvf](../math_functions/float_math_functions/normcdfinvf.md) | Obtains the inverse of the standard normal cumulative distribution function for the input x. |
| [j0f](../math_functions/float_math_functions/j0f.md) | Obtains the value of the Bessel function of the first kind of order 0, j0, for the input x. |
| [j1f](../math_functions/float_math_functions/j1f.md) | Obtains the value of the Bessel function of the first kind of order 1, j1, for the input x. |
| [jnf](../math_functions/float_math_functions/jnf.md) | Obtains the value of the Bessel function of the first kind of order n, jn, for the input x. |
| [y0f](../math_functions/float_math_functions/y0f.md) | Obtains the value of the Bessel function of the second kind of order 0, y0, for the input x. |
| [y1f](../math_functions/float_math_functions/y1f.md) | Obtains the value of the Bessel function of the second kind of order 1, y1, for the input x. |
| [ynf](../math_functions/float_math_functions/ynf.md) | Obtains the value of the Bessel function of the second kind of order n, yn, for the input x. |
| [fabsf](../math_functions/float_math_functions/fabsf.md) | Obtains the absolute value of the input. |
| [fmaf](../math_functions/float_math_functions/fmaf.md) | For the input x, y, and z, calculates the result of x multiplied by y plus z. |
| [fmaxf](../math_functions/float_math_functions/fmaxf.md) | Obtains the maximum value of the two input values. |
| [fminf](../math_functions/float_math_functions/fminf.md) | Obtains the minimum value of the two input values. |
| [fdimf](../math_functions/float_math_functions/fdimf.md) | Obtains the difference of the input; returns 0 when the difference is less than 0. |
| [remquof](../math_functions/float_math_functions/remquof.md) | Obtains the remainder of the input x divided by y. When computing the remainder, the quotient is the integer closest to the floating-point result of x divided by y; when the floating-point result of x divided by y is equidistant from the two nearest integers, the quotient is the even integer. The quotient is also assigned to the pointer variable quo. |
| [fmodf](../math_functions/float_math_functions/fmodf.md) | Obtains the remainder of the input x divided by y. When computing the remainder, the quotient is the integer part of the floating-point result of x divided by y. |
| [remainderf](../math_functions/float_math_functions/remainderf.md) | Obtains the remainder of the input x divided by y. When computing the remainder, the quotient is the integer closest to the floating-point result of x divided by y; when the floating-point result of x divided by y is equidistant from the two nearest integers, the quotient is the even integer. |
| [copysignf](../math_functions/float_math_functions/copysignf.md) | Obtains a floating-point number composed of the magnitude of the first input x and the sign of the second input y. |
| [nearbyintf](../math_functions/float_math_functions/nearbyintf.md) | Obtains the integer closest to the input floating-point number; when the input floating-point number is equidistant from the two nearest integers, returns the even integer. |
| [nextafterf](../math_functions/float_math_functions/nextafterf.md) | If y is greater than x, returns the next representable floating-point value greater than x, that is, the least significant bit of the floating-point binary representation incremented by 1.<br><br>If y is less than x, returns the next representable floating-point value less than x, that is, the least significant bit of the floating-point binary representation decremented by 1.<br><br>If y equals x, returns x. |
| [scalbnf](../math_functions/float_math_functions/scalbnf.md) | Obtains the product of the input x and 2 raised to the power of n. |
| [scalblnf](../math_functions/float_math_functions/scalblnf.md) | Obtains the product of the input x and 2 raised to the power of n. |
| [modff](../math_functions/float_math_functions/modff.md) | Decomposes the input into a fractional part and an integer part. |
| [fdividef](../math_functions/float_math_functions/fdividef.md) | Obtains the result of dividing the two input values. |
| [signbit](../math_functions/float_math_functions/signbit.md) | Obtains the sign bit of the input. |
| [__saturatef](../math_functions/float_math_functions/__saturatef.md) | Clamps the input to the interval [0.0, 1.0]. |
| [__fdividef](../math_functions/float_math_functions/__fdividef.md) | Obtains the result of dividing the two input values. |
| [rintf](../math_functions/float_math_functions/rintf.md) | Obtains the integer closest to the input; if two integers are equally close, obtains the even one. |
| [lrintf](../math_functions/float_math_functions/lrintf.md) | Obtains the integer closest to the input; if two integers are equally close, obtains the even one. |
| [llrintf](../math_functions/float_math_functions/llrintf.md) | Obtains the integer closest to the input; if two integers are equally close, obtains the even one. |
| [roundf](../math_functions/float_math_functions/roundf.md) | Obtains the integer obtained by rounding the input to the nearest integer. |
| [lroundf](../math_functions/float_math_functions/lroundf.md) | Obtains the integer obtained by rounding the input to the nearest integer. |
| [llroundf](../math_functions/float_math_functions/llroundf.md) | Obtains the integer obtained by rounding the input to the nearest integer. |
| [floorf](../math_functions/float_math_functions/floorf.md) | Obtains the largest integer value less than or equal to the input. |
| [ceilf](../math_functions/float_math_functions/ceilf.md) | Obtains the smallest integer value greater than or equal to the input. |
| [truncf](../math_functions/float_math_functions/truncf.md) | Obtains the integer obtained by truncating the floating-point number of the input. |
| [isfinite](../math_functions/float_math_functions/isfinite1.md) | Determines whether the floating-point number is finite (not inf and not nan). |
...
**Table 24** Type conversion functions
...
| [__float2uint_rn](../math_functions/data_type_conversion/type_conversion_functions/__float2uint_rn.md) | Returns the unsigned integer obtained by converting the input following the **CAST_RINT** mode. |
| [__float2uint_rz](../math_functions/data_type_conversion/type_conversion_functions/__float2uint_rz.md) | Returns the unsigned integer obtained by converting the input following the **CAST_TRUNC** mode. |
| [__float2uint_rd](../math_functions/data_type_conversion/type_conversion_functions/__float2uint_rd.md) | Returns the unsigned integer obtained by converting the input following the **CAST_FLOOR** mode. |
| [__float2uint_ru](../math_functions/data_type_conversion/type_conversion_functions/__float2uint_ru.md) | Returns the unsigned integer obtained by converting the input following the **CAST_CEIL** mode. |
| [__float2uint_rna](../math_functions/data_type_conversion/type_conversion_functions/__float2uint_rna.md) | Returns the unsigned integer obtained by converting the input following the **CAST_ROUND** mode. |
| [__float2int_rn](../math_functions/data_type_conversion/type_conversion_functions/__float2int_rn.md) | Returns the signed integer obtained by converting the input following the **CAST_RINT** mode. |
| [__float2int_rz](../math_functions/data_type_conversion/type_conversion_functions/__float2int_rz.md) | Returns the signed integer obtained by converting the input following the **CAST_TRUNC** mode. |
| [__float2int_rd](../math_functions/data_type_conversion/type_conversion_functions/__float2int_rd.md) | Returns the signed integer obtained by converting the input following the **CAST_FLOOR** mode. |
| [__float2int_ru](../math_functions/data_type_conversion/type_conversion_functions/__float2int_ru.md) | Returns the signed integer obtained by converting the input following the **CAST_CEIL** mode. |
| [__float2int_rna](../math_functions/data_type_conversion/type_conversion_functions/__float2int_rna.md) | Returns the signed integer obtained by converting the input following the **CAST_ROUND** mode. |
| [__float2ull_rn](../math_functions/data_type_conversion/type_conversion_functions/__float2ull_rn.md) | Returns the 64-bit unsigned integer obtained by converting the input following the **CAST_RINT** mode. |
| [__float2ull_rz](../math_functions/data_type_conversion/type_conversion_functions/__float2ull_rz.md) | Returns the 64-bit unsigned integer obtained by converting the input following the **CAST_TRUNC** mode. |
| [__float2ull_rd](../math_functions/data_type_conversion/type_conversion_functions/__float2ull_rd.md) | Returns the 64-bit unsigned integer obtained by converting the input following the **CAST_FLOOR** mode. |
| [__float2ull_ru](../math_functions/data_type_conversion/type_conversion_functions/__float2ull_ru.md) | Returns the 64-bit unsigned integer obtained by converting the input following the **CAST_CEIL** mode. |
| [__float2ull_rna](../math_functions/data_type_conversion/type_conversion_functions/__float2ull_rna.md) | Returns the 64-bit unsigned integer obtained by converting the input following the **CAST_ROUND** mode. |
| [__float2ll_rn](../math_functions/data_type_conversion/type_conversion_functions/__float2ll_rn.md) | Returns the 64-bit signed integer obtained by converting the input following the **CAST_RINT** mode. |
| [__float2ll_rz](../math_functions/data_type_conversion/type_conversion_functions/__float2ll_rz.md) | Returns the 64-bit signed integer obtained by converting the input following the **CAST_TRUNC** mode. |
| [__float2ll_rd](../math_functions/data_type_conversion/type_conversion_functions/__float2ll_rd.md) | Returns the 64-bit signed integer obtained by converting the input following the **CAST_FLOOR** mode. |
| [__float2ll_ru](../math_functions/data_type_conversion/type_conversion_functions/__float2ll_ru.md) | Returns the 64-bit signed integer obtained by converting the input following the **CAST_CEIL** mode. |
| [__float2ll_rna](../math_functions/data_type_conversion/type_conversion_functions/__float2ll_rna.md) | Returns the 64-bit signed integer obtained by converting the input following the **CAST_ROUND** mode. |
...
**Table 25**  Integer Math functions
...
| [llmax](../math_functions/integer_math_functions/llmax.md) | Obtains the maximum value among the two input values. |
| [ullmax](../math_functions/integer_math_functions/ullmax.md) | Obtains the maximum value among the two input values. |
| [umax](../math_functions/integer_math_functions/umax.md) | Obtains the maximum value among the two input values. |
| [llmin](../math_functions/integer_math_functions/llmin.md) | Obtains the minimum of the two input values. |
| [ullmin](../math_functions/integer_math_functions/ullmin.md) | Obtains the minimum of the two input values. |
| [umin](../math_functions/integer_math_functions/umin.md) | Obtains the minimum value of two input values. |
...
| [max](../math_functions/integer_math_functions/max1.md) | Obtains the maximum value among the two input values. |
| [min](../math_functions/integer_math_functions/min1.md) | Obtains the minimum of the two input values. |
...
## Cooperative Groups<a name="section_cooperative_groups"></a>

**Table 27**  thread_block interfaces
...
**Table 28**  coalesced_group interfaces
...
**Table 29**  thread_block_tile interfaces
...
**Table 30**  Cooperative group partition interfaces
