...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-08T01:06:20.623Z -->
...
Computes the minimum value of **val** across all active threads in the warp. All active threads in the warp return the same result.
...
Returns the minimum value of **val** across all active threads in the warp.
...
-   SIMT programming scenario:
    ...
    __global__ __launch_bounds__(1024) void KernelReduceMin(int32_t* dst)
    {
        ...
        int32_t result = asc_reduce_min(laneId); // Returns 0.
        dst[idx] = result;
    }
    ```
