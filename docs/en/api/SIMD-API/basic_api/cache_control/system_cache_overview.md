...
| NDDMA Cache | NdDmaDci | Before using the [multi-dimensional data transfer DataCopy](../../Basic API/memory_vector_compute/Data Transfer/DataCopy_GMToUB_NDDMA.md) API for data transfer, use the **NdDmaDci** API to refresh the NDDMA Cache to ensure it is in the latest state. |
