...
<!-- md-trans-meta sourceCommit=e3c8c70b3f5d27f3770063ae4b535bc75d904e3e translatedAt=2026-08-27T17:42:31.217Z -->
...
Blocks the AIV until all tasks in the Arrive group are complete, and then starts executing tasks.
...
<tbody><tr id="zh-cn_topic_0000001526206862_zh-cn_topic_0000001389783361_row152234713443"><td class="cellrowborder" valign="top" width="17.22%" headers="mcps1.2.4.1.1 "><p id="p2055524619119"><a name="p2055524619119"></a><a name="p2055524619119"></a>**waitIndex**</p></td>
...
This API can be used in loops. However, due to the communication efficiency requirements between multiple cores, the maximum number of loop iterations cannot exceed 1,048,575.

## Example<a name="zh-cn_topic_0000001526206862_section97001499599"></a>

```
if (id >= 0 && id < ARRIVE_NUM) {
  //Various Vector computation logic, implemented by the user.
  barA.Arrive(id);
} else if(id >= ARRIVE_NUM && id < ARRIVE_NUM + WAIT_NUM){
  barA.Wait(id - ARRIVE_NUM);  // The AIVs in the six AIVs of the Wait group need to wait for the AIVs in the Arrive group to finish their tasks.
  // Various Vector computation logic, implemented by the user.
}
```
