...
<!-- md-trans-meta sourceCommit=e3c8c70b3f5d27f3770063ae4b535bc75d904e3e translatedAt=2026-08-27T17:39:06.799Z -->
...
Notifies other waiting **AIV**s that this **AIV** has completed its dependent tasks.
...
This API can be used in loops. However, due to the inter-core communication efficiency requirement, the maximum number of loop iterations cannot exceed 1,048,575.
...
if (id >= 0 && id < ARRIVE_NUM) {
  ...
  barA.Arrive(id);  // The Arrive group contains two AIVs, Block0 and Block1, indicating that they have completed their tasks.
}
```
