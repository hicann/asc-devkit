...
<!-- md-trans-meta sourceCommit=9f6ce11d8b0e7d296d9c9a7af96f6025bf5b48d1 translatedAt=2026-08-27T18:12:12.276Z -->
...
Obtains the member variables of the tiling structure.
...
<tbody><tr id="row153582474618"><td class="cellrowborder" valign="top" width="17.22%" headers="mcps1.1.4.1.1 "><p id="p4535924164615"><a name="p4535924164615"></a><a name="p4535924164615"></a>struct_name</p></td>
<td class="cellrowborder" valign="top" width="15.340000000000002%" headers="mcps1.1.4.1.2 "><p id="p453562474614"><a name="p453562474614"></a><a name="p453562474614"></a>Input</p></td>
<td class="cellrowborder" valign="top" width="67.44%" headers="mcps1.1.4.1.3 "><p id="p1553552412466"><a name="p1553552412466"></a><a name="p1553552412466"></a>Specified structure name.</p></td>
</tr>
<tr id="row34771022104613"><td class="cellrowborder" valign="top" width="17.22%" headers="mcps1.1.4.1.1 "><p id="p3477922184612"><a name="p3477922184612"></a><a name="p3477922184612"></a>mem_name</p></td>
<td class="cellrowborder" valign="top" width="15.340000000000002%" headers="mcps1.1.4.1.2 "><p id="p11477112215461"><a name="p11477112215461"></a><a name="p11477112215461"></a>Input</p></td>
<td class="cellrowborder" valign="top" width="67.44%" headers="mcps1.1.4.1.3 "><p id="p747752219463"><a name="p747752219463"></a><a name="p747752219463"></a>Name of the specified member variable.</p></td>
</tr>
...
extern "C" __global__ __aicore__ void add_custom(__gm__ uint8_t *x, __gm__ uint8_t *y, __gm__ uint8_t *z, __gm__ uint8_t *tiling)
{
    KernelAdd op;
    if ASCEND_IS_AIV {
        GET_TILING_DATA(tilingData, tiling);   // The Vector side uses the complete structure registered by default for the operator.
	op.Init(x, y, z, tilingData.totalLength, tilingData.tileNum);
        op.Process();
    } else {
        GET_TILING_DATA_MEMBER(Add_Struct, tCubeTiling, tCubeTilingVar, tiling); // The Cube side uses only the member variable tCubeTiling of the operator-registered structure.
