...
<!-- md-trans-meta sourceCommit=2bc2b38d5648dc61f632186b01ba7f36c2295b13 translatedAt=2026-08-27T14:06:12.541Z -->
...
This API performs an atomic add operation on a specified GM address. It adds the old value (**old_value**) at the GM address pointed to by **address** to the input scalar value (**value**), writes the sum (**new_value**) back to the GM address, and returns the value before modification (**old_value**).
...
// AtomicAdd: Each of the three cores atomically adds 1 to the first element in GM.
uint32_t value = 1;
