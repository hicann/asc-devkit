...
<!-- md-trans-meta sourceCommit=93c993b00c4f6138f380f7a2d742660ee1403179 translatedAt=2026-09-09T10:06:22.041Z -->
...
Abs is a unary vector computation API that computes the absolute value of each element of the input tensor. The formula is as follows:
...
<!-- npu="950" id10 -->
- Computation of the first n complex numbers of the tensor
...
| <!-- npu="950" id11 -->U | Data type of the source operand in the first n complex-number computation APIs of the tensor.<!-- end id11 --> |
...
- For Ascend 950PR/Ascend 950DT
    - The data types supported by T are int8_t, int16_t, half, int32_t, float, and int64_t. The data types int8_t and int64_t are supported only by the first n data computation APIs of the tensor.
...
- Description of UB space usage. For Ascend 950PR/Ascend 950DT:
  - Tensor high-dimensional splitting computation occupies 8 KB of Unified Buffer.
...
- tensor high-dimensional splitting computation example - mask continuous mode
    ...
    Output data dstLocal: [0.0 1.0 2.0 3.0 ...]
    ```

- tensor high-dimensional splitting computation example - mask bitwise mode
...
- Sample of the API for computing the first n complex numbers of a tensor
    ...
    ```bash
    Input data srcLocal: [1+2j  2-3j ...]
    Output data dstLocal: [2.236 3.605 ...]
    ```
<!-- end id24 -->
