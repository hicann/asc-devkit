...
<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-09-09T08:53:24.943Z pushedAt=2026-09-10T03:14:14.677Z -->
...
Subtracts src1 from src0, uses the difference as the exponent to compute the power of the natural constant e, and writes the result to dst.

When the source operand data type is float, the calculation formula is as follows:

![](../../../../figures/zh-cn_formulaimage_0000002358072388.png)

When the source operand data type is half, the calculation formula is as follows:

For Ascend 950PR/Ascend 950DT:

![](../../../../figures/zh-cn_formulaimage_0000002391634117.png)
...
<table><thead align="left"><tr id="row118356578583"><th class="cellrowborder" valign="top" width="18.59%" id="mcps1.2.3.1.1"><p id="p48354572582"><a name="p48354572582"></a><a name="p48354572582"></a>Parameter</p></th>
<th class="cellrowborder" valign="top" width="81.41000000000001%" id="mcps1.2.3.1.2"><p id="p583535795817"><a name="p583535795817"></a><a name="p583535795817"></a>Description</p></th>
</tr>
</thead>
<tbody><tr id="row1835857145817"><td class="cellrowborder" valign="top" width="18.59%" headers="mcps1.2.3.1.1 "><p id="p5835457165816"><a name="p5835457165816"></a><a name="p5835457165816"></a>T</p></td>
<td class="cellrowborder" valign="top" width="81.41000000000001%" headers="mcps1.2.3.1.2 "><p id="p168351657155818"><a name="p168351657155818"></a><a name="p168351657155818"></a>Destination operand data type.</p>
<p id="p468305719192"><a name="p468305719192"></a><a name="p468305719192"></a><span id="ph126252025205"><a name="ph126252025205"></a><a name="ph126252025205"></a>Ascend 950PR/Ascend 950DT</span>, supported data types: half, float.</p></td>
</tr>
<tr id="row3862230195114"><td class="cellrowborder" valign="top" width="18.59%" headers="mcps1.2.3.1.1 "><p id="p17859630135113"><a name="p17859630135113"></a><a name="p17859630135113"></a>U</p></td>
<td class="cellrowborder" valign="top" width="81.41000000000001%" headers="mcps1.2.3.1.2 "><p id="p685914301515"><a name="p685914301515"></a><a name="p685914301515"></a>Source operand data type.</p>
<p id="p2060916912719"><a name="p2060916912719"></a><a name="p2060916912719"></a><span id="ph15609179112715"><a name="ph15609179112715"></a><a name="ph15609179112715"></a>Ascend 950PR/Ascend 950DT</span>, supported data types: half, float.</p></td>
</tr>
</tbody>
</table>
...
<tr id="row2137145181815"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.2.4.1.1 "><p id="p6844125874315"><a name="p6844125874315"></a><a name="p6844125874315"></a>src0, src1</p></td>
...
<p id="p7198164815418"><a name="p7198164815418"></a><a name="p7198164815418"></a><span id="ph1119894813419"><a name="ph1119894813419"></a><a name="ph1119894813419"></a>The start address of LocalTensor must be 32-byte aligned.</span></p></td>
</tr>
...
```
Input data src0Local: [1 2 4 ... 510]
Input data src1Local: [1 1 2 ... 510]
Output data dstLocal: [1 2.71828 7.38905 ... 1]
```
