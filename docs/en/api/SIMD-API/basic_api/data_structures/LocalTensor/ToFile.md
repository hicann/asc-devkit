...
<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-08-27T13:14:40.173Z -->
...
Only for CPU debugging, dumps **LocalTensor** data to a file for precision debugging. The file is saved in the execution directory.
...
<tbody><tr id="row42461942101815"><td class="cellrowborder" valign="top" width="13.94%" headers="mcps1.2.4.1.1 "><p id="p1412263682319"><a name="p1412263682319"></a><a name="p1412263682319"></a>fileName</p></td>
...
<td class="cellrowborder" valign="top" width="73.08%" headers="mcps1.2.4.1.3 "><p id="p870194216528"><a name="p870194216528"></a><a name="p870194216528"></a>Name of the file to be saved.</p></td>
</tr>
</tbody>
</table>
...
Returns 0 if data dump succeeds, and a non-zero value if it fails.
...
```cpp
// Example: For CPU debugging only, dump LocalTensor data to a file for precision debugging. The file is saved in the execution directory.
