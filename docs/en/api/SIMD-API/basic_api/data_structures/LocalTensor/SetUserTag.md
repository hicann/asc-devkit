# SetUserTag<a name="ZH-CN_TOPIC_0000002364805841"></a>

<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-08-27T13:13:31.871Z -->
...
Adds user-defined information to a **Tensor**. Users can set the corresponding **Tag** as needed. Subsequently, the Tag information of a specified **Tensor** can be obtained through [GetUserTag](GetUserTag.md), and the **Tensor** can be operated on accordingly based on the Tag information.
...
<tbody><tr id="row42461942101815"><td class="cellrowborder" valign="top" width="13.94%" headers="mcps1.2.4.1.1 "><p id="p284425844311"><a name="p284425844311"></a><a name="p284425844311"></a>tag</p></td>
...
<td class="cellrowborder" valign="top" width="73.08%" headers="mcps1.2.4.1.3 "><p id="p16599937192311"><a name="p16599937192311"></a><a name="p16599937192311"></a>Tag information to be set. The type **TTagType** corresponds to **int32_t**.</p></td>
</tr>
</tbody>
</table>
...
inputLocal.SetUserTag(tag); // Set the tag information for LocalTensor.
```
