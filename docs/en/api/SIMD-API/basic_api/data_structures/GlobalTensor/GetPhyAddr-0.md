...
<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-08-27T12:44:44.687Z -->
...
Gets the address of the global data.
...
-   Get the address of the global data (specifying an offset of **offset** elements).
...
<td class="cellrowborder" valign="top" width="73.08%" headers="mcps1.2.4.1.3 "><p id="p126017529210"><a name="p126017529210"></a><a name="p126017529210"></a><span>Number of elements to offset, used to specify the position of the data.</span></p></td>
</tr>
</tbody>
</table>
...
Returns the address of the global data.
