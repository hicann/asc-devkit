...
<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-08-27T12:18:34.993Z -->
...
Returns the negative infinity value of the specified data type.
...
- Vector API, assigning negative infinity to the first **count** elements of **dstLocal**:
...
The scalar API returns the negative infinity value of the corresponding data type.
...
- Vector API:
    ...
    ```cpp
    AscendC::NumericLimits<float>::NegativeInfinity(dstLocal, 256);// Returns 256 negative infinity values of the float type.
    ```
