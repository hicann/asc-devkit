...
<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-08-27T12:15:54.650Z -->
...
Returns the positive infinity value of the specified data type.
...
- Vector API, which assigns positive infinity to the first **count** elements of **dstLocal**:
...
The scalar API returns the positive infinity value of the corresponding data type.
...
- Vector API:
    ...
    ```cpp
    AscendC::NumericLimits<float>::Infinity(dstLocal, 256); // Returns 256 positive infinity values of the float type.
    ```
