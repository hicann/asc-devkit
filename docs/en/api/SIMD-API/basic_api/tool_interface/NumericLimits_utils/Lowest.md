...
<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-08-27T12:16:38.742Z -->
...
Returns the lowest finite value of the specified data type, that is, the finite value x for which no other finite value y satisfies y < x.
...
- Vector API, which assigns the lowest finite value to the first **count** elements of **dstLocal**:
...
The scalar API returns the lowest finite value of the corresponding data type.
...
- Vector API:
    ...
    ```cpp
    AscendC::NumericLimits<int32_t>::Lowest(dstLocal, 256);// Returns 256 int32_t lowest finite values.
    ```
