# More Examples<a name="ZH-CN_TOPIC_0000002364273434"></a>

<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-08-27T11:54:37.032Z -->

-   Example of using TensorTrait with the basic vector computation API
...
-   Example of using TensorTrait with the basic cube computation API
    ...
    private:
        ...
        __aicore__ inline void SplitA()
        {
            ...
            if (initl0 == true) {
                AscendC::Fill(a2Local, {static_cast<uint16_t>(m * k * sizeof(fmap_T) / 512), 1, 0, 1});
            } else{
        ...
        __aicore__ inline void CopyOut()
        {
            ...
            enhancedParams.blockMode = AscendC::BlockMode::BLOCK_MODE_CUBE;
