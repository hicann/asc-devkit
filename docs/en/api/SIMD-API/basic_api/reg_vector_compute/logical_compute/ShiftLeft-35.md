...
<!-- md-trans-meta sourceCommit=87fcc89e932521312a6dc152579c1037d8e11853 translatedAt=2026-08-27T22:09:33.184Z -->
...
Based on the mask, performs a left shift on the input data **srcReg0** according to the corresponding elements of **srcReg1**, and writes the result to **dstReg**.
...
<td class="cellrowborder" valign="top" width="81.65%" headers="mcps1.2.3.1.2 "><p id="p168351657155818"><a name="p168351657155818"></a><a name="p168351657155818"></a>Data type of the source operand.</p>
<p id="p127911257381"><a name="p127911257381"></a><a name="p127911257381"></a><span id="ph1679112523817"><a name="ph1679112523817"></a><a name="ph1679112523817"></a>Ascend 950PR/Ascend 950DT</span>: Supported data types: uint8_t/int8_t/uint16_t/int16_t/uint32_t/int32_t/uint64_t/int64_t.</p></td>
</tr>
...
<td class="cellrowborder" valign="top" width="81.65%" headers="mcps1.2.3.1.2 "><p id="p7564191710185"><a name="p7564191710185"></a><a name="p7564191710185"></a>Data type of the left shift parameter.</p>
<p id="p1891493003912"><a name="p1891493003912"></a><a name="p1891493003912"></a><span id="ph6914123018395"><a name="ph6914123018395"></a><a name="ph6914123018395"></a>Ascend 950PR/Ascend 950DT</span>: Supported data types: int8_t/int16_t/int32_t/int64_t.</p>
<p id="p68181291745"><a name="p68181291745"></a><a name="p68181291745"></a><span>For the data type constraints of the source operand and the destination operand, see</span><a href="#table15348612514">Table 3 Data type constraints of the source operand and the destination operand</a>.</p></td>
</tr>
<tr id="row916216311197"><td class="cellrowborder" valign="top" width="18.35%" headers="mcps1.2.3.1.1 "><p id="p6802539661"><a name="p6802539661"></a><a name="p6802539661"></a>mode</p></td>
<td class="cellrowborder" valign="top" width="81.65%" headers="mcps1.2.3.1.2 "><p id="p77520541653"><a name="p77520541653"></a><a name="p77520541653"></a>Selects the MERGING mode or ZEROING mode.</p>
<a name="ul1163765616511"></a><a name="ul1163765616511"></a><ul id="ul1163765616511"><li>**ZEROING**: Elements not selected by the mask are set to zero in dst.</li><li>**MERGING**: Currently not supported.</li></ul></td>
</tr>
<tr id="row36123513619"><td class="cellrowborder" valign="top" width="18.35%" headers="mcps1.2.3.1.1 "><p id="p916243141912"><a name="p916243141912"></a><a name="p916243141912"></a>S</p></td>
...
<tr id="row0687131810519"><td class="cellrowborder" valign="top" width="18.35%" headers="mcps1.2.3.1.1 "><p id="p156882018157"><a name="p156882018157"></a><a name="p156882018157"></a>V</p></td>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.2.4.1.3 "><p id="p21216245395"><a name="p21216245395"></a><a name="p21216245395"></a>Source operand.</p>
<p id="p181326485341"><a name="p181326485341"></a><a name="p181326485341"></a>The type is <a href="../register_data_types/RegTensor.md">RegTensor</a>.</p>
<p id="p19711819173920"><a name="p19711819173920"></a><a name="p19711819173920"></a>Setting it to a negative number is not supported.</p></td>
</tr>
...
<tr id="row4532510164711"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p204451180503"><a name="p204451180503"></a><a name="p204451180503"></a>uint64_t</p></td>
...
<tr id="row03411632513"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p1319018218263"><a name="p1319018218263"></a><a name="p1319018218263"></a>int8_t</p></td>
...
<tr id="row203417618256"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p51904232620"><a name="p51904232620"></a><a name="p51904232620"></a>int16_t</p></td>
...
<tr id="row1022415972519"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p1919013222612"><a name="p1919013222612"></a><a name="p1919013222612"></a>int32_t</p></td>
...
<tr id="row18107145118466"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p125401256184615"><a name="p125401256184615"></a><a name="p125401256184615"></a>int64_t</p></td>
...
-   For an arithmetic shift (signed data type), if **srcReg0** is less than 0, **srcReg1** is less than 0, and the shift amount is greater than the data type bit width, the output is -1; if **srcReg0** is greater than 0 and the shift amount is greater than the data type bit width, the output is 0.
