...
<!-- md-trans-meta sourceCommit=87fcc89e932521312a6dc152579c1037d8e11853 translatedAt=2026-08-27T21:33:42.024Z -->
...
**dstReg** is multiplied by **srcReg0** and then added to **srcReg1**, and the result is written to **dstReg** based on **mask**. The calculation formula is as follows:
...
<td class="cellrowborder" valign="top" width="81.42%" headers="mcps1.2.3.1.2 "><p id="p948920511581"><a name="p948920511581"></a><a name="p948920511581"></a>Operand data type.</p>
<p id="p153204151019"><a name="p153204151019"></a><a name="p153204151019"></a><span id="ph133209151609"><a name="ph133209151609"></a><a name="ph133209151609"></a>Ascend 950PR/Ascend 950DT</span>, supported data types: half/bfloat16_t/float.</p></td>
</tr>
<tr id="row356441781813"><td class="cellrowborder" valign="top" width="18.58%" headers="mcps1.2.3.1.1 "><p id="p1756419170189"><a name="p1756419170189"></a><a name="p1756419170189"></a>mode</p></td>
<td class="cellrowborder" valign="top" width="81.42%" headers="mcps1.2.3.1.2 "><p id="p77520541653"><a name="p77520541653"></a><a name="p77520541653"></a>Selects the MERGING mode or the ZEROING mode. Currently, only the ZEROING mode is supported.</p>
...
<tr id="row916216311197"><td class="cellrowborder" valign="top" width="18.58%" headers="mcps1.2.3.1.1 "><p id="p916243141912"><a name="p916243141912"></a><a name="p916243141912"></a>U</p></td>
<td class="cellrowborder" valign="top" width="81.42%" headers="mcps1.2.3.1.2 "><p id="p15901115914145"><a name="p15901115914145"></a><a name="p15901115914145"></a><span id="ph19851723182011"><a name="ph19851723182011"></a><a name="ph19851723182011"></a>RegTensor type of the destination operand, for example, **RegTensor&lt;half&gt;**. It is automatically deduced by the compiler and does not need to be specified by the user.</span></p></td>
</tr>
</tbody>
</table>
...
<p id="p74744436423"><a name="p74744436423"></a><a name="p74744436423"></a>The type is <a href="../register_data_types/RegTensor.md">RegTensor</a>.</p>
<p id="p13224257695"><a name="p13224257695"></a><a name="p13224257695"></a>The data type must be consistent with that of the destination operand.</p></td>
</tr>
