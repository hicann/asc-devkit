...
<!-- md-trans-meta sourceCommit=87fcc89e932521312a6dc152579c1037d8e11853 translatedAt=2026-08-27T21:31:51.376Z -->
...
Performs a multiply-add operation element-wise on the input data **dstReg**, **srcReg**, and **scalarValue** based on **mask**, and writes the result to **dstReg**. The calculation formula is as follows:

![](../../../../figures/zh-cn_formulaimage_0000002523920653.png)
...
<td class="cellrowborder" valign="top" width="81.73%" headers="mcps1.2.3.1.2 "><p id="p168351657155818"><a name="p168351657155818"></a><a name="p168351657155818"></a>Operand data type.</p>
<p id="p1940551913268"><a name="p1940551913268"></a><a name="p1940551913268"></a><span id="ph240501915267"><a name="ph240501915267"></a><a name="ph240501915267"></a>Ascend 950PR/Ascend 950DT</span>: Supported data types: half/float/uint64_t/int64_t.</p></td>
</tr>
<tr id="row553324655815"><td class="cellrowborder" valign="top" width="18.27%" headers="mcps1.2.3.1.1 "><p id="p127754478583"><a name="p127754478583"></a><a name="p127754478583"></a>**U**</p></td>
...
<p id="p47157331012"><a name="p47157331012"></a><a name="p47157331012"></a><span id="ph18715233918"><a name="ph18715233918"></a><a name="ph18715233918"></a>Ascend 950PR/Ascend 950DT</span>: Supported data types: half/float/uint64_t/int64_t.</p></td>
</tr>
<tr id="row18835145716587"><td class="cellrowborder" valign="top" width="18.27%" headers="mcps1.2.3.1.1 "><p id="p1383515717581"><a name="p1383515717581"></a><a name="p1383515717581"></a>**mode**</p></td>
<td class="cellrowborder" valign="top" width="81.73%" headers="mcps1.2.3.1.2 "><p id="p77520541653"><a name="p77520541653"></a><a name="p77520541653"></a>Selects the MERGING mode or ZEROING mode. Currently, only the ZEROING mode is supported.</p>
<a name="ul1163765616511"></a><a name="ul1163765616511"></a><ul id="ul1163765616511"><li>ZEROING: Elements not selected by the mask are set to zero in dst. Only this mode is supported.</li></ul></td>
</tr>
<tr id="row12899183713202"><td class="cellrowborder" valign="top" width="18.27%" headers="mcps1.2.3.1.1 "><p id="p916243141912"><a name="p916243141912"></a><a name="p916243141912"></a>S</p></td>
...
<tr id="row11773440341"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.2.4.1.1 "><p id="p10132448173420"><a name="p10132448173420"></a><a name="p10132448173420"></a>**scalarValue**</p></td>
...
<p id="p157131671911"><a name="p157131671911"></a><a name="p157131671911"></a>Type: scalar.</p>
<p id="p813204817342"><a name="p813204817342"></a><a name="p813204817342"></a>The data types of the two source operands must be consistent with that of the destination operand.</p></td>
</tr>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.2.4.1.3 "><p id="p11541143920"><a name="p11541143920"></a><a name="p11541143920"></a><span id="ph15776181222"><a name="ph15776181222"></a><a name="ph15776181222"></a>Effective indication of source operand element operations. For details, see <a href="../register_data_types/MaskReg.md">MaskReg</a>.</span></p></td>
</tr>
</tbody>
</table>
...
## Example<a name="section98571172212"></a>
