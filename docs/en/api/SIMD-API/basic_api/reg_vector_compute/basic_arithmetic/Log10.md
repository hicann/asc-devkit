...
<!-- md-trans-meta sourceCommit=87fcc89e932521312a6dc152579c1037d8e11853 translatedAt=2026-08-27T21:47:01.394Z -->
...
Performs a base-10 logarithm operation on the input data **srcReg** according to **mask**, and writes the result to **dstReg**. The calculation formula is as follows:
...
<p id="p1218065664919"><a name="p1218065664919"></a><a name="p1218065664919"></a><span id="ph8180656154911"><a name="ph8180656154911"></a><a name="ph8180656154911"></a>Ascend 950PR/Ascend 950DT</span>, supported data types: half, float.</p></td>
</tr>
...
<td class="cellrowborder" valign="top" width="81.57%" headers="mcps1.2.3.1.2 "><div class="p" id="p4367181482310"><a name="p4367181482310"></a><a name="p4367181482310"></a>Can be configured as an enumeration of MaskMergeMode or a structure of Log10SpecificMode.<a name="ul1131085281310"></a><a name="ul1131085281310"></a><ul id="ul1131085281310"><li>MaskMergeMode, selects the MERGING mode or the ZEROING mode.<a name="ul13721340113818"></a><a name="ul13721340113818"></a><ul id="ul13721340113818"><li>ZEROING, elements not filtered by the mask are set to zero in dstReg.</li><li>MERGING, not supported.</li></ul>
</li><li>Log10SpecificMode, defined as follows:<pre class="screen" id="screen18481935171419"><a name="screen18481935171419"></a><a name="screen18481935171419"></a>enum class Log10Algo {
    INTRINSIC = 0,
...
<a name="ul196783155815"></a><a name="ul196783155815"></a><ul id="ul196783155815"><li>mrgMode: selects the MERGING mode or the ZEROING mode.</li><li>algo: used to configure the Subnormal mode.<a name="ul111801915217"></a><a name="ul111801915217"></a><ul id="ul111801915217"><li>Log10Algo::INTRINSIC, Log10Algo::PRECISION_1ULP_FTZ_TRUE, the result is computed using a single instruction, and all Subnormal values are approximated to 0.</li><li>Log10Algo::PRECISION_1ULP_FTZ_FALSE, supports Subnormal data computation.</li></ul>
</li></ul>
</li></ul>
</div></td>
</tr>
<tr id="row1043313302213"><td class="cellrowborder" valign="top" width="18.43%" headers="mcps1.2.3.1.1 "><p id="p916243141912"><a name="p916243141912"></a><a name="p916243141912"></a>U</p></td>
<td class="cellrowborder" valign="top" width="81.57%" headers="mcps1.2.3.1.2 "><p id="p15901115914145"><a name="p15901115914145"></a><a name="p15901115914145"></a><span id="ph19851723182011"><a name="ph19851723182011"></a><a name="ph19851723182011"></a>RegTensor type of the destination operand, for example, RegTensor&lt;half&gt;. It is automatically inferred by the compiler and does not need to be specified by the user.</span></p></td>
</tr>
</tbody>
</table>
