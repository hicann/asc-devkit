# Mul<a name="ZH-CN_TOPIC_0000001956986917"></a>

<!-- md-trans-meta sourceCommit=87fcc89e932521312a6dc152579c1037d8e11853 translatedAt=2026-08-27T21:51:38.055Z -->
...
Performs element-wise multiplication on the input data **srcReg0** and **srcReg1** based on **mask**, and writes the result to **dstReg**. The calculation formula is as follows:

![](../../../../figures/zh-cn_formulaimage_0000001957708533.png)
...
<table><thead align="left"><tr id="row118356578583"><th class="cellrowborder" valign="top" width="17.76%" id="mcps1.2.3.1.1"><p id="p48354572582"><a name="p48354572582"></a><a name="p48354572582"></a>Parameter</p></th>
<th class="cellrowborder" valign="top" width="82.24000000000001%" id="mcps1.2.3.1.2"><p id="p583535795817"><a name="p583535795817"></a><a name="p583535795817"></a>Description</p></th>
</tr>
</thead>
<tbody><tr id="row1835857145817"><td class="cellrowborder" valign="top" width="17.76%" headers="mcps1.2.3.1.1 "><p id="p5835457165816"><a name="p5835457165816"></a><a name="p5835457165816"></a>T</p></td>
<td class="cellrowborder" valign="top" width="82.24000000000001%" headers="mcps1.2.3.1.2 "><p id="p168351657155818"><a name="p168351657155818"></a><a name="p168351657155818"></a>Operand data type.</p>
<p id="p191381421619"><a name="p191381421619"></a><a name="p191381421619"></a><span id="ph13138124214116"><a name="ph13138124214116"></a><a name="ph13138124214116"></a>Ascend 950PR/Ascend 950DT</span> supports the following data types: uint16_t/int16_t/uint32_t/int32_t/half/float/bfloat16_t/uint64_t/int64_t/complex32/complex64</p></td>
</tr>
<tr id="row18835145716587"><td class="cellrowborder" valign="top" width="17.76%" headers="mcps1.2.3.1.1 "><p id="p1756419170189"><a name="p1756419170189"></a><a name="p1756419170189"></a>mode</p></td>
<td class="cellrowborder" valign="top" width="82.24000000000001%" headers="mcps1.2.3.1.2 "><p id="p77520541653"><a name="p77520541653"></a><a name="p77520541653"></a>Selects the MERGING mode or the ZEROING mode.</p>
<a name="ul1163765616511"></a><a name="ul1163765616511"></a><ul id="ul1163765616511"><li>ZEROING, elements not selected by the mask are set to zero in dstReg.</li><li>MERGING, currently not supported.</li></ul></td>
</tr>
<tr id="row465710455516"><td class="cellrowborder" valign="top" width="17.76%" headers="mcps1.2.3.1.1 "><p id="p916243141912"><a name="p916243141912"></a><a name="p916243141912"></a>U</p></td>
<td class="cellrowborder" valign="top" width="82.24000000000001%" headers="mcps1.2.3.1.2 "><p id="p15901115914145"><a name="p15901115914145"></a><a name="p15901115914145"></a><span id="ph19851723182011"><a name="ph19851723182011"></a><a name="ph19851723182011"></a>RegTensor type of the destination operand, for example, RegTensor&lt;half&gt;. It is automatically inferred by the compiler and does not need to be specified by the user.</span></p></td>
</tr>
</tbody>
</table>
...
<p id="p1484485824312"><a name="p1484485824312"></a><a name="p1484485824312"></a></p></td>
</tr>
...
<p id="p813204817342"><a name="p813204817342"></a><a name="p813204817342"></a>Type: <a href="../register_data_types/RegTensor.md">RegTensor</a>.</p>
<p id="p12132154853419"><a name="p12132154853419"></a><a name="p12132154853419"></a></p></td>
</tr>
...
The result is in unsaturated mode.
