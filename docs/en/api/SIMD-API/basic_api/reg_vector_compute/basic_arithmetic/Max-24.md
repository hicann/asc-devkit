...
<!-- md-trans-meta sourceCommit=87fcc89e932521312a6dc152579c1037d8e11853 translatedAt=2026-08-27T21:49:19.523Z -->
...
Performs an element-wise maximum operation on the source operands **srcReg0** and **srcReg1** based on the mask, and writes the result to the destination operand **dstReg**. The calculation formula is as follows:

![](../../../../figures/zh-cn_formulaimage_0000001930511850.png)
...
<td class="cellrowborder" valign="top" width="81.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p168351657155818"><a name="p168351657155818"></a><a name="p168351657155818"></a>Operand data type.</p>
<p id="p133471255132"><a name="p133471255132"></a><a name="p133471255132"></a><span id="ph16347355936"><a name="ph16347355936"></a><a name="ph16347355936"></a>Ascend 950PR/Ascend 950DT</span>, supported data types are: uint8_t/int8_t/uint16_t/int16_t/uint32_t/int32_t/uint64_t/int64_t/half/float/bfloat16_t</p></td>
</tr>
<tr id="row18835145716587"><td class="cellrowborder" valign="top" width="18.18%" headers="mcps1.2.3.1.1 "><p id="p1756419170189"><a name="p1756419170189"></a><a name="p1756419170189"></a>mode</p></td>
<td class="cellrowborder" valign="top" width="81.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p77520541653"><a name="p77520541653"></a><a name="p77520541653"></a>Selects the MERGING mode or the ZEROING mode.</p>
<a name="ul1163765616511"></a><a name="ul1163765616511"></a><ul id="ul1163765616511"><li>ZEROING, elements not selected by the mask are set to zero in dstReg.</li><li>MERGING, elements not selected by the mask retain the original values in dstReg.</li></ul></td>
</tr>
<tr id="row3100156125812"><td class="cellrowborder" valign="top" width="18.18%" headers="mcps1.2.3.1.1 "><p id="p916243141912"><a name="p916243141912"></a><a name="p916243141912"></a>U</p></td>
<td class="cellrowborder" valign="top" width="81.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p15901115914145"><a name="p15901115914145"></a><a name="p15901115914145"></a><span id="ph19851723182011"><a name="ph19851723182011"></a><a name="ph19851723182011"></a>RegTensor type of the destination operand, for example, RegTensor&lt;half&gt;, which is automatically deduced by the compiler and does not need to be specified by the user.</span></p></td>
</tr>
</tbody>
</table>
...
<p id="p1020395410265"><a name="p1020395410265"></a><a name="p1020395410265"></a><span id="ph920355410265"><a name="ph920355410265"></a><a name="ph920355410265"></a>The type is <a href="../register_data_types/RegTensor.md">RegTensor</a>.</span></p>
...
<p id="p19308559261"><a name="p19308559261"></a><a name="p19308559261"></a><span id="ph393025522616"><a name="ph393025522616"></a><a name="ph393025522616"></a>The type is <a href="../register_data_types/RegTensor.md">RegTensor</a>.</span></p>
