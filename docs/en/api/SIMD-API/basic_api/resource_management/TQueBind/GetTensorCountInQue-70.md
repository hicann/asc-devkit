...
<!-- md-trans-meta sourceCommit=f6490d1e030d257ee55f3f1600bffece5a8bd3f7 translatedAt=2026-08-27T14:50:58.763Z -->
...
Queries the number of **Tensor**s enqueued in the **Que**.
...
Returns the number of **Tensor**s that have been enqueued in the **Que**.

## Example<a name="section642mcpsimp"></a>

```
// Query the number of tensors enqueued in the queue through GetTensorCountInQue. Memory is allocated through the AllocTensor API and added to the queue, so num is 1.
AscendC::TPipe pipe;
