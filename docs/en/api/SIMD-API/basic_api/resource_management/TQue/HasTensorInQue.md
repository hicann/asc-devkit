# HasTensorInQue<a name="ZH-CN_TOPIC_0000001500187481"></a>

<!-- md-trans-meta sourceCommit=f6490d1e030d257ee55f3f1600bffece5a8bd3f7 translatedAt=2026-08-27T14:44:48.512Z -->
...
-   true - The **Queue** contains enqueued **Tensors**.
-   false - The **Queue** is completely idle.

## Example<a name="section642mcpsimp"></a>

```
// Determine whether the current queue contains an enqueued Tensor based on VacantInQue. The current queue depth is 4, no memory Enque operation is performed, and false is returned.
AscendC::TPipe pipe;
