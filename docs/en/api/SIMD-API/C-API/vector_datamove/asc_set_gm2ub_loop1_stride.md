...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-08T04:46:49.786Z pushedAt=2026-09-08T13:17:42.528Z -->
...
When transferring data from Global Memory (GM) to Unified Buffer (UB), call this API to set the stride between adjacent iteration data blocks in the inner loop.
...
|------------|------------|-----------|
| **loop1_src_stride**     | Input     | Stride between adjacent iteration source operand data blocks in the inner loop, in bytes, with a value range of [0, 2^40).|
| **loop1_dst_stride**     | Input     | Stride between adjacent iteration destination operand data blocks in the inner loop, in bytes, with a value range of [0, 2^21), and must be 32B-aligned.|
