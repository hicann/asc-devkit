...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-08T04:18:52.233Z pushedAt=2026-09-08T13:17:42.504Z -->
...
- When **dst_stride** is not equal to **len_burst**, **dst_stride** must be 32-byte aligned.

## Example

```cpp
// total_length refers to the total length of the data involved in the copy. src is the externally input GM memory of the half type.
