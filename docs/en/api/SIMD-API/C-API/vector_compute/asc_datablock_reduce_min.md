...
<!-- md-trans-meta sourceCommit=b89e273df218e4b8c2c6857aeec20f0a35233b01 translatedAt=2026-09-05T13:43:44.477Z pushedAt=2026-09-08T03:45:05.461Z -->
...
Performs a reduce-min operation on the data block.
...
| dst_repeat_stride | Input | Address stride between the same DataBlock in adjacent iterations of the destination operand.<br>When the input type bit width is 16 bits, the unit is 16 bytes; when the input type bit width is 32 bits, the unit is 32 bytes.|
