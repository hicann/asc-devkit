...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T13:31:08.016Z pushedAt=2026-09-08T03:45:05.445Z -->
...
Performs element-wise summation followed by ReLU computation (comparing the result with 0 and taking the larger value), and provides the capability to convert the data type of the final result (s162s8, f322f16, f162s8). The calculation formula is as follows:
...
| src0, src1 | Input | Starting address of the source operand (vector).                        |
...
| dst_repeat_stride | Input | Address stride between the same DataBlock across adjacent iterations of the destination operand. |
| src0_repeat_stride | Input | Address stride between the same DataBlock across adjacent iterations of source operand 0. |
| src1_repeat_stride | Input | Address stride between the same DataBlock across adjacent iterations of source operand 1. |
...
```cpp
// The data types of the destination operand and the source operands are the same.
...
```cpp
// The data types of the destination operand and the source operand are inconsistent (s162s8).
