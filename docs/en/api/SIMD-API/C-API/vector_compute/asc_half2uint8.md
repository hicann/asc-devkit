...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T14:27:21.257Z pushedAt=2026-09-08T03:45:05.512Z -->
...
Converts half type data to uint8_t type, supporting multiple rounding modes:

- NONE rounding mode: When the conversion involves precision loss, it represents the RINT rounding mode; when no precision loss is involved, it represents no rounding.
...
```cpp
//total_length indicates the total length of data involved in the conversion.
