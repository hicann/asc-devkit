...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T14:59:32.606Z pushedAt=2026-09-08T03:45:05.557Z -->
...
Each element in **src** is compared with the scalar **value** one by one. If an element at a certain position is not equal to **value**, the corresponding bit of the output result **dst** is set to 1; otherwise, it is set to 0.
...
- **dst** is sorted in little-endian order into a binary result, corresponding to the comparison result of the data at the corresponding position in **src**.

## Example

```cpp
// Output the result to the destination address, fixed to 128 elements.
