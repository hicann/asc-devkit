...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T13:55:41.193Z pushedAt=2026-09-08T03:45:05.477Z -->
...
Converts float data to half type, supporting multiple rounding modes:
...
- ODD rounding mode: Von Neumann rounding (round to nearest, ties to odd).

## Prototype

- Computes the first n data elements

  ```cpp
  // Indicates RINT rounding mode when precision loss occurs during conversion, and no rounding when no precision loss is involved.
