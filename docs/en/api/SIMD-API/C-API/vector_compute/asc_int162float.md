...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T14:30:01.925Z pushedAt=2026-09-08T03:45:05.509Z -->
...
Converts **int16_t** data to the **float** type.
...
asc_int162float(dst, src, total_length);    // Convert src to the float type and store the result in dst.
```
