...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T14:32:50.122Z pushedAt=2026-09-08T03:45:05.518Z -->
...
Converts int32_t data to int16_t.
...
| :--- | :--- | :--- |
| dst | Output | Starting address of the destination operation (vector). |
...
| dst_block_stride | Input | Address stride between different DataBlocks within a single iteration of the destination operation. |
| src_block_stride | Input | Address stride between different DataBlocks within a single iteration of the source operand. |
| dst_repeat_stride | Input | Address stride of the same DataBlock between adjacent iterations of the destination operation. |
...
asc_int322int16(dst, src, total_length);    // Convert src to int16_t and store the result in dst.
```
