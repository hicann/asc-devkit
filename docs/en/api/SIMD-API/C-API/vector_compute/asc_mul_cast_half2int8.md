...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T14:55:12.926Z pushedAt=2026-09-08T03:45:05.550Z -->
...
Computes the product of two source operands element-wise and converts the result to the int8_t type. The calculation formula is as follows:
$$
dst_i = Cast(src0_i * src1_i)
$$

Precision conversion rule: The product of the source operands is converted using the RINT rounding mode (round half to even), and overflow is handled by saturation.
