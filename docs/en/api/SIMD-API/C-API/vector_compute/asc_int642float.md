...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T14:37:47.216Z pushedAt=2026-09-08T03:45:05.524Z -->
...
Converts int64_t data to float type.
...
```cpp
// total_length indicates the total length of the data involved in the conversion.
constexpr uint64_t total_length = 128;
__ubuf__ int64_t src[total_length];
__ubuf__ float dst[total_length];
asc_int642float_rn(dst, src, total_length);    // Convert src to float type and store the result in dst.
```
