...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T10:14:51.003Z pushedAt=2026-09-05T12:14:28.859Z -->
...
Converts int16_t data to int32_t data.

Because the bit-width ratio between the source operand and the destination operand is 1:2, the data of one VL size must be divided into two parts when reading, and index 0 or index 1 is selected according to the API.
...
asc_loadalign(src, src_addr); // src_addr is the UB memory space address input externally.
