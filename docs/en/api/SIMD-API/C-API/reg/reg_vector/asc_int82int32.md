...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T10:32:26.538Z pushedAt=2026-09-05T12:14:28.886Z -->
...
Converts data of the **int8_t** type to the **int32_t** type.

Because the bit-width ratio between the source operand and the destination operand is 1:4, when reading data, one **VL**-sized data block must be divided into four parts, and index 0, index 1, index 2, or index 3 is selected according to the API used.

## Prototype

```cpp
// Read the data at index 0.
__simd_callee__ inline void asc_int82int32(vector_int32_t& dst, vector_int8_t src, vector_bool mask)
// Read the data at index 1.
__simd_callee__ inline void asc_int82int32_v2(vector_int32_t& dst, vector_int8_t src, vector_bool mask)
// Read the data at index 2.
__simd_callee__ inline void asc_int82int32_v3(vector_int32_t& dst, vector_int8_t src, vector_bool mask)
// Read the data at index 3.
