...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T10:07:56.988Z pushedAt=2026-09-05T12:14:28.853Z -->
...
Converts **hifloat8_t** data to the **float** type.

Since the bit-width ratio between the source operand and the destination operand is 1:4, when reading data, one **VL**-sized data block must be divided into four parts, and index 0, index 1, index 2, or index 3 is selected depending on the API.
