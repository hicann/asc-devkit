...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T10:22:32.698Z pushedAt=2026-09-05T12:14:28.870Z -->
...
Converts the int32_t type to the uint8_t type.

Overflow modes:
- Non-saturation mode: The result is truncated to the data width of the destination format, and the least significant bit (LSB) is retained.
- Saturation mode: The result is clamped to the representable range of the destination format.

Because the bit-width ratio between the source operand and the destination operand is 4:1, data of one VL size must be divided into four parts when written, and index 0, index 1, index 2, or index 3 is selected according to the API.
