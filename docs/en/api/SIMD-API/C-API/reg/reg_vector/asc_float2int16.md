...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T09:45:02.791Z pushedAt=2026-09-05T12:14:28.829Z -->
...
- Non-saturation mode:
  ...
  - When the input data is +/-inf, returns the maximum/minimum value of the output type.
  - When the input data is NaN, returns 0.
- Saturation mode:
  - When the input data exceeds the range of the output type, returns the corresponding maximum/minimum value of the output type.
  - When the input data is +/-inf, returns the maximum/minimum value of the output type.
  - When the input data is NaN, returns 0.
...
- When the saturation mode and non-saturation mode are enabled, configure the **ctrl** register. For details about the **ctrl** register, see [asc_set_ctrl.md](../../sys_var/asc_set_ctrl.md).
