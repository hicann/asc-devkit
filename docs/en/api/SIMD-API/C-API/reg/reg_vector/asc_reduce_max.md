...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T11:05:13.863Z pushedAt=2026-09-05T12:14:28.928Z -->
...
Performs a reduction maximum operation on the source operand **src** based on **mask**: writes the maximum value in **src** to position 0 of the destination operand **dst**, writes the index of the maximum value in **src** to position 1 of **dst**, and sets the remaining positions of **dst** to 0.
...
- When no element participates in the computation, the minimum value of the data type is written to **dst**.
- When multiple maximum values exist, the first maximum value and its index are saved in **dst**.
