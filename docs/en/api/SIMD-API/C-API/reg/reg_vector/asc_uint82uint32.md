...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T11:32:45.126Z pushedAt=2026-09-05T12:14:28.956Z -->
...
Converts **uint8_t** data to **uint32_t** data.

Because the bit-width ratio between the source operand and the destination operand is 1:4, the data of one VL size must be divided into four parts when reading, and index 0, index 1, index 2, or index 3 is selected according to the API used.

## Prototype

```cpp
// Read the position at index 0.
__simd_callee__ inline void asc_uint82uint32(vector_uint32_t& dst, vector_uint8_t src, vector_bool mask)
// Read the position at index 1.
__simd_callee__ inline void asc_uint82uint32_v2(vector_uint32_t& dst, vector_uint8_t src, vector_bool mask)
// Read the position at index 2.
__simd_callee__ inline void asc_uint82uint32_v3(vector_uint32_t& dst, vector_uint8_t src, vector_bool mask)
// Read the position at index 3.
