...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T10:04:43.544Z pushedAt=2026-09-05T12:14:28.850Z -->
...
Converts the **half** type to the **int8_t** type and supports multiple rounding modes.
...
- Non-saturation mode:
  - When the input data exceeds the maximum value of the output type, the result is truncated to the data width of the target format. For example, if the input **half** value is 257, the output **int8_t** value is 1.
  - When the input data is +/-inf, the extreme value of the output type is returned.
  - When the input data is nan, 0 is returned.
- Saturation mode:
  - When the input data exceeds the maximum value of the output type, the corresponding extreme value of the output type is returned. For example, if the input half value is 257, the output int8_t value is 127.
  - When the input data is +/-inf, the extreme value of the output type is returned.
  - When the input data is nan, 0 is returned.
