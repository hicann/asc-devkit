...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T09:27:16.049Z pushedAt=2026-09-05T12:14:28.808Z -->
...
Fills the destination operand **dst** with the lowest element of the source operand **src** according to **mask**.
...
| mask | Input | Source operand mask (mask register). Indicates which elements participate in the calculation. Elements with a corresponding position of 1 participate in the calculation, and those with 0 do not. Elements not selected by **mask** are set to zero in the output. |
