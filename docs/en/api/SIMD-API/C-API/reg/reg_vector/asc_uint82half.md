...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T11:30:04.821Z pushedAt=2026-09-05T12:14:28.954Z -->
...
Because the bit-width ratio of the source operand to the destination operand is 1:2, when reading data, one VL-sized data block must be divided into two parts, and index 0 or index 1 is selected depending on the API.

## Prototype

```cpp
// Read data at even-indexed positions.
__simd_callee__ inline void asc_uint82half(vector_half& dst, vector_uint8_t src, vector_bool mask)    
// Read data at odd-indexed positions.
