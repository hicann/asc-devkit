...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T11:02:28.691Z pushedAt=2026-09-05T12:14:28.921Z -->
...
**PairReduceSum**: Sums each pair of adjacent (odd/even) elements and writes the result to **dst**. For example, if **src**={1,2,3,4}, then **dst**={3,7}.
...
- When **mask** is odd, the last element selected by **mask** is output at the low-order position of **dst** with its original value unchanged.
