...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T10:36:27.341Z pushedAt=2026-09-05T12:14:28.891Z -->
...
Performs an element-wise comparison to determine whether src_i <= value holds. If it holds, the output result is 1; otherwise, it is 0.
...
| mask       | Input    | Source operand mask (mask register), which indicates the elements that participate in the computation. An element participates in the computation when the corresponding bit is 1, and does not participate when the bit is 0. Elements not selected by mask are set to 0 in the output. |
