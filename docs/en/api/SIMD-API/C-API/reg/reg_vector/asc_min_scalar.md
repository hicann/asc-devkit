...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T10:49:07.700Z pushedAt=2026-09-05T12:14:28.905Z -->
...
Compares each element in the source operand vector with the scalar. If an element is greater than the scalar, the scalar value is used; otherwise, the source operand element is used. The formula is as follows:
...
| mask   | Input | Source operand mask (mask register), which indicates the elements that participate in the calculation. Elements with a corresponding bit of 1 participate in the calculation, and those with a bit of 0 do not. Elements not selected by the mask are set to zero in the output. |
