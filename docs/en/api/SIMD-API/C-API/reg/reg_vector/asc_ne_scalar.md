...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-04T10:56:23.480Z pushedAt=2026-09-05T12:14:28.916Z -->
...
Each element in **src** is compared with the scalar **value** one by one. If src_i != value, the corresponding bit of the output result **dst** is set to 1; otherwise, it is set to 0.
...
| **mask** | Input | Source operand mask (mask register), which indicates which elements participate in the computation. A value of 1 at the corresponding position indicates participation, and 0 indicates no participation. Elements not selected by **mask** are set to zero in the output. |
