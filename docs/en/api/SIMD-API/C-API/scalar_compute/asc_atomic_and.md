...
<!-- md-trans-meta sourceCommit=2bc2b38d5648dc61f632186b01ba7f36c2295b13 translatedAt=2026-09-05T12:19:39.047Z pushedAt=2026-09-08T03:45:05.337Z -->
...
Performs an atomic AND operation on data in Global Memory with the specified data, that is, bitwise-ANDs **val** onto the data element pointed to by **address**.
...
Returns the original data in **address** before the operation.
...
```cpp
uint32_t dst = 0xF;      // Initial value.
