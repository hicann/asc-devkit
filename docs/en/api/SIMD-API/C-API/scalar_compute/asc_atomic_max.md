...
<!-- md-trans-meta sourceCommit=2bc2b38d5648dc61f632186b01ba7f36c2295b13 translatedAt=2026-09-05T12:22:48.450Z pushedAt=2026-09-08T03:45:05.341Z -->
...
Performs an atomic maximum operation on the data in Global Memory and the specified data, that is, writes the maximum of the data element pointed to by **address** and **val** back to that address.
...
int32_t old = asc_atomic_max(&dst, 20);  // dst = 20, old = 10
```
