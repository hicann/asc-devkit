...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T12:56:24.792Z pushedAt=2026-09-08T03:45:05.396Z -->
...
Performs a synchronization operation on the PIPE_MTE3 pipeline.
...
// Synchronization operation: Subsequent operations can start only after the preceding operations are complete.
asc_sync();
...
// Synchronization operation: Subsequent operations can start only after the data transfer operation (UB to GM, PIPE_MTE3 pipeline) is complete.
asc_sync_mte3(0);
```
