...
<!-- md-trans-meta sourceCommit=0ece502ce5e30f12c91b14fc87b28b1b051cb796 translatedAt=2026-09-05T12:40:25.729Z pushedAt=2026-09-08T03:45:05.368Z -->
...
Enables the atomic compare-and-min operation for subsequent data transfers from Unified Buffer/L0C Buffer/L1 Buffer to Global Memory. The supported data types are int8_t, int16_t, int32_t, bfloat16_t, half, and float.
<!-- npu="950" id1 -->
...
- After use, it is recommended to disable the atomic minimum operation through [asc_set_atomic_none](./asc_set_atomic_none.md) to avoid affecting the functionality of subsequent related instructions.
<!-- npu="950" id2 -->
...
```cpp
// total_length indicates the length of the data involved in the computation, and dst is the externally provided int8_t GM memory address.
...
Output data dst: [1, 1, 1, ..., 1]   // int8_t type
```
