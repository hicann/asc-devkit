...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-08T12:03:58.106Z -->
...
-   The operator implementation needs to call the AscendQuant API. Reserve a space of **currBuff** size for it, use the **GetAscendQuantTmpBufferFactorSize** API to obtain the output values of **maxLiveNodeCount** and **extraBuf**, and then derive the maximum number of elements that the operator can compute at a time as follows:
...
uint32_t extraBuf = 0;
AscendC::GetAscendQuantTmpBufferFactorSize(maxLiveNodeCount, extraBuf);
```
