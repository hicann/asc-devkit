...
<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-09-09T12:29:57.918Z -->
...
Performs element-wise inverse hyperbolic cosine (arccosh) computation. The calculation formula is as follows:

![](../../../../figures/zh-cn_formulaimage_0000002182892220.png)

![](../../../../figures/zh-cn_formulaimage_0000002183182340.png)
...
| sharedTmpBuffer | Input | Temporary buffer.<br><br>The type is [LocalTensor](../../../basic_api/data_structures/LocalTensor/LocalTensor.md), and the supported TPosition is VECIN/VECCALC/VECOUT.<br><br>Used to store intermediate variables during complex computation inside Acosh, provided by yourself.<br><br>For how to obtain the temporary space size BufferSize, see [GetAcoshMaxMinTmpSize](GetAcoshMaxMinTmpSize.md). |
...
-   The input source data must be kept within the value range of \[1, 65504\]. If the input is out of range, the output result is invalid.
...
```
Input data (srcLocal): [-1.000000 0.000000 1.000000 2.000000 3.000000 4.000000 ...]
Output data (dstLocal): [-nan      -nan     0.000000 1.316958 1.762747 2.063437 ...]
```
