...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-09T13:37:37.747Z -->
...
-   The operator implementation needs to call the **BitwiseXor** API. Reserve a space of **currBuff** size for it, use the **GetBitwiseXorTmpBufferFactorSize** API to obtain the output values of **maxLivedNodeCount** and **extraBuf**, and then derive the maximum number of elements that the operator can compute at a time as follows:
...
| --- | --- | --- |
| **ascendcPlatform** | Input | Platform information to be input. For the definition of **PlatformAscendC**, see [Constructor and Destructor](../../../../Utils-API/platform_info/PlatformAscendC/constructors_and_destructors.md). |
