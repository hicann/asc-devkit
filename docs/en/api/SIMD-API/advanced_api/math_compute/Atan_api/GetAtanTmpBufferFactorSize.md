...
<!-- md-trans-meta sourceCommit=c17b32aa8d725bcb43135ab25add5a26d62ad5c0 translatedAt=2026-09-09T12:53:06.570Z -->
...
-   The operator implementation needs to call the **Atan** API. Reserve a space of **currBuff** size for it, use the **GetAtanTmpBufferFactorSize** API to obtain the output values of **maxLiveNodeCount** and **extraBuf**, and then derive the maximum number of elements that the operator can compute at a time as follows:
...
| **maxLiveNodeCount** | Output | Maximum number of live nodes, indicating how many times the temporary space is the size of the data processed in a single computation. |
...
uint32_t extraBuf = 0;
AscendC::GetAtanTmpBufferFactorSize(typeSize, maxLiveNodeCount, extraBuf);
```
