...
```
void GetLgammaMaxMinTmpSize(const ge::Shape& srcShape, const uint32_t typeSize, const bool isReuseSource, uint32_t& maxValue, uint32_t& minValue)
```
...
uint32_t maxValue = 0;
uint32_t minValue = 0;
AscendC::GetLgammaMaxMinTmpSize(shape, 2, false, maxValue, minValue);
```
