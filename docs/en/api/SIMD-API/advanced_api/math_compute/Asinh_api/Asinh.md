...
<!-- md-trans-meta sourceCommit=0364dcce9ab16d714270f168ec9546fd7620f90f translatedAt=2026-09-09T12:42:23.108Z -->
...
Computes the inverse hyperbolic sine function element-wise. The calculation formula is as follows:
...
| sharedTmpBuffer | Input | Temporary buffer.<br><br>The type is [LocalTensor](../../../basic_api/data_structures/LocalTensor/LocalTensor.md), and the supported TPosition is VECIN/VECCALC/VECOUT.<br><br>Used to store intermediate variables during complex computation inside Asinh, provided by yourself.<br><br>For how to obtain the temporary space size BufferSize, see [GetAsinhMaxMinTmpSize](GetAsinhMaxMinTmpSize.md). |
...
-   The input source data must be kept within the value range \[-65504, 65504\]. If the input is out of range, the output result is invalid.
...
```
Input data srcLocal: [0.000000 0.100000 0.200000 ... 51.000000 51.100002]
Output data dstLocal: [0.000000 0.099834 0.198690 ... 4.625069 4.627028]
```
