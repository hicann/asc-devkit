# UserDefined<a name="ZH-CN_TOPIC_0000002521251841"></a>

<!-- md-trans-meta sourceCommit=b3e2e715646b9fecf3e353f980743f9a959a7286 translatedAt=2026-09-06T10:35:58.918Z pushedAt=2026-09-11T02:54:58.464Z -->
...
Configures whether the operator is a custom operator. For AI CPU custom operators, **userDefined** can only be set to **True**. If the developer does not configure it, this parameter is set to **True** by default.
...
<td class="cellrowborder" valign="top" width="67.44%" headers="mcps1.1.4.1.3 "><p id="zh-cn_topic_0000001626409757_zh-cn_topic_0000001526442954_p12935163055011"><a name="zh-cn_topic_0000001626409757_zh-cn_topic_0000001526442954_p12935163055011"></a><a name="zh-cn_topic_0000001626409757_zh-cn_topic_0000001526442954_p12935163055011"></a><span>For an AI CPU custom operator, userDefined can only be set to "True".</span><span>If the developer does not configure it, this parameter is set to "True" by default.</span></p></td>
</tr>
</tbody>
</table>
