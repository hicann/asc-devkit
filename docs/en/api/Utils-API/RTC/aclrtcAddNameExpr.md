...
<!-- md-trans-meta sourceCommit=134c8a713e94913719724061b56ccd2fc3a577d7 translatedAt=2026-09-06T15:18:31.518Z pushedAt=2026-09-09T11:36:37.595Z -->
...
Registers a specified name expression that represents a \_\_global\_\_ function.

It is mainly used in scenarios where the \_\_global\_\_ function is a template function. After calling this API, you can obtain the mangling name of the function through [aclrtcGetLoweredName](aclrtcGetLoweredName.md), and then call the corresponding template \_\_global\_\_ function during the launch phase.
...
<tr id="row13879152135218"><td class="cellrowborder" valign="top" width="17.580000000000002%" headers="mcps1.2.4.1.1 "><p id="p19982811135218"><a name="p19982811135218"></a><a name="p19982811135218"></a>nameExpression</p></td>
...
<td class="cellrowborder" valign="top" width="66.86%" headers="mcps1.2.4.1.3 "><p id="p4268745104714"><a name="p4268745104714"></a><a name="p4268745104714"></a>A constant expression, usually a string literal, used to identify a __global__ function.</p></td>
</tr>
</tbody>
</table>
...
**aclError** is an int type variable. For details, see [RTC Error Codes](rtc_error_codes.md).

## Constraints<a name="section633mcpsimp"></a>

This API must be used before the [aclrtcCompileProg](aclrtcCompileProg.md) compilation API.
