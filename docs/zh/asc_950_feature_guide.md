...
| 4 | **HiF8(hifloat8_t)数据类型**：Cube计算单元新增支持HiF8数据类型的矩阵乘 | [3510架构规格](guide/编程指南/高级编程/硬件实现/架构规格/NPU架构版本3510.md)中Cube支持的数据类型 | [内置数据类型说明](api/SIMD-API/basic_api/data_structures/builtin_data_types.md)、[Cast类型转换](api/SIMD-API/basic_api/reg_vector_compute/type_conversion/Cast.md)、[asc_float2hif8（废弃）](api/SIMD-API/C-API/reg/data_type_convert/asc_float2hif8_deprecated.md) | 资料开发中 |
...
| 9 | **Mutex同步**：核内异步流水指令间同步，功能类似CPU中的锁机制 | 资料开发中 | [Mutex ISASI](<api/SIMD-API/basic_api/sync_control/intra_core_sync/Mutex_ISASI.md>)、[asc_lock](api/SIMD-API/C-API/sync/asc_lock.md) | 资料开发中 |
