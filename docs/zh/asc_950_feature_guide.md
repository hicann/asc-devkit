...
| 6 | **L0C到UB通路**：支持数据直接从L0C Buffer搬运到UB，无需经GM中转 | [3510架构变更-搬运单元](guide/cross_gen_migration_guide/3510_arch_migration/2201_to_3510_arch_changes.md) | [asc_copy_l0c2ub](api/SIMD-API/c_api/cube_datamove/asc_copy_l0c2ub.md) | [矩阵乘结果累加](guide/operator_practice/simd_operator_optimization/matrix_compute/l0c_buffer_matmul_accumulate.md) |
