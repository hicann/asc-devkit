...
**该接口已废弃，请使用[layout::capacity](../layout/layout.md#capacity)替代。**

返回当前Layout或指定子维度对应布局的实际内存容量，包含由非连续Stride产生的无效数据区域。
...
auto old_capacity = layout.Capacity();      // 废弃写法
auto new_capacity = layout.capacity();       // 替代写法
```
