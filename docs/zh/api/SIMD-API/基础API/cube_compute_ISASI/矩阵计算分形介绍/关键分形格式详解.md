...
<!-- npu="950" id20 -->
- 转换示例：针对Ascend 950PR/Ascend 950DT，可以使用[矩阵搬入DataCopy DN2NZ接口](../矩阵计算的搬入/DataCopy_GMToL1_DN2NZ.md)将其转换为Nz格式以适配Cube单元。
<!-- end id20 -->
...
- **格式转换过程：** 通常使用[DataCopy（GMToL1随路转换-ND2NZ搬运）](../矩阵计算的搬入/DataCopy_GMToL1_ND2NZ.md)指令来进行NHWC格式到NC1HWC0格式的转换。
