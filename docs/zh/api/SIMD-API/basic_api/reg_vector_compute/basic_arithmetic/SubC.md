...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/reg_vector_compute/basic_arithmetic/SubC_res.md#id1 -->
...
| carrySrc | 输入 | 源操作数。输入进位值。<br>类型为[MaskReg](../register_data_types/MaskReg.md)。 |
