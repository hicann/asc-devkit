...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/reg_vector_compute/composite_compute/MulDstAdd_res.md#id1 -->
...
在硬件层面单条指令完成乘加融合计算，精度高于分开执行[Mul](../basic_arithmetic/Mul.md)和[Add](../basic_arithmetic/Add.md)。
