...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/reg_vector_compute/reg_data_load/Gather_discrete_res.md#id1 -->
...
| baseAddr | 输入 | 源操作数，Unified Buffer（UB）中的基地址，需要32字节对齐。 |
