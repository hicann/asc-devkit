...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/memory_vector_compute/logical_compute/Ands_res.md#id1 -->
...
| repeatParams | 输入 | 元素操作控制结构信息，具体请参考[UnaryRepeatParams](../../aux_data_structures//UnaryRepeatParams.md)。 |
