...
- Kirin 9030：支持
<!-- end id9 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/memory_vector_compute/composite_compute/FusedMulAdd_res.md#id1 -->
...
<!-- npu="950" id10 -->
Ascend 950PR/Ascend 950DT，支持的数据类型为：half、bfloat16_t、float、int64_t、uint64_t。其中，uint64\_t/int64\_t数据类型仅支持tensor前n个数据计算接口。
<!-- end id10 -->
