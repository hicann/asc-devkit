...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/memory_vector_compute/composite_compute/AbsSub_ISASI_res.md#id1 -->
...
<!-- npu="950" id9 -->
- 该接口通过VF调用[Reg矢量计算API](../../reg_vector_compute/reg_vector_compute.md)实现兼容，当参数count取值为0时，不保证该接口将被视为NOP（空操作）。
  <!-- end id9 -->
