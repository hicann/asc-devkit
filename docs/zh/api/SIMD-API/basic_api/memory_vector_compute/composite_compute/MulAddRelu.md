...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/memory_vector_compute/composite_compute/MulAddRelu_res.md#id1 -->
...
<!-- npu="950" id8 -->
Ascend 950PR/Ascend 950DT，支持的数据类型为：half、float、int64_t、uint64_t。其中，int64\_t、uint64\_t数据类型仅支持tensor前n个数据计算接口。
<!-- end id8 -->
