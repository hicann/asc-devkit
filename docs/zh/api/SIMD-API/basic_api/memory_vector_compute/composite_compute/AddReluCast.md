...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/memory_vector_compute/composite_compute/AddReluCast_res.md#id1 -->
...
针对Ascend 950PR/Ascend 950DT，src0、src1数据类型为int64_t，dst数据类型为int32_t的数据类型组合仅支持tensor前n个数据计算接口。
