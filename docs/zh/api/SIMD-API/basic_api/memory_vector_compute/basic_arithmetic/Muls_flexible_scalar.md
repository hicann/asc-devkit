...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/memory_vector_compute/basic_arithmetic/Muls_flexible_scalar_res.md#id1 -->
...
<!-- npu="950" id8 -->
针对Ascend 950PR/Ascend 950DT，支持的数据为int16_t、half、bfloat16_t、int32_t、float、complex32、int64_t、uint64_t、complex64。其中complex32、int64_t、uint64_t、complex64数据类型仅支持tensor前n个数据计算接口。
<!-- end id8 -->
