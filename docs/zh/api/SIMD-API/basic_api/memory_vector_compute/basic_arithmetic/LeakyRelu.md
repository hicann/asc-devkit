...
- Kirin 9030：支持
<!-- end id9 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/memory_vector_compute/basic_arithmetic/LeakyRelu_res.md#id1 -->
...
|---|---|
| T | 操作数数据类型。 |
| U | scalarValue的数据类型。仅在dst和src使用[TensorTrait](../../aux_data_structures/TensorTrait/TensorTrait.md)类型时有效。 |
