...
- Atlas 训练系列产品：支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/memory_vector_compute/reduction_compute/ReducePairElem_res.md#id1 -->
...
本样例中只展示`Compute`流程中的部分代码。更多样例可参考[ReducePairElem样例](../../../../../../../examples/01_simd_cpp_api/03_basic_api/01_memory_vector_compute/reduce_pair_elem)。
