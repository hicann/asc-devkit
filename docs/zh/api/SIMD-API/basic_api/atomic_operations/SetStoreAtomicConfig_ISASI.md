...
- Atlas 训练系列产品：不支持
<!-- end id14 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/atomic_operations/SetStoreAtomicConfig_ISASI_res.md#id1 -->
...
| op | 输入 | 原子操作类型，仅当开启原子操作时有效（即"type"为非"ATOMIC_NONE"的场景），当前仅支持求和操作。<br>enum class AtomicOp {<br>    ATOMIC_SUM = 0   // 求和操作<br>}; |
