...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/scalar_compute/Cast_float_to_bfloat16_res.md#id1 -->
...
- float到bfloat16\_t转换采用[CAST\_RINT舍入](../data_structures/precision_conversion.md#二进制精度舍入规则)。
