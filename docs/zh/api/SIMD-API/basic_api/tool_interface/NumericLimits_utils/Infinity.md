...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/tool_interface/NumericLimits_utils/Infinity_res.md#id1 -->
...
标量接口返回值为对应数据类型的[正无穷大值](../../data_structures/builtin_data_types.md)。
...
标量接口无约束，矢量接口使用[duplicate](../../memory_vector_compute/data_padding/Duplicate.md)填充前count个元素赋正无穷大值，参照Memory矢量计算下的数据填充接口duplicate约束。
