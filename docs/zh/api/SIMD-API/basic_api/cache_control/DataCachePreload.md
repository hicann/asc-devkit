...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/cache_control/DataCachePreload_res.md#id1 -->
...
| 参数名 | 输入/输出 | 描述 |
|--------|-----------|------|
| src | 输入 | 源操作数，类型为[GlobalTensor](../data_structures/GlobalTensor/GlobalTensor_intro.md)。支持的数据类型为：uint64_t。 |
