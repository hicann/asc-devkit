...
- Kirin 9030：支持
<!-- end id9 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/debug_interface/exception_detection/assert_res.md#id1 -->
...
在算子核函数（Kernel）侧实现代码中需要增加断言的地方使用assert检查代码，并格式化输出一些调测信息。示例如下：
