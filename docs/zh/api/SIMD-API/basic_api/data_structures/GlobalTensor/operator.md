...
- Atlas 训练系列产品：支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/data_structures/GlobalTensor/operator_res.md#id1 -->
...
```cpp
// operator[]使用方法, aGlobal[4]为从起始地址开始偏移量为4的新tensor
auto gmA = aGlobal[4];
// 示例结果如下：
// 输入数据(aGlobal): [1 2 3 4 5 6 ... 100]
// 输出数据(gmA ): [5 6 7 8 ... 100]
```
