...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/data_structures/GlobalTensor/operator_call_res.md#id1 -->
...
与[LocalTensor](../LocalTensor/LocalTensor.md)的operator\(\)类似。
...
<td class="cellrowborder" valign="top" width="73.08%" headers="mcps1.2.4.1.3 "><p id="p17980185810404"><a name="p17980185810404"></a><a name="p17980185810404"></a>GlobalTensor的下标索引。</p>
</td>
</tr>
</tbody>
</table>
