...
- Atlas 训练系列产品：支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/data_structures/LocalTensor/GetShapeInfo_res.md#id1 -->
...
LocalTensor的Shape信息，[ShapeInfo](../../aux_data_structures/ShapeInfo.md)结构体类型。
