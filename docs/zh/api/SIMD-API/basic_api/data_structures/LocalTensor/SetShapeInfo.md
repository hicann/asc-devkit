...
- Atlas 训练系列产品：支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/data_structures/LocalTensor/SetShapeInfo_res.md#id1 -->
...
<tbody><tr id="row42461942101815"><td class="cellrowborder" valign="top" width="13.94%" headers="mcps1.2.4.1.1 "><p id="p284425844311"><a name="p284425844311"></a><a name="p284425844311"></a>shapeInfo</p>
</td>
...
<td class="cellrowborder" valign="top" width="73.08%" headers="mcps1.2.4.1.3 "><p id="p554174121211"><a name="p554174121211"></a><a name="p554174121211"></a>Shape信息，<a href="../../aux_data_structures/ShapeInfo.md">ShapeInfo</a>结构体类型。</p>
</td>
</tr>
</tbody>
</table>
