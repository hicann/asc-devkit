...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/resource_management/LocalMemAllocator/Alloc_res.md#id1 -->
...
<td class="cellrowborder" valign="top" width="82.57%" headers="mcps1.2.3.1.2 "><p id="p18689719202918"><a name="p18689719202918"></a><a name="p18689719202918"></a><a href="../../aux_data_structures//TPosition.md">TPosition</a>位置，需要符合<a href="LocalMemAllocator_intro.md">LocalMemAllocator</a>中指定的Hardware物理位置（C++ Tensor编程场景下，此参数可以省略）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="72.16%" headers="mcps1.2.3.1.2 "><p id="p10458194684613"><a name="p10458194684613"></a><a name="p10458194684613"></a>只支持传入<a href="../../aux_data_structures/TensorTrait/TensorTrait.md">TensorTrait</a>类型，TensorTrait的数据类型/逻辑位置/Shape大小需要匹配LocalMemAllocator中指定的物理位置及其剩余空间。</p>
</td>
</tr>
</tbody>
</table>
