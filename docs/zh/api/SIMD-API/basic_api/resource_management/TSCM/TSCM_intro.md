...
<td class="cellrowborder" valign="top" width="86.37%" headers="mcps1.2.3.1.2 "><p id="p35011591693"><a name="p35011591693"></a><a name="p35011591693"></a>队列逻辑位置，可以为<span>VECIN、GM</span>。<span>关于TPosition的具体介绍请参考</span><a href="../../aux_data_structures//TPosition.md">TPosition</a>。</p>
</td>
</tr>
...
for () {
    auto scmTensor = tscm.AllocTensor<float>(); // 在搬运数据从UB->L1 Buffer（TSCM）前分配Buffer
    DataCopy(scmTensor, ubLocal, 1024); // 将UB数据搬运至L1 Buffer（TSCM），准备用于Matmul计算
