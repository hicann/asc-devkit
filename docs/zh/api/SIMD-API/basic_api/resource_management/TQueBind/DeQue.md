...
- Atlas 训练系列产品：支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/resource_management/TQueBind/DeQue_res.md#id1 -->
...
non-inplace接口的返回值为从队列中取出的[LocalTensor](../../data_structures/LocalTensor/LocalTensor.md)；inplace接口没有返回值。
