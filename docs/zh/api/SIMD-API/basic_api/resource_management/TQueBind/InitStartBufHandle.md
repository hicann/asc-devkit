...
- Atlas 训练系列产品：支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/resource_management/TQueBind/InitStartBufHandle_res.md#id1 -->
...
-   该接口目前只提供给[自定义TBufPool](../custom_TBufPool/custom_TBufPool.md)初始化TQue、TBuf的内存块时使用。
...
完整示例请参考[调用示例](../custom_TBufPool/EXTERN_IMPL_BUFPOOL.md#section1234017553610)。
