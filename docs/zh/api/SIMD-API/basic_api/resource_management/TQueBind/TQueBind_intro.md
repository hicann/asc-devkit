...
<td class="cellrowborder" valign="top" width="85.9%" headers="mcps1.2.3.1.2 "><p id="p35011591693"><a name="p35011591693"></a><a name="p35011591693"></a>源逻辑位置，支持的<span>TPosition</span>可以为<span>VECIN、VECOUT、</span>A1<span>、</span>A2<span>、</span>B1<span>、</span>B2<span>、</span>CO1<span>、</span>CO2。<span>关于TPosition的具体介绍请参考</span><a href="../../aux_data_structures//TPosition.md">TPosition</a>。支持的src和dst组合请参考<a href="#table171821134125613">表1</a>。</p>
</td>
</tr>
