...
- Atlas 训练系列产品：支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/resource_management/TQueBind/InitBufHandle_res.md#id1 -->
...
-   目前只提供给[自定义TBufPool](../custom_TBufPool/custom_TBufPool.md)初始化TQue、TBuf的内存块时使用。
