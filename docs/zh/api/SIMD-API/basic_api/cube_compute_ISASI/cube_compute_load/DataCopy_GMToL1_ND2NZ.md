# DataCopy（GMToL1随路转换-ND2NZ搬运）<a id="ZH-CN_TOPIC_0000002569070913"></a>
...
示例代码片段如下，仅展示样例中的部分代码，完整示例请参考：[DataCopy_GM2L1样例](../../../../../../../examples/01_simd_cpp_api/03_basic_api/03_matrix_compute/load_data_l12l0)。
