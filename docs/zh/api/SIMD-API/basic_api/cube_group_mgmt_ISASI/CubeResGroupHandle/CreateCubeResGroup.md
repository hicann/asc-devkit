...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/cube_group_mgmt_ISASI/CubeResGroupHandle/CreateCubeResGroup_res.md#id1 -->
...
<td class="cellrowborder" valign="top" width="78.92%" headers="mcps1.2.4.1.3 "><p id="p1560613391196"><a name="p1560613391196"></a><a name="p1560613391196"></a><a href="../KfcWorkspace/KfcWorkspace.md">KfcWorkspace</a>，用于维护消息队列空间。</p>
</td>
</tr>
...
-   使用该接口，Unified Buffer（UB）空间末尾的1600B + sizeof\(CubeMsgType\)将被占用。
