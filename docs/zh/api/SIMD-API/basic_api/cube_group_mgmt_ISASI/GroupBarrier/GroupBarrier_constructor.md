...
- Atlas 训练系列产品：不支持
<!-- end id7 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/basic_api/cube_group_mgmt_ISASI/GroupBarrier/GroupBarrier_constructor_res.md#id1 -->
...
-   使用该接口时，Unified Buffer（UB）空间末尾的1600B被占用。
