...
__global__ __vector__ void asc_neg_kernel(__gm__ float* dst, __gm__ float* src)
{
    asc_init();
...
int main()
{
    ...
    asc_neg_kernel<<<1, 0>>>(dst_device, src_device);
    ...
    std::cout << (passed ? "[Success] asc_neg passed." : "[Failed] asc_neg failed.") << std::endl;
