...
<!-- npu="A3,910b" id1 -->
- 针对Atlas A2 训练系列产品/Atlas A2 推理系列产品、Atlas A3 训练系列产品/Atlas A3 推理系列产品，支持的枚举值：`NoQuant`、`F322F16`、`F322BF16`、`DEQF16`、`VDEQF16`、`QF322B8_PRE`、`VQF322B8_PRE`、`REQ8`、`VREQ8`。部分矩阵搬出接口还支持`REQ4`、`VREQ4`、`QF322S4_PRE`和`VQF322S4_PRE`。
<!-- end id1 -->
<!-- npu="950" id2 -->
