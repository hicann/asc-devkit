...
```cpp
__simd_vf__ inline void min_vf(__ubuf__ half* dst_addr, __ubuf__ half* src0_addr, __ubuf__ half* src1_addr, uint32_t count, int32_t one_repeat_size, uint16_t repeat_time)
{
    vector_half src0;
    vector_half src1;
    vector_half dst;
