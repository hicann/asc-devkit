...
完成src0与src1逐元素相乘再加dst的融合乘加运算，根据mask将计算结果写回dst。计算公式如下：
...
```cpp
__simd_callee__ inline void asc_fma(vector_bfloat16_t& dst, vector_bfloat16_t src0, vector_bfloat16_t src1, vector_bool mask)
