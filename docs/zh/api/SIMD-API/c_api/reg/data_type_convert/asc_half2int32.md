...
```cpp
__simd_vf__ inline void half2int32_vf(__ubuf__ int32_t* dst_addr, __ubuf__ half* src_addr, int32_t src_repeat_size, int32_t dst_repeat_size, uint16_t repeat_time)
{
    vector_half src;
    vector_int32_t dst;
