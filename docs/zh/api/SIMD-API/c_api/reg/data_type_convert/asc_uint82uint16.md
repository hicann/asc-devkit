...
__simd_vf__ inline void convert(__ubuf__ uint8_t* output, __ubuf__ uint8_t* input)
{
    ...
    asc_uint82uint16_v2(dst_0, src_0, mask);
    ...
    asc_uint82uint16(dst_1, src_1, mask);
...
int main()
{
    ...
    std::cout << (passed ? "[Success] asc_uint82uint16/asc_uint82uint16_v2 passed."
                         : "[Failed] asc_uint82uint16/asc_uint82uint16_v2 failed.")
              << std::endl;
