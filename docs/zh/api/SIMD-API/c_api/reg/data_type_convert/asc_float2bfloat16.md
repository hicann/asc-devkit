...
- 使用饱和或非饱和模式时，需要配置`ctrl`寄存器，详细说明请参见[asc_set_ctrl](../../sys_var/asc_set_ctrl.md)。
...
__simd_vf__ inline void convert(__ubuf__ uint8_t* output, __ubuf__ uint8_t* input)
{
    ...
    asc_float2bfloat16_rd_sat(dst_0, src_0, mask);
    ...
    asc_float2bfloat16_rd_v2(dst_1, src_1, mask);
    ...
    asc_float2bfloat16_rd_sat_v2(dst_2, src_2, mask);
    ...
    asc_float2bfloat16_rn(dst_3, src_3, mask);
    ...
    asc_float2bfloat16_rn_sat(dst_4, src_4, mask);
    ...
    asc_float2bfloat16_rn_v2(dst_5, src_5, mask);
    ...
    asc_float2bfloat16_rn_sat_v2(dst_6, src_6, mask);
    ...
    asc_float2bfloat16_rna(dst_7, src_7, mask);
    ...
    asc_float2bfloat16_rna_sat(dst_8, src_8, mask);
    ...
    asc_float2bfloat16_rna_v2(dst_9, src_9, mask);
    ...
    asc_float2bfloat16_rna_sat_v2(dst_10, src_10, mask);
    ...
    asc_float2bfloat16_ru(dst_11, src_11, mask);
    ...
    asc_float2bfloat16_ru_sat(dst_12, src_12, mask);
    ...
    asc_float2bfloat16_ru_v2(dst_13, src_13, mask);
    ...
    asc_float2bfloat16_ru_sat_v2(dst_14, src_14, mask);
    ...
    asc_float2bfloat16_rz(dst_15, src_15, mask);
    ...
    asc_float2bfloat16_rz_sat(dst_16, src_16, mask);
    ...
    asc_float2bfloat16_rz_v2(dst_17, src_17, mask);
    ...
    asc_float2bfloat16_rz_sat_v2(dst_18, src_18, mask);
    ...
    asc_float2bfloat16_rd(dst_19, src_19, mask);
...
int main()
{
    ...
    std::cout << (passed ? "[Success] asc_float2bfloat16_rd/asc_float2bfloat16_rd_sat/"
                           "asc_float2bfloat16_rd_v2/asc_float2bfloat16_rd_sat_v2/"
                           "asc_float2bfloat16_rn/asc_float2bfloat16_rn_sat/"
                           "asc_float2bfloat16_rn_v2/asc_float2bfloat16_rn_sat_v2/"
                           "asc_float2bfloat16_rna/asc_float2bfloat16_rna_sat/"
                           "asc_float2bfloat16_rna_v2/asc_float2bfloat16_rna_sat_v2/"
                           "asc_float2bfloat16_ru/asc_float2bfloat16_ru_sat/"
                           "asc_float2bfloat16_ru_v2/asc_float2bfloat16_ru_sat_v2/"
                           "asc_float2bfloat16_rz/asc_float2bfloat16_rz_sat/"
                           "asc_float2bfloat16_rz_v2/asc_float2bfloat16_rz_sat_v2 passed."
                         : "[Failed] asc_float2bfloat16_rd/asc_float2bfloat16_rd_sat/"
                           ...
                           "asc_float2bfloat16_ru_v2/asc_float2bfloat16_ru_sat_v2/"
                           "asc_float2bfloat16_rz/asc_float2bfloat16_rz_sat/"
                           "asc_float2bfloat16_rz_v2/asc_float2bfloat16_rz_sat_v2 failed.")
              << std::endl;
