...
asc_fill_value_config为fill_value的初始化参数结构体，包含[asc_fill_l0a](../cube_data_move/asc_fill_l0a.md)/[asc_fill_l0b](../cube_data_move/asc_fill_l0b.md)/[asc_fill_l1](../cube_data_move/asc_fill_l1.md)接口需要配置的各种初始化参数。
