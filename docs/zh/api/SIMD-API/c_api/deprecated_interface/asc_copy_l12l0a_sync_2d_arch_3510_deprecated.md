# asc_copy_l12l0a_sync_2d_arch_3510（废弃）
...
**`asc_copy_l12l0a_sync`和`asc_copy_l12l0a_transpose_sync`接口已废弃，请使用[对应的非同步接口](../cube_datamove/asc_copy_l12l0a/asc_copy_l12l0a_2d_arch_3510.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
    ...
    __gm__ int32_t* output)
{
    ...
    asc_copy_l12l0a_sync(a_l0, a_l1, 0, 0, M / CUBE_M, K / CUBE_K, M / CUBE_M, M / CUBE_M);
