...
执行此接口后，可以继续执行[asc_get_reduce_min_cnt](../vector_compute/vector_reduce/asc_get_reduce_min_cnt.md)获取全部repeat内的最小值，以及第一个最小值时的索引。
...
asc_repeat_reduce_min_value_index_sync(dst, src, repeat, dst_repeat_stride, src_block_stride, src_repeat_stride);
```
