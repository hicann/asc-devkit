...
**`asc_duplicate_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_broadcast/asc_duplicate.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
uint16_t val = 18;
asc_duplicate_sync(dst, val, dst_length);
```
