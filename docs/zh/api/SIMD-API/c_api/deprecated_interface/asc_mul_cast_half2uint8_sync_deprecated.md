# asc_mul_cast_half2uint8_sync（废弃）
...
**`asc_mul_cast_half2uint8_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_fused/asc_mul_cast_half2uint8.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_mul_cast_half2uint8_sync(dst, src0, src1, total_length);
```
