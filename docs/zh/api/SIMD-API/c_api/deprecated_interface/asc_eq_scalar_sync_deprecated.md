...
**`asc_eq_scalar_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_compare/asc_eq_scalar.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
…… // 数据搬运及同步操作
asc_eq_scalar_sync(dst, src, scalar, repeat, dst_block_stride, src_block_stride, dst_repeat_stride, src_repeat_stride);
