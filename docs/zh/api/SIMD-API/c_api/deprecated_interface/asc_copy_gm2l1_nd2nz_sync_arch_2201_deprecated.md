# asc_copy_gm2l1_nd2nz_sync_arch_2201（废弃）
...
// src表示源操作数的起始地址
asc_copy_gm2l1_nd2nz_sync(dst, src, nd_num, n_value, d_value, src_nd_matrix_stride, src_d_value, dst_nz_c0_stride, dst_nz_n_stride, dst_nz_matrix_stride);
```
