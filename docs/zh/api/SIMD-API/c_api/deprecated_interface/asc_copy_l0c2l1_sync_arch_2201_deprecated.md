# asc_copy_l0c2l1_sync_arch_2201（废弃）
...
**`asc_copy_l0c2l1_sync`接口已废弃，请使用[对应的非同步接口](../cube_datamove/asc_copy_l0c2l1/asc_copy_l0c2l1_arch_2201.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
| quant_pre            | 输入    | 量化参数。取值见[功能说明](../cube_datamove/asc_copy_l0c2l1/asc_copy_l0c2l1_arch_2201.md#功能说明)。                                                                             |
| relu_pre             | 输入    | 开启relu。                                                                                                                          |
...
asc_copy_l0c2l1_sync(dst, src, n_size, m_size, dst_stride, src_stride, unit_flag_mode, quant_pre, relu_pre, enable_channel_split, enable_nz2nd);
```
