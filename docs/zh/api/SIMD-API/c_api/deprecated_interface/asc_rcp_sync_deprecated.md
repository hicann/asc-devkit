...
**`asc_rcp_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_arith/asc_rcp.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_rcp_sync(dst, src, total_length);    // dst = 1 / src
// src [1, 2, 3, ..., 128]
