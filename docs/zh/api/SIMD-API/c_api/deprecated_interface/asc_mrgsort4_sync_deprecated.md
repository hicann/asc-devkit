...
dst = tmp_workspace;
valid_bit = 15;
asc_mrgsort4_sync(dst, src, 2, element_length, element_length, element_length, element_length, false, valid_bit);
...
dst = dst_workspace;
valid_bit = 3;
asc_mrgsort4_sync(dst, src, 1, 4 * element_length, 4 * element_length, 0, 0, false, valid_bit);
```
