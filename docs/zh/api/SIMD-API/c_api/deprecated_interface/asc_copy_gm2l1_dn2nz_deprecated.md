...
**`asc_copy_gm2l1_dn2nz`的旧常规重载和`asc_copy_gm2l1_dn2nz_sync`接口已废弃。请使用带`asc_load_l2_cache_mode l2_cache_mode`参数的[asc_copy_gm2l1_dn2nz](../cube_datamove/asc_copy_gm2l1_dn2nz.md)接口；同步场景请额外调用`asc_sync`。**
