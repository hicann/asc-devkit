...
**`asc_int322int64_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_convert/asc_int322int64.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_int322int64_sync(dst, src, total_length);    // 将src转换为int64_t类型并存放到dst中
```
