...
**`asc_bfloat162int32_rn_sync`、`asc_bfloat162int32_rna_sync`、`asc_bfloat162int32_rd_sync`、`asc_bfloat162int32_ru_sync`和`asc_bfloat162int32_rz_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_convert/asc_bfloat162int32.md)和同步接口[asc_sync](../sync/asc_sync.md)替代。**
