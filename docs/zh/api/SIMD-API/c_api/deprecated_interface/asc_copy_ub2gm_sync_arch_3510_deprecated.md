# asc_copy_ub2gm_sync_arch_3510（废弃）
...
**`asc_copy_ub2gm_sync`接口已废弃，请使用[对应的非同步接口](../vector_datamove/asc_copy_ub2gm/asc_copy_ub2gm_arch_3510.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
- 当src_stride不等于burst_len时，src_stride要求32字节对齐。
...
asc_copy_ub2gm_sync(dst, src, total_length * sizeof(half));
```
