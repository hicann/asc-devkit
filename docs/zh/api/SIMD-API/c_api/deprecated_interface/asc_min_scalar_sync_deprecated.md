...
**`asc_min_scalar_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_arith/asc_min_scalar.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
half value = 3;
asc_min_scalar_sync(dst, src, value, total_length);
// src : [1, 2, 3, 4, ... , 32]
// value : 3
// dst : [1, 2, 3, 3, ... , 3]
```
