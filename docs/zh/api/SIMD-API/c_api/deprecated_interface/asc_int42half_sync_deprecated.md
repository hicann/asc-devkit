...
**`asc_int42half_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_convert/asc_int42half.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_int42half_sync(dst, src, total_length);    // 将src转换为half类型并存放到dst中
```
