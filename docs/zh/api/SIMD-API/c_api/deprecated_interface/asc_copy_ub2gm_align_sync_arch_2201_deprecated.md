# asc_copy_ub2gm_align_sync_arch_2201（废弃）
...
**`asc_copy_ub2gm_align_sync`接口已废弃，请使用[对应的非同步接口](../vector_datamove/asc_copy_ub2gm_align/asc_copy_ub2gm_align_arch_2201.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_copy_ub2gm_align_sync(dst, src, total_length * sizeof(uint8_t));
```
