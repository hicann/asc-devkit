...
**`asc_half2int4_sync`、`asc_half2int4_rn_sync`、`asc_half2int4_rd_sync`、`asc_half2int4_rna_sync`、`asc_half2int4_ru_sync`和`asc_half2int4_rz_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_convert/asc_half2int4.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
