...
**`asc_copy_l12gm_sync`接口已废弃，请使用[对应的非同步接口](../cube_datamove/asc_copy_l12gm.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
// dst表示目的操作数的起始地址
asc_copy_l12gm_sync(dst, src, n_burst, len_burst, src_gap, dst_gap);
```
