...
**`asc_half2int8_sync`、`asc_half2int8_rn_sync`、`asc_half2int8_rna_sync`、`asc_half2int8_rd_sync`、`asc_half2int8_ru_sync`和`asc_half2int8_rz_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_convert/asc_half2int8.md)和同步接口[asc_sync](../sync/asc_sync.md)替代。**
