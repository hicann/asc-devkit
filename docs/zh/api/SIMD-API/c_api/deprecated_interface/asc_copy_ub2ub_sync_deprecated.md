...
**`asc_copy_ub2ub_sync`接口已废弃，请使用[对应的非同步接口](../vector_datamove/asc_copy_ub2ub.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_copy_ub2ub_sync(dst, src, total_length * sizeof(half));
```
