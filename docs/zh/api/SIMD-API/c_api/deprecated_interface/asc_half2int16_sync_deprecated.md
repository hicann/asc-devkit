...
**`asc_half2int16_rn_sync`、`asc_half2int16_rna_sync`、`asc_half2int16_rd_sync`、`asc_half2int16_ru_sync`和`asc_half2int16_rz_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_convert/asc_half2int16.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_half2int16_rn_sync(dst, src, total_length);
```
