...
**`asc_mul_add_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_fused/asc_mul_add.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_mul_add_sync(dst, src0, src1, total_length);    // dst = (src0 * dst) + src1
// src0 [1, 2, 3, ..., 128]
// src1 [1, 1, 1, ..., 1]
// 计算前dst [2, 2, 2, ..., 2]
// 计算后dst [3, 5, 7, ..., 257]
