...
**`asc_float2bfloat16_rn_sync`、`asc_float2bfloat16_rna_sync`、`asc_float2bfloat16_rd_sync`、`asc_float2bfloat16_ru_sync`和`asc_float2bfloat16_rz_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_convert/asc_float2bfloat16.md)和同步接口[asc_sync](../sync/asc_sync.md)替代。**
