# asc_copy_l0c2gm_sync_arch_3510（废弃）
...
**`asc_copy_l0c2gm_sync`接口已废弃，请使用[对应的非同步接口](../cube_datamove/asc_copy_l0c2gm/asc_copy_l0c2gm_arch_3510.md)和同步接口[asc_sync](../sync/asc_sync.md)替代。**
    ...
    __gm__ int32_t* output)
{
    ...
    asc_copy_l0c2gm_sync(output, c_l0, N, M, N, M, 0, 0, 0,
