# asc_copy_gm2l1_nd2nz_sync_arch_3510（废弃）
...
**`asc_copy_gm2l1_nd2nz_sync`接口已废弃，请使用[对应的非同步接口](../cube_datamove/asc_copy_gm2l1_nd2nz/asc_copy_gm2l1_nd2nz_arch_3510.md)和同步接口[asc_sync](../sync/asc_sync.md)替代。**
    ...
    __gm__ int32_t* output)
{
    ...
    asc_copy_gm2l1_nd2nz_sync(a_l1, a, K, 0, M, K, 0, false);
    asc_set_gm2l1_nz_para(1, 1, 128, 0);
    asc_copy_gm2l1_nd2nz_sync(b_l1, b, K, 0, N, K, 0, false);
