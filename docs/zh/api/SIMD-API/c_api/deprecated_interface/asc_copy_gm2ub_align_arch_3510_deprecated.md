# asc_copy_gm2ub_align_arch_3510（废弃）
...
| l2_cache_mode | 输入 | L2 Cache管理策略配置。该参数类型为`uint8_t`，建议改用[asc_load_l2_cache_mode](../defs/enum/asc_load_l2_cache_mode.md)类型的枚举值。 |
