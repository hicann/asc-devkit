...
**`asc_int642float_rd_sync`、`asc_int642float_rn_sync`、`asc_int642float_rna_sync`、`asc_int642float_ru_sync`和`asc_int642float_rz_sync`接口已废弃，请使用[对应的非同步接口](../vector_compute/vector_convert/asc_int642float.md)和同步接口[asc_sync](../sync/asc_sync.md)替代。**
