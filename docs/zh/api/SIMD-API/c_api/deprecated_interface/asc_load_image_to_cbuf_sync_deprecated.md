# asc_load_image_to_cbuf_sync（废弃）
...
**`asc_load_image_to_cbuf_sync`接口已废弃，请使用[对应的非同步接口](../cube_datamove/asc_load_image_to_cbuf.md)和同步接口[asc_sync](../sync/intra_core_sync/asc_sync.md)替代。**
...
asc_load_image_to_cbuf_sync(dst, 1, 1, 0, 0, 1, 0, 0, 0, 0);
```
