...
| 参数名  | 输入/输出 | 描述 |
| :----- | :------- | :------- |
| config | 输入 | 用于设置Load3Dv2接口的repeat参数，详细说明请参考[asc_load3d_v2_config.md](../defs/union/asc_load3d_v2_config.md)。 |
...
- 需配合[asc_load3d_v2_config.md](../defs/union/asc_load3d_v2_config.md)使用，用于设置Load3Dv2接口的repeat参数。
