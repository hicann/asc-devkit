...
C API开放芯片完备编程能力，支持[以数组形式分配内存](general_description_and_constraints.md#以数组方式申请内存)，一般基于指针编程。提供与业界一致的C语言编程体验。
...
|\_\_ubuf\_\_|存储空间定义修饰符，表示被修饰的变量位于Unified Buffer（UB）地址空间。|
