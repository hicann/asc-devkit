...
设置A矩阵的Layout轴信息，包括[B、S、N、G、D轴](../Matmul_Kernel/IterateBatch.md)。对于BSNGD、SBNGD、BNGS1S2 Layout格式，调用[IterateBatch](../Matmul_Kernel/IterateBatch.md)接口之前，需要在Host侧Tiling实现中通过本接口设置A矩阵的Layout轴信息。
...
对于BSNGD、SBNGD、BNGS1S2 Layout格式，调用[IterateBatch](../Matmul_Kernel/IterateBatch.md)接口之前，需要在Host侧Tiling实现中通过本接口设置A矩阵的Layout轴信息。
