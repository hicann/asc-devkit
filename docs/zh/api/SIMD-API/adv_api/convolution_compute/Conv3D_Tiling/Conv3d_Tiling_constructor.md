...
| platform | 输入 | 传入硬件版本以及AI Core中各个硬件单元提供的内存大小。PlatformInfo构造时通过[构造及析构函数](../../../../Utils-API/platform_info/PlatformAscendC/constructor_and_destructor.md)获取。<br><br>PlatformInfo结构定义如下方代码所示，socVersion通过[GetSocVersion](../../../../Utils-API/platform_info/PlatformAscendC/GetSocVersion.md)获取并透传，各类硬件存储空间大小通过[GetCoreMemSize](../../../../Utils-API/platform_info/PlatformAscendC/GetCoreMemSize.md)获取并透传。 |
