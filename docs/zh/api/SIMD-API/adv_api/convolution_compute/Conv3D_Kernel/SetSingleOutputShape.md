...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/adv_api/convolution_compute/Conv3D_Kernel/SetSingleOutputShape_res.md#id1 -->
...
**图1**  M合轴模式示意图  
![](../../../../figures/m_axis_merge_mode.png "M合轴模式示意图")
