...
用户通过调用[GetTiling](GetTiling-114.md)接口获取TConv3DBackpropInputTiling结构体，具体流程请参考[Conv3DBackpropInput Tiling使用说明](Conv3DBackpropInput_Tiling_usage.md)。当前暂不支持用户自定义配置TConv3DBackpropInputTiling结构体中的参数。
