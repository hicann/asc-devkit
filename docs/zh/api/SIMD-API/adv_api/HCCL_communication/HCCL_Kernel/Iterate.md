...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMD-API/adv_api/HCCL_communication/HCCL_Kernel/Iterate_res.md#id1 -->
...
![](../../../../figures/alltoallv_pairwise_steps.png "使用pairwise算法的AlltoAllV通信步骤示意图")
