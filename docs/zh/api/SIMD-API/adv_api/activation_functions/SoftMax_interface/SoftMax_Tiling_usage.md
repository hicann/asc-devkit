...
对于SoftmaxFlash请参考[SoftmaxFlash Tiling接口](SoftmaxFlash_Tiling_interface.md)；

对于SoftmaxGrad请参考[SoftmaxGrad Tiling接口](SoftmaxGrad_Tiling_interface.md)；

对于SoftmaxFlashV2请参考[SoftmaxFlashV2 Tiling接口](SoftmaxFlashV2_Tiling_interface.md)；
