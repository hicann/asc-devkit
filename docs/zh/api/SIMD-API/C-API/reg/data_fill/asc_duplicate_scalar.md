...
```cpp
__simd_vf__ inline void duplicate_scalar_vf(__ubuf__ half* dst_addr, uint32_t count, uint16_t one_repeat_size, uint16_t repeat_time)
{
    vector_half dst;
    vector_bool mask;
    half value = 1.0;
