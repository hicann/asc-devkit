...
| sharedTmpBuffer | 输入 | 临时缓存。<br><br>类型为[LocalTensor](../../../基础API/数据结构/LocalTensor/LocalTensor.md)，支持的TPosition为VECIN/VECCALC/VECOUT。<br><br>临时空间大小BufferSize的获取方式请参考[GetLogMaxMinTmpSize](GetLogMaxMinTmpSize.md)。 |
...
完整的调用样例可参考[Log样例](../../../../../../../examples/01_simd_cpp_api/04_advanced_api/10_math/log)。
