...
- 对于mean，采用的方式为先求和再做除法，其求和时内部使用的底层相加方式与[Sum](../Sum接口/Sum.md)、[ReduceSum](../../../basic_api/memory_vector_compute/reduction_compute/ReduceSum.md)以及[ReduceRepeat](../../../basic_api/memory_vector_compute/reduction_compute/ReduceRepeat.md)的内部的相加方式一致，采用二叉树方式，两两相加，可参考[Sum](../Sum接口/Sum.md)。
