...
-   传入的scaleB地址空间大小必须不小于[singleCoreK](../Matmul-Tiling类/TCubeTiling结构体.md)\*[singleCoreN](../Matmul-Tiling类/TCubeTiling结构体.md)/32。
