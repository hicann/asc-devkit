...
- 确保Grid中的线程块总数不超过设备的AIV物理核数，以避免程序卡死。开发者可以通过[aclrtGetDeviceInfo](https://gitcode.com/cann/runtime/blob/master/docs/zh/api_ref/04_device_management.md#aclrtGetDeviceInfo)接口查询设备的AIV物理核数。
