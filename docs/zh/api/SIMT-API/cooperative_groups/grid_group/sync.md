...
- 确保Grid中的线程块总数不超过设备的AIV物理核数，以避免程序卡死。开发者可以通过[aclrtGetDeviceInfo](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/920/API/runtimeapi/aclcppdevg_03_1867.html)接口查询设备的AIV物理核数。
