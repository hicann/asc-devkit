...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/cooperative_groups/thread_block_tile/shfl_down_res.md#id1 -->
...
仅支持`thread_block_tile`的模板参数`Size`为2的幂（1、2、4、8、16、32）且小于等于32的场景，即仅支持单Warp内线程子组。
