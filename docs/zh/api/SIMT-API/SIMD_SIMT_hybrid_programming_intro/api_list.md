...
| 接口名 | 功能描述 |
| --- | --- |
| [htanh](../math_functions/bfloat16_type/bfloat16_math_functions/htanh-176.md) | 获取输入数据的三角函数双曲正切值。 |
...
| 接口名 | 功能描述 |
| --- | --- |
| [h2tanh](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2tanh-242.md) | 获取输入数据各元素的三角函数双曲正切值。 |
