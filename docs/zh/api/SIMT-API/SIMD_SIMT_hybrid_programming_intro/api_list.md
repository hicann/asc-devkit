...
| 接口名 | 功能描述 |
| --- | --- |
| [__float22hif82_rna](../math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rna.md) | 获取输入的两个分量遵循CAST_ROUND模式转换成的hifloat8x2_t类型数据。 |
| [__float22hif82_rna_sat](../math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rna_sat.md) | 饱和模式下获取输入的两个分量遵循CAST_ROUND模式转换成的hifloat8x2_t类型数据。 |
| [__float22hif82_rh](../math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rh.md) | 获取输入的两个分量遵循CAST_HYBRID模式转换成的hifloat8x2_t类型数据。 |
| [__float22hif82_rh_sat](../math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rh_sat.md) | 饱和模式下获取输入的两个分量遵循CAST_HYBRID模式转换成的hifloat8x2_t类型数据。 |
| [__asc_cvt_float2_to_fp8x2](../math_functions/fp8_type/fp8_conversion_functions/__asc_cvt_float2_to_fp8x2.md) | 输入的两个分量遵循CAST_RINT模式，根据指定的8位浮点数类型和指定的饱和模式，转换成__asc_fp8x2_storage_t类型数据。 |
| [__asc_cvt_float_to_fp8](../math_functions/fp8_type/fp8_conversion_functions/__asc_cvt_float_to_fp8.md) | 将float类型数据按照CAST_RINT模式转换为指定类型的8位浮点数。 |
| [__half22hif82_rna](../math_functions/fp8_type/fp8_conversion_functions/__half22hif82_rna.md) | 获取输入的两个分量遵循CAST_ROUND模式转换成的hifloat8x2_t类型数据。 |
| [__half22hif82_rna_sat](../math_functions/fp8_type/fp8_conversion_functions/__half22hif82_rna_sat.md) | 饱和模式下获取输入的两个分量遵循CAST_ROUND模式转换成的hifloat8x2_t类型数据。 |
| [__half22hif82_rh](../math_functions/fp8_type/fp8_conversion_functions/__half22hif82_rh.md) | 获取输入的两个分量遵循CAST_HYBRID模式转换成的hifloat8x2_t类型数据。 |
| [__half22hif82_rh_sat](../math_functions/fp8_type/fp8_conversion_functions/__half22hif82_rh_sat.md) | 饱和模式下获取输入的两个分量遵循CAST_HYBRID模式转换成的hifloat8x2_t类型数据。 |
| [__hif822float2](../math_functions/fp8_type/fp8_conversion_functions/__hif822float2.md) | 获取hifloat8x2_t类型输入转换成的float2类型数据。 |
| [__hif822half2](../math_functions/fp8_type/fp8_conversion_functions/__hif822half2.md) | 获取hifloat8x2_t类型输入转换成的half2类型数据。 |
| [__e4m3x22float2](../math_functions/fp8_type/fp8_conversion_functions/__e4m3x22float2.md) | 获取float8_e4m3x2_t类型输入转换成的float2类型数据。 |
| [__e5m2x22float2](../math_functions/fp8_type/fp8_conversion_functions/__e5m2x22float2.md) | 获取float8_e5m2x2_t类型输入转换成的float2类型数据。 |
...
| 接口名 | 功能描述 |
| --- | --- |
| [htanh](../math_functions/half_type/half_math_functions/htanh.md) | 获取输入数据的三角函数双曲正切值。 |
...
| 接口名 | 功能描述 |
| --- | --- |
| [h2tanh](../math_functions/half_type/half2_math_functions/h2tanh.md) | 获取输入数据各元素的三角函数双曲正切值。 |
...
| 接口名 | 功能描述 |
| --- | --- |
| [htanh](../math_functions/bfloat16_type/bfloat16_math_functions/htanh.md) | 获取输入数据的三角函数双曲正切值。 |
...
| [__highs2bfloat162](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__highs2bfloat162.md) | 分别提取两个bfloat16x2输入的高16位，并填充到bfloat16x2中。返回填充后的数据。 |
...
| [__lows2bfloat162](../math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__lows2bfloat162.md) | 分别提取两个bfloat16x2输入的低16位，并填充到bfloat16x2中。返回填充后的数据。 |
...
| 接口名 | 功能描述 |
| --- | --- |
| [h2tanh](../math_functions/bfloat16_type/bfloat16x2_math_functions/h2tanh.md) | 获取输入数据各元素的三角函数双曲正切值。 |
...
| [tanhf](../math_functions/float_math_functions/tanhf.md) | 获取输入数据的三角函数双曲正切值。 |
