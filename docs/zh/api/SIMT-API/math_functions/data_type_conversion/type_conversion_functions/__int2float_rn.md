...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/data_type_conversion/type_conversion_functions/__int2float_rn_res.md#id1 -->

## 功能说明

遵循CAST\_RINT模式，将int32类型数据转换为浮点数，返回转换后的值。
