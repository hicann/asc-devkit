...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/data_type_conversion/type_conversion_functions/__float2ll_rn_res.md#id1 -->
...
输入遵循CAST\_RINT模式转换成的64位有符号整数。特殊值如下：
