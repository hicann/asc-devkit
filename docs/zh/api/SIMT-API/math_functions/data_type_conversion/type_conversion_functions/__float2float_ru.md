...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/data_type_conversion/type_conversion_functions/__float2float_ru_res.md#id1 -->

## 功能说明

将浮点数四舍五入取整，并遵循CAST\_CEIL模式。
