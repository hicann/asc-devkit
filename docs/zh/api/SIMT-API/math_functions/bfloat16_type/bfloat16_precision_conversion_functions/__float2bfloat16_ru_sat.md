...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__float2bfloat16_ru_sat_res.md#id1 -->

## 功能说明

头文件路径为：`"simt_api/asc_bf16.h"`。

饱和模式下，将浮点数转换为bfloat16精度，并遵循CAST\_CEIL模式，返回转换后的值。
...
饱和模式下将输入遵循CAST\_CEIL模式转换成的bfloat16类型数据。特殊值如下：
