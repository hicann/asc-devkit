...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/bfloat16_type/bfloat16_precision_conversion_functions/__bfloat162bfloat16_rd_res.md#id1 -->
...
输入遵循CAST\_FLOOR模式取整后的bfloat16\_t类型数据。本接口受全局饱和模式影响，特殊值如下：
