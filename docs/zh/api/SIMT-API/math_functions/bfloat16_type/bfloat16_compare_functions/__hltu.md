...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/bfloat16_type/bfloat16_compare_functions/__hltu_res.md#id1 -->

## 功能说明

头文件路径为：`"simt_api/asc_bf16.h"`。

比较两个bfloat16类型数据，当第一个数据小于第二个数据时，返回true。若任一输入为nan，返回true。
