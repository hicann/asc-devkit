...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/bfloat16_type/bfloat16_compare_functions/__hleu_res.md#id1 -->
...
比较输入的第一个数是否小于或等于第二个数的结果。

-   true：第一个数小于或等于第二个数，或者任一输入为nan。
-   false：第一个数大于第二个数。
