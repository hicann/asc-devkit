...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/bfloat16_type/bfloat16x2_math_functions/h2floor_res.md#id1 -->
...
小于或等于输入数据各元素的最大整数值。本接口受全局饱和模式影响，特殊值如下：
