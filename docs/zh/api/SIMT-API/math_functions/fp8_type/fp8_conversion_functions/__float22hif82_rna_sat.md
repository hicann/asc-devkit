...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/fp8_type/fp8_conversion_functions/__float22hif82_rna_sat_res.md#id1 -->
...
| inf | inf | 32768 |
| -inf | -inf | -32768 |
| 超出hif8范围的正值 | inf | 32768 |
| 超出hif8范围的负值 | -inf | -32768 |
