...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/half_type/half_precision_conversion_functions/__half2half_rn_res.md#id1 -->

## 功能说明

头文件路径为：`"simt_api/asc_fp16.h"`。

将half类型数据遵循CAST\_RINT模式取整。
...
输入遵循CAST\_RINT模式取整后的half类型数据。本接口受全局饱和寄存器的影响，特殊值如下：
