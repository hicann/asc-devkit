...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/half_type/half_precision_conversion_functions/__ull2half_rna_res.md#id1 -->

## 功能说明

遵循CAST\_ROUND模式，将uint64类型数据转换为half类型数据，返回转换后的值。
