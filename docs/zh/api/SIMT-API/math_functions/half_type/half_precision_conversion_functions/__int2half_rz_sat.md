...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/half_type/half_precision_conversion_functions/__int2half_rz_sat_res.md#id1 -->
...
遵循CAST\_TRUNC模式，将输入int32数据转换成的half数据。特殊值如下：
