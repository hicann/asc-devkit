...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/half_type/half_precision_conversion_functions/__uint2half_ru_sat_res.md#id1 -->

## 功能说明

将uint32类型数据转换为half类型数据，并遵循CAST\_CEIL模式，返回转换后的值。
...
遵循CAST\_CEIL模式，将输入uint32数据转换成的half数据。特殊值如下：
