...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/half_type/half_precision_conversion_functions/__float2half_rna_sat_res.md#id1 -->
...
将输入遵循CAST\_ROUND模式转换成的半精度浮点数。特殊值如下：
