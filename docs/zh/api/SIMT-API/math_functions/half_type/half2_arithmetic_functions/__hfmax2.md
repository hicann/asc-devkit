...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/SIMT-API/math_functions/half_type/half2_arithmetic_functions/__hfmax2_res.md#id1 -->

## 功能说明

头文件路径为：`"simt_api/asc_fp16.h"`。

计算输入half2类型数据各分量的乘加的结果（前两个输入相乘后与第三个输入相加），并遵循CAST\_RINT模式对结果进行舍入。
