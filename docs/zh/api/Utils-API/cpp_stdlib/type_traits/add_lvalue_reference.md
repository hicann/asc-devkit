...
- Atlas 训练系列产品：不支持
<!-- end id6 -->
<!-- @ref: asc-devkit/res/docs/zh/api/Utils-API/cpp_stdlib/type_traits/add_lvalue_reference_res.md#id1 -->
...
add\_lvalue\_reference是一个结构体，其提供一个嵌套类型type，表示添加左值引用限定符后的类型。通过add\_lvalue\_reference<Tp\>::type来访问该类型。
