# 基本开发流程<a name="ZH-CN_TOPIC_0000001985333472"></a>

该开发流程以[工程化算子开发](../aclnn_operator_development/overview.md)为基础，除了需要提供工程化算子开发中的算子实现文件外，还需要额外交付算子入图的代码文件。本节仅提供算子入图代码文件的开发指导。
...
**图1**  shape与datatype推导示意图<a name="fig1729122183718"></a>  
![](../../../figures/shape_dtype.png "shape与datatype推导示意图")
