...
**图1**  Tensor原地操作实现原理<a name="fig1745165317496"></a>  
![](../../../figures/tensor_inplace.png "Tensor原地操作实现原理")
...
- **调用原地操作接口**：使用inplace接口直接操作LocalTensor。
    - [AllocTensor](../../../../api/SIMD-API/basic_api/resource_management/TQue/AllocTensor.md)和[DeQue](../../../../api/SIMD-API/basic_api/resource_management/TQue/DeQue.md)区分non-inplace和inplace接口，详情请参考[AllocTensor](../../../../api/SIMD-API/basic_api/resource_management/TQue/AllocTensor.md)、[DeQue](../../../../api/SIMD-API/basic_api/resource_management/TQue/DeQue.md)。
