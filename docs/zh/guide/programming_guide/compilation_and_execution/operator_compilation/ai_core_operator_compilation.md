...
|------|----------|------|
| -help | 否 | 查看帮助。 |
| --npu-arch | 是 | 编译时指定的AI处理器架构，取值为dav-&lt;arch-version&gt;，其中&lt;arch-version&gt;为NPU架构版本号，各产品型号对应的架构版本号请通过[对应关系表](../../language_extension/simd_builtin_keywords.md#npu-arch)进行查询。 |
