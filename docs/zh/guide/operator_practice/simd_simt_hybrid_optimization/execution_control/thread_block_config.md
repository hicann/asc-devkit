...
物理核数可以在运行期通过[aclrtGetDeviceInfo](https://gitcode.com/cann/runtime/blob/9.2.0-beta.2/docs/zh/api_ref/04_device_management.md#aclrtGetDeviceInfo)查询。在下面的场景中，实测的物理核数均为64。
