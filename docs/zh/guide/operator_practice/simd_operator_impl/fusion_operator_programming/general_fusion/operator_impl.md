...
1.  **编译**
    ...
    参考[AllGatherMatmul样例](https://gitcode.com/cann/ops-transformer/tree/9.2.0/mc2/all_gather_matmul_v2)中生成自定义算子工程、编译算子的命令，运行install.sh脚本完成编译。
...
3.  **运行**
    ...
    在通算融合场景，单算子API调用的程序中需要调用[通信域创建与管理接口](https://gitcode.com/cann/hcomm/blob/9.2.0/docs/zh/api_ref/comm_mgr_c/README.md)创建通信域，并在多线程上执行AllGatherMatmul算子。以下给出main函数和线程调用函数中关键步骤的代码示例，仅供参考。
