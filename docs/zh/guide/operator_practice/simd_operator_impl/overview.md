...
本章介绍矢量编程、矩阵编程、融合算子编程三种典型场景下的算子Tiling、Kernel实现，是对上文中典型[编程范式](../../programming_guide/programming_model/ai_core_simd_programming/overview.md)的具体应用，同时也介绍了编程的更多细节、API的使用方法等。
