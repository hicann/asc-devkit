...
-   Tiling优化
    ...
    **表1**  Tiling优化策略总览
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><p id="p123781939164916"><a name="p123781939164916"></a><a name="p123781939164916"></a><a href="matmul_tiling_strategy.md">Matmul算子优化Tiling策略</a></p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   并行度优化
    ...
    **表2**  并行度优化策略总览
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><p id="p1625832617508"><a name="p1625832617508"></a><a name="p1625832617508"></a><a href="matmul_multi_core_split_k.md">Matmul高阶API开启多核切K</a></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><p id="p192580261505"><a name="p192580261505"></a><a name="p192580261505"></a><a href="matmul_multi_core_k_stagger.md">Matmul高阶API开启多核K轴错峰访问内存</a></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><a name="ol224351311615"></a><a name="ol224351311615"></a><ol id="ol224351311615"><li><a href="matmul_unit_flag.md">Matmul高阶API开启UnitFlag</a></li><li><a href="matmul_nbuffer33.md">Matmul高阶API开启NBuffer33模板</a></li></ol>
    </td>
    </tr>
    </tbody>
    </table>
...
-   内存优化
    ...
    **表3**  内存优化策略总览
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><p id="p1160255465017"><a name="p1160255465017"></a><a name="p1160255465017"></a><a href="matmul_ibshare_ab.md">Matmul高阶API开启IBShare模板共享A和B矩阵数据</a></p>
    <p id="p8602185495016"><a name="p8602185495016"></a><a name="p8602185495016"></a><a href="matmul_ibshare_b.md">Matmul高阶API开启IBShare模板共享B矩阵数据</a></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><p id="p16602754195019"><a name="p16602754195019"></a><a name="p16602754195019"></a><a href="aiv_nd2nz_conversion.md">AIV核上的ND2NZ格式转换</a></p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   Scalar优化
    ...
    **表4**  Scalar优化策略总览
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><p id="p12148182365118"><a name="p12148182365118"></a><a name="p12148182365118"></a><a href="matmul_tiling_constant.md">Matmul高阶API开启Tiling全量常量化</a></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><p id="p17148723205118"><a name="p17148723205118"></a><a name="p17148723205118"></a><a href="matmul_pure_cube.md">Matmul高阶API开启纯Cube模式</a></p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   搬运优化
    ...
    **表5**  搬运优化策略总览
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><a name="ol0907154317615"></a><a name="ol0907154317615"></a><ol id="ol0907154317615"><li><a href="matmul_mdl_template.md">Matmul高阶API开启MDL模板</a></li><li><a href="matmul_l2_cache_split.md">Matmul高阶API开启L2 Cache切分</a></li></ol>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.087091290870916%" headers="mcps1.2.4.1.3 "><p id="p042947135117"><a name="p042947135117"></a><a name="p042947135117"></a><a href="matmul_mte2_preload.md">Matmul高阶API开启MTE2 Preload</a></p>
    </td>
    </tr>
    </tbody>
    </table>
