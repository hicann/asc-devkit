# Vector算子灵活运用Counter模式<a name="ZH-CN_TOPIC_0000001989723914"></a>
...
提示：Normal模式和Counter模式、掩码的介绍可参考[如何使用掩码操作API](../../../programming_guide/library_api/basic_api/quick_reference/how_to_use_mask_api.md)。

以下反例和正例中的代码均以[AddCustom](../../../../../../examples/01_simd_cpp_api/02_features/99_acl_based/00_acl_compilation/custom_op)算子为例，修改其中Add接口的调用代码，以说明Counter模式的优势。
