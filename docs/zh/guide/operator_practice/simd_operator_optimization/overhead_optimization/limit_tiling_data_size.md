# 限制TilingData结构大小<a name="ZH-CN_TOPIC_0000001846878548"></a>
...
-   如下的示例中存在TilingData结构变量冗余的情况：NumBlocks信息已经通过SetSimdNumBlocks接口进行设置，可以在核函数（Kernel）侧调用GetBlockNum接口获取，无需通过TilingData结构传递。
