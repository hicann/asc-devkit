...
`AttrType`描述属性是否必须提供，常用取值为`REQUIRED`和`OPTIONAL`。`Bool`、`Float`、`Int`等接口用于声明属性数据类型和默认值，具体说明请参考[OpAttrDef](../../../../../api/Utils-API/prototype_register_management/OpAttrDef/OpAttrDef-272.md)。
