...
- 如果算法本身不需要DCache缓存，可以使用[ReadGmByPassDCache](<../../../../api/SIMD-API/基础API/标量计算/ReadGmByPassDCache(ISASI).md>)和[WriteGmByPassDCache](<../../../../api/SIMD-API/基础API/标量计算/WriteGmByPassDCache(ISASI).md>)直接读写GM。
