# 开启Tiling下沉<a name="ZH-CN_TOPIC_0000002130625528"></a>
...
-   算子核函数实现
    ...
    当前Tiling下沉仅支持融合算子，为了模拟融合算子场景，通过[KERNEL\_TASK\_TYPE\_DEFAULT](../../../../api/SIMD-API/基础API/Kernel-Tiling/设置Kernel类型.md)接口强制指定算子在AIC、AIV混合场景运行。
