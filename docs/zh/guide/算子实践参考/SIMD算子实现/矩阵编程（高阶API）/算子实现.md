...
针对数据格式，包括CubeFormat::ND, CubeFormat::NZ, CubeFormat::ND\_ALIGN三种，ND和NZ格式在[数据格式](基础知识.md#zh-cn_topic_0000001622194138_section1453415011)章节已经介绍，ND\_ALIGN格式的介绍请参考[数据排布格式](../../../technical_appendix/concepts_and_terms/neural_networks_and_operators/data_layout.md#li075920427155)。
