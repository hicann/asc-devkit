...
-   单核Tiling时设置
    -   [SetOrgShape](../../../../api/SIMD-API/adv_api/cube_compute/Matmul_Tiling/SetOrgShape-87.md)（必选）：设置M、N、K
...
-   多核Tiling时设置
    ...
    -   [SetSingleShape](../../../../api/SIMD-API/adv_api/cube_compute/Matmul_Tiling/SetSingleShape-86.md)\(非必选\)：设置singleCoreM、singleCoreN、singleCoreK
