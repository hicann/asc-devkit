...
针对数据格式，包括CubeFormat::ND, CubeFormat::NZ, CubeFormat::ND\_ALIGN三种，ND和NZ格式在[数据格式](基础知识.md#zh-cn_topic_0000001622194138_section1453415011)章节已经介绍，ND\_ALIGN格式的介绍请参考[数据排布格式](../../../技术附录/概念原理和术语/神经网络和算子/数据排布格式.md#li075920427155)。
