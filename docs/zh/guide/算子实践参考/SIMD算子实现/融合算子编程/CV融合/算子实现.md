...
根据上述分析，明确实现过程中会使用到[Matmul高阶API](../../../../../api/SIMD-API/高阶API/矩阵计算/Matmul-Kernel侧接口/Matmul-Kernel侧接口.md)接口，[LeakyRelu Vector计算接口](../../../../../api/SIMD-API/basic_api/memory_vector_compute/basic_arithmetic/LeakyRelu.md)、[DataCopy](../../../../../api/SIMD-API/basic_api/data_move_guide/overview/data_move_concept.md)、[EnQue](../../../../../api/SIMD-API/basic_api/resource_management/TQue/EnQue.md)、[DeQue](../../../../../api/SIMD-API/basic_api/resource_management/TQue/DeQue.md)接口。
