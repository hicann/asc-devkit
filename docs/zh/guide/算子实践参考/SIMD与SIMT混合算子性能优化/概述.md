...
| 优化建议 | 样例 |
| --- | --- |
| [通过SIMT实现分支判断](./计算优化/通过SIMT实现分支判断.md) | [simd_simt_high_performance](../../../../../examples/05_simd_simt_hybrid/02_best_practices/simd_simt_high_performance) |

表2 内存访问优化建议总览表

| 优化建议 | 样例 |
| --- | --- |
| [使用Unified Buffer提升内存访问效率](./内存访问/使用Unified-Buffer提升内存访问效率.md) | [simd_simt_high_performance](../../../../../examples/05_simd_simt_hybrid/02_best_practices/simd_simt_high_performance) |
| [访存合并](../SIMT算子性能优化/内存访问/访存合并.md) | [simd_simt_matrix_transpose](../../../../../examples/05_simd_simt_hybrid/02_best_practices/simd_simt_matrix_transpose) |
| [避免UB的Bank冲突](../SIMT算子性能优化/内存访问/避免UB的Bank冲突.md) | [matrix_transpose_practice](../../../../../examples/03_simt_api/03_best_practices/00_memory_optimizations/matrix_transpose_practice) |
| [DCache访问优化](../SIMT算子性能优化/内存访问/DCache访问优化.md) | [cache_hint](../../../../../examples/03_simt_api/03_best_practices/00_memory_optimizations/cache_hint) |
| [使用短向量类型提升效率](../SIMT算子性能优化/内存访问/短向量类型提升效率.md) | [short_vector_add](../../../../../examples/03_simt_api/03_best_practices/00_memory_optimizations/short_vector_add) |
| [通过类型对齐提升搬运效率](../SIMT算子性能优化/内存访问/通过类型对齐提升搬运效率.md) | [aligned_types](../../../../../examples/03_simt_api/03_best_practices/00_memory_optimizations/aligned_types) |

表3 执行控制优化建议总览表

| 优化建议 | 样例 |
| --- | --- |
| [线程块数量配置优化](./执行控制/线程块数量配置优化.md) | [simd_simt_grid_dim_config](../../../../../examples/05_simd_simt_hybrid/02_best_practices/simd_simt_grid_dim_config) |

表4 控制流优化建议总览表

| 优化建议 | 样例 |
| --- | --- |
| [同一Warp内避免分支跳转](../SIMT算子性能优化/控制流/同一Warp内避免分支跳转.md) | [warp_divergence](../../../../../examples/03_simt_api/03_best_practices/02_control_flow/warp_divergence) |

表5 指令优化建议总览表

| 优化建议 | 样例 |
| --- | --- |
| [整数除法的快速算法](./指令优化/整数除法的快速算法.md) | [simd_simt_integer_fast_div](../../../../../examples/05_simd_simt_hybrid/02_best_practices/simd_simt_integer_fast_div) |
