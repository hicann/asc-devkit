...
- [DataCopy](../../../../../api/SIMD-API/基础API/Memory矢量计算/数据搬运/DataCopy_GMAndUB_continuous.md)：用于在GM和UB之间搬运数据的API。
- [PipeBarrier](../../../../../api/SIMD-API/基础API/同步控制/核内同步/PipeBarrier_ISASI.md)：流水线同步屏障，确保数据搬运完成后再执行后续操作。
...
在算子kernel侧实现代码中需要输出日志信息的地方调用[printf](../../../../../api/Utils-API/调测接口/printf.md)接口打印相关内容。
