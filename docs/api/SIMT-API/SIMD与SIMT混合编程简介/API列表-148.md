...
| [__highs2bfloat162](../数学函数/bfloat16类型/bfloat16类型精度转换函数/__highs2bfloat162.md) | 分别提取两个bfloat16x2输入的高16位，并填充到bfloat16x2中。返回填充后的数据。 |
...
| [__lows2bfloat162](../数学函数/bfloat16类型/bfloat16类型精度转换函数/__lows2bfloat162.md) | 分别提取两个bfloat16x2输入的低16位，并填充到bfloat16x2中。返回填充后的数据。 |
