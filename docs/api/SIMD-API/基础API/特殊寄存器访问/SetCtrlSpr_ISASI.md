...
| CTRL[60] | 用于控制饱和模式的全局生效方式。<br>&bull; 1'b0：单指令设置饱和；<br>&bull; 1'b1：全局设置饱和。 | 1'b1 | 该控制位可与Reg矢量计算API [Cast](../Reg矢量计算/类型转换/Cast-45.md)配合使用，或与CTRL[48]、CTRL[59]配合使用，具体配置信息参考[Ascend 950PR/Ascend 950DT饱和模式全局或单指令生效配置表](#table231122118201)。 |
...
- Ascend 950PR/Ascend 950DT对于CTRL[8:6]和CTRL[10:9]的设置，已封装原子操作API，建议通过这些原子操作API进行配置。
  ...
  - [SetAtomicMax](../原子操作/SetAtomicMax_ISASI.md)
  - [SetAtomicMin](../原子操作/SetAtomicMin_ISASI.md)
<!-- end id17 -->
...
更多示例请参考[CtrlSpr样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0/examples/01_simd_cpp_api/03_basic_api/09_utils/ctrl_spr)。
