...
本样中只展示部分关键代码。如果您需要运行样例代码，请参考完整样例[复合计算样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0/examples/01_simd_cpp_api/03_basic_api/01_memory_vector_compute/element_wise_compound_compute)。
