...
[DataCopyPad](../数据搬运/GM与UB数据搬运/DataCopyPad_GMToUB.md)从Global Memory将数据非对齐搬运至Unified Buffer时，可根据开发者的需要自行填充数据。SetPadValue用于设置DataCopyPad需要填充的数值。
...
完整样例请参考[DataCopyPad样例场景1](https://gitcode.com/cann/asc-devkit/blob/9.1.0/examples/01_simd_cpp_api/03_basic_api/00_data_movement/data_copy_pad_gm2ub_ub2gm)。
