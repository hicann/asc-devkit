# GM与UB切片数据搬运\(DataCopy\)<a name="ZH-CN_TOPIC_0000002568770166"></a>
...
完整样例请参考[切片数据搬运样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0/examples/01_simd_cpp_api/03_basic_api/00_data_movement/data_copy_gm2ub_slice)。srcSliceInfo、dstSliceInfo参数解析与结果示例请参考[图1](#fig1196816115710)。
