...
| selMode | 输入 | 指令模式，SELMODE类型，取值如下：<br><pre>enum class SELMODE : uint8_t {<br>    VSEL_CMPMASK_SPR = 0, <br>    VSEL_TENSOR_SCALAR_MODE,<br>    VSEL_TENSOR_TENSOR_MODE,<br>};</pre> 三种模式详细说明请参考[功能说明](#功能说明)。|
