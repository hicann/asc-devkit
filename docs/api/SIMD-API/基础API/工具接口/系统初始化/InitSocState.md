...
| AIC | 初始化[Load3D接口调用时Pad填充的数值](../../cube_compute_ISASI/矩阵搬入辅助配置接口/SetLoadDataPaddingValue.md#功能说明)为0。 |
| AIC | 初始化[使用Load3D时A1/B1的边界值](../../cube_compute_ISASI/矩阵搬入辅助配置接口/SetLoadDataBoundary.md#功能说明)为0，表示无边界。 |
