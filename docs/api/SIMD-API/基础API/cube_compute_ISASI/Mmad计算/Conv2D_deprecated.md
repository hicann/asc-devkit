...
| loopMode | LoopMode | 遍历模式，结构体具体定义为：<br><br>enum class LoopMode {<br>    MODE_NM = 0,<br>    MODE_MN = 1,<br>    MODE_KM = 2,<br>    MODE_KN = 3<br>};<br><br>|
