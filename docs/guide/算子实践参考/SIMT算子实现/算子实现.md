...
下文将对上述步骤进行详细介绍。完整的算子实现请参考[gather算子实现样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0/examples/03_simt_api/00_introduction/01_gather/general_gather)。
