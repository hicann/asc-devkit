...
>    } 
>    ```
>    完整样例请参考[matmul_fused_manual样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0/examples/01_simd_cpp_api/04_advanced_api/00_matmul/matmul_fused_manual)。
