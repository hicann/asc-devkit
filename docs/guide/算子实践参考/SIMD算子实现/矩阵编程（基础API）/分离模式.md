...
| 核函数名称 | matmul_custom |
| 使用的主要接口 | [DataCopy](../../../../api/SIMD-API/基础API/cube_compute_ISASI/矩阵计算的搬入/DataCopy_GMToL1_ND2NZ.md)：Global Memory到L1 Buffer数据搬运 + ND转NZ格式转换接口<br>[Load2D](../../../../api/SIMD-API/基础API/cube_compute_ISASI/矩阵计算的搬入/Load2D.md)：L1 Buffer到L0 Buffer数据搬运 + NZ转ZZ/ZN格式转换接口<br>[Mmad](../../../../api/SIMD-API/基础API/cube_compute_ISASI/Mmad计算/Mmad.md)：矩阵乘计算接口<br>[Fixpipe](../../../../api/SIMD-API/基础API/cube_compute_ISASI/矩阵计算的搬出/Fixpipe_L0CToGM.md)：L0C Buffer到Global Memory数据搬出 + NZ转ND格式转换 + 精度转换接口 |
...
1.  CopyIn任务（Globale Memory --> L1 Buffer）  
    使用[DataCopy](../../../../api/SIMD-API/基础API/cube_compute_ISASI/矩阵计算的搬入/DataCopy_GMToL1_ND2NZ.md)接口将Global Memory中的数据搬运到L1 Buffer，将ND格式转换为NZ格式。

2.  Split任务（L1 Buffer--> L0 Buffer）    
    使用[Load2D](../../../../api/SIMD-API/基础API/cube_compute_ISASI/矩阵计算的搬入/Load2D.md)接口将数据从L1 Buffer中搬运到L0A Buffer/L0B Buffer，同时完成NZ到ZZ/ZN的格式转换。
...
4.  CopyOut任务（L0C Buffer--> Globale Memory）    
    使用[Fixpipe](../../../../api/SIMD-API/基础API/cube_compute_ISASI/矩阵计算的搬出/Fixpipe_L0CToGM.md)接口将结果从L0C Buffer直接搬运到Global Memory，同时利用Fixpipe的随路格式转换功能将NZ格式转回ND格式。
