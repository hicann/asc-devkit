...
1.  Stage1：CopyIn实现。
    ...
    2.  使用[EnQue](../../../../api/SIMD-API/基础API/资源管理/TQue/EnQue.md)将LocalTensor放入VECIN的Queue中。
...
2.  Stage2：Compute实现。
    ...
    1.  使用[DeQue](../../../../api/SIMD-API/基础API/资源管理/TQue/DeQue.md)从VECIN中取出LocalTensor。
    2.  使用Ascend C接口[Add](../../../../api/SIMD-API/基础API/Memory矢量计算/基础算术/Add.md)完成矢量计算。
    3.  使用[EnQue](../../../../api/SIMD-API/基础API/资源管理/TQue/EnQue.md)将计算结果LocalTensor放入到VECOUT的Queue中。
...
3.  Stage3：CopyOut实现。
    ...
    1.  使用[DeQue](../../../../api/SIMD-API/基础API/资源管理/TQue/DeQue.md)接口从VECOUT的Queue中取出LocalTensor。
