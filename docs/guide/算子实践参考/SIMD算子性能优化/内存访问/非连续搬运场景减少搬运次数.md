...
DataCopy接口在Ascend 950PR/Ascend 950DT上支持多维数据的搬运，具体可参考[GMToUB多维数据搬运NDDMA(DataCopy)](../../../../api/SIMD-API/基础API/Memory矢量计算/数据搬运/DataCopy_GMToUB_NDDMA.md)。以2D场景的搬运为例，代码如下：
