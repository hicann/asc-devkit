...
if (DEFINED ASCEND_SOC_SERIES)
    if (DEFINED ASCEND_COMPUTE_UNIT)
        message(FATAL_ERROR "ASCEND_SOC_SERIES and ASCEND_COMPUTE_UNIT cannot be set at the same time")
    endif()
    if ("${ASCEND_SOC_SERIES}" STREQUAL "")
        message(FATAL_ERROR "ASCEND_SOC_SERIES cannot be empty")
    endif()
    set(ASCEND_COMPUTE_UNIT)
    foreach(soc_series ${ASCEND_SOC_SERIES})
        string(TOLOWER "${soc_series}" soc_series_lower)
        list(FIND ASC_VALID_SOC_LIST "${soc_series_lower}" _SOC_INDEX)
        if(_SOC_INDEX EQUAL -1)
            message(FATAL_ERROR "SOC_SERIES ${soc_series} does not support, the support list is ${ASC_VALID_SOC_LIST}")
        endif()
        list(APPEND ASCEND_COMPUTE_UNIT "${soc_series_lower}")
    endforeach()
elseif (NOT DEFINED ASCEND_COMPUTE_UNIT)
