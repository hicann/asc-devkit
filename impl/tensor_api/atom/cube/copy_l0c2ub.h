...
#warning \
    "impl/tensor_api/atom/cube/copy_l0c2ub.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ATOM_CUBE_COPY_L0C2UB_H
#define IMPL_TENSOR_API_ATOM_CUBE_COPY_L0C2UB_H
...
struct copy_traits<copy_l0c_to_ub_with, TraitStruct> {
...
#endif // IMPL_TENSOR_API_ATOM_CUBE_COPY_L0C2UB_H
