...
#warning \
    "impl/tensor_api/arch/cube/l0c_to_l1/routing.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_CUBE_L0C_TO_L1_ROUTING_H
#define IMPL_TENSOR_API_ARCH_CUBE_L0C_TO_L1_ROUTING_H

#include "impl/tensor_api/arch/cube/utils/l0c2out_utils.h"
#include "impl/tensor_api/arch/cube/l0c_to_l1/copy_impl/l0c_to_l1_data_copy.h"
