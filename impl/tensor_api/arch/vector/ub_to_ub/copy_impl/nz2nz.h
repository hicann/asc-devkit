...
#warning                                                                                                               \
    "impl/tensor_api/arch/vector/ub_to_ub/copy_impl/nz2nz.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
...
public:
        ...
        const SrcCoord& src_coord, const ShapeType& copy_shape)
    {
        ...
        auto block_count = get_shape_batch_size(src_shape) *
            Std::ceil_division(get_shape_columns(src_shape), c0_element<src_type>);
