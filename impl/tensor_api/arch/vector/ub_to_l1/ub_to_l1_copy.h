...
#pragma message( \
    "impl/tensor_api/arch/vector/ub_to_l1/ub_to_l1_copy.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"tensor_api/tensor.h\"\" and use public functions or variables defined in interface headers files.")
#define ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_L1_COPY_H
#endif

/*!
 * \file ub_to_l1_copy.h
 * \brief
 */
...
__aicore__ inline void copy_ub_to_l1::copy(const Args&... args)
{
...
__aicore__ inline void copy_ub_to_l1::data_copy_impl(const DstTensor& dst, const SrcTensor& src)
{
    ...
    static_assert(
        Std::is_same_v<dst_pos, location::l1>, "For copy_ub_to_l1, the destination tensor must be located in L1.");
    static_assert(Std::is_same_v<src_pos, location::ub>, "For copy_ub_to_l1, the source tensor must be located in UB.");
    TENSOR_API_DEBUG_CHECK(debug_check_layout, dst.layout(), "dst", "copy_ub_to_l1");
    TENSOR_API_DEBUG_CHECK(debug_check_layout, src.layout(), "src", "copy_ub_to_l1");
    TENSOR_API_DEBUG_CHECK(debug_check_copy_size, src, dst, "copy_ub_to_l1");
...
template <
    ...
    typename ShapeType>
__aicore__ inline void copy_ub_to_l1::data_copy_impl(
...
#if defined(UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_L1_COPY_H)
#undef ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#undef UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_L1_COPY_H
#endif
