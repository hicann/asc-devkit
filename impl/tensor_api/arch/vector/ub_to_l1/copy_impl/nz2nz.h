 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_L1_COPY_IMPL_NZ2NZ_H
#define IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_L1_COPY_IMPL_NZ2NZ_H
...
class copy_ub_to_l1_nz : private copy_ub_to_l1_common {
public:
