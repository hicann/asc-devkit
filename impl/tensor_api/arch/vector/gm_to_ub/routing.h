...
#warning "impl/tensor_api/arch/vector/gm_to_ub/routing.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "tensor_api/tensor.h"" and use public functions or variables defined in interface headers files."
...
public:
    ...
    __aicore__ inline static void Run(const Args&... args) {
        static_assert(Std::is_same_v<Args..., void>, "CopyGM2UBIgnore should not be called");
    }
};
...
template <uint32_t Version>
struct CopyGM2UBRouting<Version, NDLayoutPtn, NDLayoutPtn> {
    using type = CopyGmToUbufAlignV2ND;
};
...
template <uint32_t Version>
struct CopyGM2UBRouting<Version, DNLayoutPtn, DNLayoutPtn> {
    using type = CopyGmToUbufAlignV2DN;
};
