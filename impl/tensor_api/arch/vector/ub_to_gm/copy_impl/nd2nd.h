...
public:
    ...
    template <const ub_to_gm_trait& trait, typename T, typename U, typename DstCoord, typename SrcCoord,
        typename ShapeType>
...
private:
    ...
    __aicore__ inline static void data_copy_impl(const DstTensor& dst, const SrcTensor& src)
    {
        ...
        uint32_t block_len = Std::min(get_total_column_shape(src_layout) * sizeof(src_type),
