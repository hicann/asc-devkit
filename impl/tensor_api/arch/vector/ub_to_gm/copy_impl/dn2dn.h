...
#pragma message( \
    "impl/tensor_api/arch/vector/ub_to_gm/copy_impl/dn2dn.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"tensor_api/tensor.h\"\" and use public functions or variables defined in interface headers files.")
#define ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_GM_COPY_IMPL_DN2DN_H
#endif
...
class copy_ub_to_gm_dn : private copy_ub_to_gm_common {
public:
...
private:
    ...
    __aicore__ inline static void data_copy_impl(const DstTensor& dst, const SrcTensor& src)
    {
        ...
        uint32_t block_len = Std::min(
            get_total_row_shape(src_layout) * sizeof(src_type), get_total_row_shape(dst_layout) * sizeof(dst_type));
...
#if defined( \
    UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_GM_COPY_IMPL_DN2DN_H)
#undef ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#undef UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_GM_COPY_IMPL_DN2DN_H
#endif
