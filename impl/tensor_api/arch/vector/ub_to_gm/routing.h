...
#pragma message( \
    "impl/tensor_api/arch/vector/ub_to_gm/routing.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"tensor_api/tensor.h\"\" and use public functions or variables defined in interface headers files.")
#define ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_GM_ROUTING_H
#endif
...
#include "impl/tensor_api/arch/vector/ub_to_gm/copy_impl/dn2dn.h"
...
#include "impl/tensor_api/arch/vector/ub_to_gm/copy_impl/zn2zn.h"
...
template <uint32_t version>
struct copy_ub_to_gm_routing<version, one_dim_layout_ptn, one_dim_layout_ptn> {
    using type = copy_ub_to_gm_one_dim;
};
...
template <uint32_t version>
struct copy_ub_to_gm_routing<version, zn_layout_ptn, zn_layout_ptn> {
    using type = copy_ub_to_gm_zn;
};
...
#if defined(UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_GM_ROUTING_H)
#undef ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#undef UNDEF_ASCENDC_TENSOR_API_INCLUDE_COMPILER_INTERNAL_HEADERS_IMPL_TENSOR_API_ARCH_VECTOR_UB_TO_GM_ROUTING_H
#endif
