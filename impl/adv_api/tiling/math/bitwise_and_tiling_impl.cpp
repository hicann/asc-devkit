...
#include <set>
#include "adv_api/math/bitwise_and_tiling.h"
...
static const std::set<uint32_t> SUPPORT_TYPESIZE = {
    BITWISE_AND_UINT8_SIZE, BITWISE_AND_UINT16_SIZE, BITWISE_AND_UINT32_SIZE, BITWISE_AND_UINT64_SIZE};
...
void GetBitwiseAndMaxMinTmpSize(
...
void GetBitwiseAndTmpBufferFactorSize(
