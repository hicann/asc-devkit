...
__aicore__ inline void CheckFuncFma(
...
#endif // IMPL_API_CHECK_KERNEL_CHECK_MATH_FMA_FMA_CHECK_H_

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_FMA_CHECK_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_FMA_CHECK_H__
#endif
