...
/*!
 * \file fma_check_common.h
 * \brief
 */
#if !defined(__ASCENDC_INCLUDE_INTERNAL_HEADERS__)
#pragma message( \
    "impl/adv_api/detail/api_check/kernel_check/math/fma/fma_check_common.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/math/fma.h\"\" and use public functions or variables defined in interface headers files.")
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_FMA_CHECK_COMMON_H__
#endif

#ifndef IMPL_API_CHECK_KERNEL_CHECK_MATH_FMA_FMA_CHECK_COMMON_H
#define IMPL_API_CHECK_KERNEL_CHECK_MATH_FMA_FMA_CHECK_COMMON_H
...
class CheckFuncClassFma : public DataTypeCheckFuncBasicClass,
...
public:
    __aicore__ inline CheckFuncClassFma(){};
    __aicore__ inline CheckFuncClassFma(__gm__ const char* name)
...
public:
        ...
        const LocalTensor<uint8_t>& sharedTmpBuffer, const uint32_t count)
    {
        ...
        CalCountCheckFuncBasicClass::CalCountVerifyingParameters(
            ARG_AND_STRING(count), VA_ARGS_TO_MAKE_TUPLE(dst, src0, src1, src2));

        SingleTensorCheckFuncBasicClass::TensorVerifyingParameters(
            VA_ARGS_TO_MAKE_TUPLE(dst, src0, src1, src2, sharedTmpBuffer),
        ...
        MultipleTensorCheckFuncBasicClass::TensorReuseVerifyingParameters(VA_ARGS_TO_MAKE_TUPLE(dst, src2));
    };
};

} // namespace HighLevelApiCheck
} // namespace AscendC
#endif // IMPL_API_CHECK_KERNEL_CHECK_MATH_FMA_FMA_CHECK_COMMON_H

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_FMA_CHECK_COMMON_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_FMA_CHECK_COMMON_H__
#endif
