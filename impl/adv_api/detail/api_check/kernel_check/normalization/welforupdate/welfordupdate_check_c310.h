...
/*!
 * \file welfordupdate_check_c310.h
 * \brief
 */
#if !defined(__ASCENDC_INCLUDE_INTERNAL_HEADERS__)
#pragma message( \
    "impl/adv_api/detail/api_check/kernel_check/normalization/welforupdate/welfordupdate_check_c310.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/normalization/welfordfinalize.h\"\" and use public functions or variables defined in interface headers files.")
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_WELFORDUPDATE_CHECK_C310_H__
#endif

#ifndef IMPL_API_CHECK_KERNEL_CHECK_NORMALIZATION_WELFORDUPDATE_WELFORDUPDATE_CHECK_C310_H_
#define IMPL_API_CHECK_KERNEL_CHECK_NORMALIZATION_WELFORDUPDATE_WELFORDUPDATE_CHECK_C310_H_
...
private:
        ...
        const LocalTensor<U>& inputVariance, const LocalTensor<T>& inputX, const WelfordUpdateParam& para)
    {
        ...
        ASCENDC_ASSERT(
            ((para.abComputeLength <= para.abLength && para.abComputeLength > 0) || HighLevelAPIParametersPrint), {
                KERNEL_LOG(
                    KERNEL_ERROR,
                    "[WelfordUpdate] The para.abComputeLength is %u, should be positive and less than or equal to "
                    "para.abLength.",
        ...
        ASCENDC_ASSERT((para.rnLength * para.abLength <= outputMean.GetSize() || HighLevelAPIParametersPrint), {
            KERNEL_LOG(
                ...
                "the product of para.rnLength and para.abLength should not larger than outputMean and outputVariance "
                "size %u.",
        ...
        ASCENDC_ASSERT((para.rnLength * para.abLength <= inputMean.GetSize() || HighLevelAPIParametersPrint), {
            KERNEL_LOG(
                KERNEL_ERROR,
                "[WelfordUpdate] The para.rnLength is %u, para.abLength is %u, "
                "the product of para.rnLength and para.abLength should not larger than inputMean and inputVariance "
                "size %u.",
...
#endif // IMPL_API_CHECK_KERNEL_CHECK_NORMALIZATION_WELFORDUPDATE_WELFORDUPDATE_CHECK_C310_H_

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_WELFORDUPDATE_CHECK_C310_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_WELFORDUPDATE_CHECK_C310_H__
#endif
