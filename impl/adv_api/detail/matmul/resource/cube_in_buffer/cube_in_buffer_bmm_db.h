...
#pragma message( \
    "impl/adv_api/detail/matmul/resource/cube_in_buffer/cube_in_buffer_bmm_db.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/matmul/matmul.h\"\" and use public functions or variables defined in interface headers files.")
...
class CubeInBuffer<
    ...
    enable_if_t<GetCubeInBufferType<INPUT_TYPE, MM_CFG>() == CubeInBufferType::BMM_DOUBLE_BUFFER>> {
...
public:
    ...
    __aicore__ inline void Destroy() { qid_.FreeAllEvent(); }
    ...
    __aicore__ inline bool Hit(int32_t iterIndex, int32_t bufferPos = -1) { return isCached_; }

    __aicore__ inline LocalTensor<TransT> GetBuffer(int32_t iterIndex, int32_t bufferPos = -1) { return cacheHead_[0]; }
