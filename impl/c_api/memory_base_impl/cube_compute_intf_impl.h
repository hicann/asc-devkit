...
#warning \
    "impl/c_api/memory_base_impl/cube_compute_intf_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "c_api/asc_simd.h"" and use public functions or variables defined in interface headers files."
#define ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS_ASCENDC
#endif

#ifndef IMPL_C_API_MEMORY_BASE_IMPL_CUBE_COMPUTE_INTF_IMPL_H
#define IMPL_C_API_MEMORY_BASE_IMPL_CUBE_COMPUTE_INTF_IMPL_H
...
{
    if ASC_IS_AIC {
        mad_sp(c, a, b, m, k, n, static_cast<uint8_t>(unit_flag_mode), c_matrix_source, c_matrix_init_val);
    }
}
...
{
    if ASC_IS_AIC {
        mad(c_matrix, a_matrix, b_matrix, m, k, n, static_cast<uint8_t>(unit_flag_mode), k_direction_align,
    ...
    asc_unit_flag_mode unit_flag_mode, bool k_direction_align, bool c_matrix_source, bool c_matrix_init_val)
{
    if ASC_IS_AIC {
        mad_s4(
            c_matrix, (__ca__ void*)a_matrix, (__cb__ void*)b_matrix, m, k, n, static_cast<uint8_t>(unit_flag_mode),
            k_direction_align, c_matrix_source, c_matrix_init_val);
    }
}
