...
#warning \
    "impl/c_api/memory_base_impl/sys_var_intf_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "c_api/asc_simd.h"" and use public functions or variables defined in interface headers files."
#define ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS_ASCENDC
#endif

#ifndef IMPL_C_API_MEMORY_BASE_IMPL_SYS_VAR_INTF_IMPL_H
#define IMPL_C_API_MEMORY_BASE_IMPL_SYS_VAR_INTF_IMPL_H
...
__aicore__ inline int64_t asc_get_block_idx() { return get_block_idx(); }

ASC_DEPRECATED(9.2.0, "2027/09/07", block_num)
__aicore__ inline int64_t asc_get_block_num() { return get_block_num(); }

__aicore__ inline uint64_t asc_get_phy_buf_addr(uint64_t offset) { return get_imm(offset); }

__aicore__ inline uint64_t asc_get_overflow_status() { return get_overflow_status(); }
...
__aicore__ inline void asc_get_arch_ver(uint32_t& core_version) { core_version = 2201U; }

__aicore__ inline int64_t asc_get_program_counter() { return get_pc(); }

__aicore__ inline int64_t asc_get_ffts_base_addr() { return get_ffts_base_addr(); }

__aicore__ inline void asc_set_ffts_base_addr(uint64_t config) { set_ffts_base_addr(config); }
