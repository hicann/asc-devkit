...
#warning \
    "impl/c_api/reg_base_impl/storealign_intf_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "c_api/asc_simd.h"" and use public functions or variables defined in interface headers files."
#define ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS_ASCENDC
#endif

#ifndef IMPL_C_API_REG_BASE_IMPL_STOREALIGN_INTF_IMPL_H
#define IMPL_C_API_REG_BASE_IMPL_STOREALIGN_INTF_IMPL_H

#include "impl/c_api/reg_base_impl/utils_impl.h"

#if defined(__NPU_ARCH__) && (__NPU_ARCH__ == 3510)
#include "impl/c_api/reg_base_impl/npu_arch_3510/storealign_intf_impl.h"
#endif
...
{
    asc_storealign_squeeze_status(dst, 0);
}
...
{
    if ASC_IS_AIV {
        vsts(src, dst, offset, PK4_B32, mask);
    }
}
...
{
    if ASC_IS_AIV {
        vst(src, dst, offset, PK4_B32, mask);
    }
}
...
{
    if ASC_IS_AIV {
        vsts(src, dst, offset, PK4_B32, mask, POST_UPDATE);
    }
}
