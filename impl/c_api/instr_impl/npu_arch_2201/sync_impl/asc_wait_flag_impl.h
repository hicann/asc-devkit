...
#warning \
    "c_api/instr_impl/npu_arch_2201/sync_impl/asc_wait_flag_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "c_api/asc_simd.h"" and use public functions or variables defined in interface headers files."
#define ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS_ASCENDC
#endif

#ifndef IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_SYNC_IMPL_ASC_WAIT_FLAG_IMPL_H
#define IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_SYNC_IMPL_ASC_WAIT_FLAG_IMPL_H
...
__aicore__ inline void asc_sync_wait_impl(pipe_t pipe, pipe_t tpipe, event_t id)
{
    if ASC_IS_AIC {
