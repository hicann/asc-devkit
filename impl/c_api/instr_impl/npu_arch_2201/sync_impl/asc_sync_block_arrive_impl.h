...
#warning \
    "impl/c_api/instr_impl/npu_arch_2201/sync_impl/asc_sync_block_arrive_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "c_api/asc_simd.h"" and use public functions or variables defined in interface headers files."
...
__aicore__ inline void asc_sync_block_arrive_impl(pipe_t pipe, int64_t flag_id)
{
