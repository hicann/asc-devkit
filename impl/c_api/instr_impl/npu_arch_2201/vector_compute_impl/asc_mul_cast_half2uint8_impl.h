...
/* !
 * \file asc_mul_cast_half2uint8_impl.h
 * \brief
 */
...
#ifndef IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_IMPL_ASC_MUL_CAST_HALF2UINT8_IMPL_H
#define IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_IMPL_ASC_MUL_CAST_HALF2UINT8_IMPL_H

#include "impl/c_api/instr_impl/npu_arch_2201/utils_impl/utils_impl.h"

__aicore__ inline void asc_mul_cast_half2uint8_impl(
...
__aicore__ inline void asc_mul_cast_half2uint8_sync_impl(
    __ubuf__ uint8_t* dst, __ubuf__ half* src0, __ubuf__ half* src1, uint32_t count)
{
