...
#ifndef IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_ASC_HALF2FLOAT_IMPL_H
#define IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_ASC_HALF2FLOAT_IMPL_H

#include "impl/c_api/instr_impl/npu_arch_2201/utils_impl/utils_impl.h"

__aicore__ inline void asc_half2float_impl(
...
__aicore__ inline void asc_half2float_impl(__ubuf__ float* dst, __ubuf__ half* src, uint32_t count)
{
...
__aicore__ inline void asc_half2float_sync_impl(__ubuf__ float* dst, __ubuf__ half* src, uint32_t count)
{
