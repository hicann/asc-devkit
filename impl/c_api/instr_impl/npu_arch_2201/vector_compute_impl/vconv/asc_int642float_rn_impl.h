...
#ifndef IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_ASC_INT642FLOAT_RN_IMPL_H
#define IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_ASC_INT642FLOAT_RN_IMPL_H

#include "impl/c_api/instr_impl/npu_arch_2201/utils_impl/utils_impl.h"

__aicore__ inline void asc_int642float_rn_impl(
...
__aicore__ inline void asc_int642float_rn_impl(__ubuf__ float* dst, __ubuf__ int64_t* src, uint32_t count)
{
    asc_set_mask_count_begin(count);
    asc_int642float_rn_impl(
...
__aicore__ inline void asc_int642float_rn_sync_impl(__ubuf__ float* dst, __ubuf__ int64_t* src, uint32_t count)
{
