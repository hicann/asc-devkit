...
/* !
 * \file asc_int322float_rna_impl.h
 * \brief
 */
...
#ifndef IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_ASC_INT322FLOAT_RNA_IMPL_H
#define IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_ASC_INT322FLOAT_RNA_IMPL_H

#include "impl/c_api/instr_impl/npu_arch_2201/utils_impl/utils_impl.h"

__aicore__ inline void asc_int322float_rna_impl(
...
__aicore__ inline void asc_int322float_rna_impl(__ubuf__ float* dst, __ubuf__ int32_t* src, uint32_t count)
{
...
__aicore__ inline void asc_int322float_rna_sync_impl(__ubuf__ float* dst, __ubuf__ int32_t* src, uint32_t count)
{
