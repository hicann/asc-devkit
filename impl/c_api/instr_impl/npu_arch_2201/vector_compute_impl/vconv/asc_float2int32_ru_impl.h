...
#ifndef IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_FLOAT2INT32_RU_IMPL_H
#define IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_FLOAT2INT32_RU_IMPL_H
#include "impl/c_api/instr_impl/npu_arch_2201/utils_impl/utils_impl.h"

__aicore__ inline void asc_float2int32_ru_impl(
...
__aicore__ inline void asc_float2int32_ru_count_impl(__ubuf__ int32_t* dst, __ubuf__ float* src, uint32_t count)
{
    asc_set_mask_count_begin(count);
    asc_float2int32_ru_impl(
...
__aicore__ inline void asc_float2int32_ru_sync_impl(__ubuf__ int32_t* dst, __ubuf__ float* src, uint32_t count)
{
