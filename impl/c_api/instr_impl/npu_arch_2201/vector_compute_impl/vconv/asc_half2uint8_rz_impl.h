...
#ifndef IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_ASC_HALF2UINT8_RZ_IMPL_H
#define IMPL_C_API_INSTR_IMPL_NPU_ARCH_2201_VECTOR_COMPUTE_VCONV_ASC_HALF2UINT8_RZ_IMPL_H

#include "impl/c_api/instr_impl/npu_arch_2201/utils_impl/utils_impl.h"

__aicore__ inline void asc_half2uint8_rz_impl(
...
__aicore__ inline void asc_half2uint8_rz_impl(__ubuf__ uint8_t* dst, __ubuf__ half* src, uint32_t count)
{
    asc_set_mask_count_begin(count);
    asc_half2uint8_rz_impl(
...
__aicore__ inline void asc_half2uint8_rz_sync_impl(__ubuf__ uint8_t* dst, __ubuf__ half* src, uint32_t count)
{
