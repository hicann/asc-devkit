...
#warning \
    "impl/c_api/instr_impl/npu_arch_2201/vector_datamove_impl/asc_copy_gm2ub_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use "#include "c_api/asc_simd.h"" and use public functions or variables defined in interface headers files."
...
{
    asc_copy_gm2ub_impl(dst, src, 1, size / ASC_C_API_ONE_DATABLOCK_SIZE, 0, 0);
}
