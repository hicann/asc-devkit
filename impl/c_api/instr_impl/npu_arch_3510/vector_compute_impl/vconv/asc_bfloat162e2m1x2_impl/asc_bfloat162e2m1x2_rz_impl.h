...
#pragma message( \
    "impl/c_api/instr_impl/npu_arch_3510/vector_compute_impl/vconv/asc_bfloat162e2m1x2_rz_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use \"#include \"c_api/asc_simd.h\"\" and use public functions or variables defined in interface headers files.")
#define ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS_ASCENDC
#endif

#ifndef IMPL_CAPI_INSTR_IMPL_NPU_ARCH_3510_VECTOR_COMPUTE_IMPL_VCON_ASC_BFLOAT162E2M1X2_IMPL_ASC_BFLOAT162E2M1X2_RZ_IMPL_H
#define IMPL_CAPI_INSTR_IMPL_NPU_ARCH_3510_VECTOR_COMPUTE_IMPL_VCON_ASC_BFLOAT162E2M1X2_IMPL_ASC_BFLOAT162E2M1X2_RZ_IMPL_H

#include "impl/c_api/instr_impl/npu_arch_3510/utils_impl.h"

__simd_callee__ inline void asc_bfloat162e2m1x2_rz_impl(
...
__simd_callee__ inline void asc_bfloat162e2m1x2_rz_v2_impl(
    vector_fp4x2_e2m1_t& dst, vector_bfloat16_t src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_bfloat162e2m1x2_rz_v3_impl(
    vector_fp4x2_e2m1_t& dst, vector_bfloat16_t src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_bfloat162e2m1x2_rz_v4_impl(
    vector_fp4x2_e2m1_t& dst, vector_bfloat16_t src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline vector_fp4x2_e2m1_t asc_bfloat162e2m1x2_rz_impl(
