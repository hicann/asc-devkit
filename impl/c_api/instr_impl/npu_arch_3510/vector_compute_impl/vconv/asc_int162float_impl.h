 ...
 * \brief
 */
#ifndef IMPL_C_API_INSTR_IMPL_NPU_ARCH_3510_VECTOR_COMPUTE_IMPL_ASC_INT162FLOAT_IMPL_H
#define IMPL_C_API_INSTR_IMPL_NPU_ARCH_3510_VECTOR_COMPUTE_IMPL_ASC_INT162FLOAT_IMPL_H

#include "impl/c_api/instr_impl/npu_arch_3510/utils_impl.h"

__simd_callee__ inline void asc_int162float_impl(vector_float& dst, vector_int16_t src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_int162float_v2_impl(vector_float& dst, vector_int16_t src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_int162float_impl(
