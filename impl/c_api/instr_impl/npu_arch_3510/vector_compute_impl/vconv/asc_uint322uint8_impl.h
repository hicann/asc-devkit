...
__simd_callee__ inline void asc_uint322uint8_impl(
...
__simd_callee__ inline void asc_uint322uint8_sat_impl(
    vector_uint8_t& dst, vector_uint32_t src, vector_bool mask,
    std::integral_constant<asc_position_quarter_mode, asc_position_quarter_mode::DISPERSE_FIRST_QUARTER>
        dst_quarter_pos)
{
...
__simd_callee__ inline vector_uint8_t asc_uint322uint8_impl(
...
__simd_callee__ inline vector_uint8_t asc_uint322uint8_sat_impl(
    vector_uint32_t src, vector_bool mask,
    std::integral_constant<asc_position_quarter_mode, asc_position_quarter_mode::DISPERSE_FIRST_QUARTER>
        dst_quarter_pos)
{
