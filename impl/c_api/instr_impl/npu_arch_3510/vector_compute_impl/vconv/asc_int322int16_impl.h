...
__simd_callee__ inline void asc_int322int16_impl(
...
__simd_callee__ inline void asc_int322int16_sat_impl(
    vector_int16_t& dst, vector_int32_t src, vector_bool mask,
    std::integral_constant<asc_position_mode, asc_position_mode::EVEN> dst_pos)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline vector_int16_t asc_int322int16_impl(
...
__simd_callee__ inline vector_int16_t asc_int322int16_sat_impl(
    vector_int32_t src, vector_bool mask, std::integral_constant<asc_position_mode, asc_position_mode::EVEN> dst_pos)
{
    vector_int16_t dst;
