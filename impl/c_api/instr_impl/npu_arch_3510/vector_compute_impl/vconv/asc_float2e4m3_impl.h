...
#pragma message( \
    "impl/c_api/instr_impl/npu_arch_3510/vector_compute_impl/vconv/asc_float2e4m3_rn_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use \"#include \"c_api/asc_simd.h\"\" and use public functions or variables defined in interface headers files.")
...
__simd_callee__ inline void asc_float2e4m3_rn_impl(vector_fp8_e4m3fn_t& dst, vector_float src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_float2e4m3_rn_sat_v2_impl(vector_fp8_e4m3fn_t& dst, vector_float src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_float2e4m3_rn_v2_impl(vector_fp8_e4m3fn_t& dst, vector_float src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_float2e4m3_rn_sat_v3_impl(vector_fp8_e4m3fn_t& dst, vector_float src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_float2e4m3_rn_v3_impl(vector_fp8_e4m3fn_t& dst, vector_float src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_float2e4m3_rn_sat_v4_impl(vector_fp8_e4m3fn_t& dst, vector_float src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_float2e4m3_rn_v4_impl(vector_fp8_e4m3fn_t& dst, vector_float src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline vector_fp8_e4m3fn_t asc_float2e4m3_rn_impl(
...
__simd_callee__ inline vector_fp8_e4m3fn_t asc_float2e4m3_rn_sat_impl(
    vector_float src, vector_bool mask,
    std::integral_constant<asc_position_quarter_mode, asc_position_quarter_mode::DISPERSE_FIRST_QUARTER>
        dst_quarter_pos)
{
