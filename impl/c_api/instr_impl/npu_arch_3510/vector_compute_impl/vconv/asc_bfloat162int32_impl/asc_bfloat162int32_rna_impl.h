...
__simd_callee__ inline void asc_bfloat162int32_rna_impl(
    vector_int32_t& dst, vector_bfloat16_t src, vector_bool mask,
...
__simd_callee__ inline vector_int32_t asc_bfloat162int32_rna_impl(
...
__simd_callee__ inline vector_int32_t asc_bfloat162int32_rna_sat_impl(
    vector_bfloat16_t src, vector_bool mask, std::integral_constant<asc_position_mode, asc_position_mode::EVEN> src_pos)
{
    vector_int32_t dst;
