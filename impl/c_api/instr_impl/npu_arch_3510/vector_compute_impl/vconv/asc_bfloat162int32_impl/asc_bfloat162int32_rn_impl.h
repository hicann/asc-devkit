...
/* !
 * \file asc_bfloat162int32_rn_impl.h
 * \brief
 */

#if !defined(ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS)
#pragma message( \
    "impl/c_api/instr_impl/npu_arch_3510/vector_compute_impl/asc_bfloat162int32_impl/asc_bfloat162int32_rn_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use \"#include \"c_api/asc_simd.h\"\" and use public functions or variables defined in interface headers files.")
...
__simd_callee__ inline void asc_bfloat162int32_rn_sat_impl(vector_int32_t& dst, vector_bfloat16_t src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_bfloat162int32_rn_v2_impl(vector_int32_t& dst, vector_bfloat16_t src, vector_bool mask)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline void asc_bfloat162int32_rn_sat_v2_impl(
...
__simd_callee__ inline void asc_bfloat162int32_rn_impl(
    vector_int32_t& dst, vector_bfloat16_t src, vector_bool mask,
...
__simd_callee__ inline void asc_bfloat162int32_rn_sat_impl(
    vector_int32_t& dst, vector_bfloat16_t src, vector_bool mask,
    std::integral_constant<asc_position_mode, asc_position_mode::EVEN> src_pos)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline vector_int32_t asc_bfloat162int32_rn_impl(
...
__simd_callee__ inline vector_int32_t asc_bfloat162int32_rn_sat_impl(
    vector_bfloat16_t src, vector_bool mask, std::integral_constant<asc_position_mode, asc_position_mode::EVEN> src_pos)
{
    vector_int32_t dst;
