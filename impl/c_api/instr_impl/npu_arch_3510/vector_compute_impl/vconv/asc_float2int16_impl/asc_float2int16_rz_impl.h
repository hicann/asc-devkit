...
#pragma message( \
    "impl/c_api/instr_impl/npu_arch_3510/vector_compute_impl/vconv/asc_float2int16_rz_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use \"#include \"c_api/asc_simd.h\"\" and use public functions or variables defined in interface headers files.")
#define ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS
#define UNDEF_ASCENDC_C_API_INCLUDE_COMPILER_INTERNAL_HEADERS_ASCENDC
#endif

#ifndef IMPL_CAPI_INSTR_IMPL_NPU_ARCH_3510_VECTOR_COMPUTE_IMPL_VCON_ASC_FLOAT2INT16_IMPL_ASC_FLOAT2INT16_RZ_IMPL_H
#define IMPL_CAPI_INSTR_IMPL_NPU_ARCH_3510_VECTOR_COMPUTE_IMPL_VCON_ASC_FLOAT2INT16_IMPL_ASC_FLOAT2INT16_RZ_IMPL_H
...
__simd_callee__ inline void asc_float2int16_rz_impl(
...
__simd_callee__ inline void asc_float2int16_rz_sat_impl(
    vector_int16_t& dst, vector_float src, vector_bool mask,
    std::integral_constant<asc_position_mode, asc_position_mode::EVEN> dst_pos)
{
    if ASC_IS_AIV {
...
__simd_callee__ inline vector_int16_t asc_float2int16_rz_impl(
...
__simd_callee__ inline vector_int16_t asc_float2int16_rz_sat_impl(
    vector_float src, vector_bool mask, std::integral_constant<asc_position_mode, asc_position_mode::EVEN> dst_pos)
{
    vector_int16_t dst;
