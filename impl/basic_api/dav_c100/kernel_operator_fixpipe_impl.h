...
#pragma message( \
    "impl/basic_api/dav_c100/kernel_operator_fixpipe_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_tensor.h\"\" and use public functions or variables defined in interface headers files.")
...
[[deprecated(
    "NOTICE: Fixpipe is not deprecated. Currently, Fixpipe is an unsupported API on current device. Please check "
...
__aicore__ inline void FixpipeL0C2UBImpl(__ubuf__ T* dst, __cc__ U* src, const FixpipeParamsV220& intriParams)
{
    ASCENDC_DEBUG_ASSERT(
        false, KERNEL_LOG_INTERNAL(KERNEL_ERROR, "Fixpipe doesn't support L0C to UB on current device\n"));
}
