...
/* !
 * \file kernel_reg_compute_vec_cmpsel_intf_impl.h
 * \brief
 */

#if !defined(__ASCENDC_INCLUDE_INTERNAL_HEADERS__)
#pragma message( \
    "impl/basic/reg_compute/kernel_reg_compute_vec_cmpsel_intf_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file maybe removed in the future. Please use \"#include \"reg_compute/kernel_reg_compute_vec_cmpsel_intf.h\"\" and use public functions or variables defined in interface headers files.")
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_KERNEL_REG_COMPUTE_VEC_CMPSEL_INTF_IMPL__
#endif

#ifndef ASCENDC_KERNEL_REG_COMPUTE_VEC_CMPSEL_INTERFACE_IMPL_H
#define ASCENDC_KERNEL_REG_COMPUTE_VEC_CMPSEL_INTERFACE_IMPL_H
...
#include "../../basic_api/reg_compute/dav_v516/kernel_reg_compute_vec_cmpsel_impl.h"
#else
#include "../../basic_api/reg_compute/dav_3510/kernel_reg_compute_vec_cmpsel_impl.h"
#endif
...
#endif // ASCENDC_KERNEL_REG_COMPUTE_VEC_CMPSEL_INTERFACE_IMPL_H

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_KERNEL_REG_COMPUTE_VEC_CMPSEL_INTF_IMPL__)
