...
#pragma message( \
    "impl/basic_api/dav_m300/kernel_operator_sys_var_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_operator_intf.h\"\" and use public functions or variables defined in interface headers files.")
...
__aicore__ inline int64_t GetBlockIdxImpl() { return get_block_idx(); }

__aicore__ inline void GetArchVersionImpl(uint32_t& coreVersion) { coreVersion = 3002U; }
...
__aicore__ inline void TrapImpl() { ASCENDC_REPORT_NOT_SUPPORT(false, "Trap"); }
} // namespace AscendC
