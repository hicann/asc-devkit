...
#pragma message( \
    "impl/basic_api/dav_v516/kernel_operator_vec_reduce_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_vec_intf.h\"\" and use public functions or variables defined in interface headers files.")
...
__aicore__ inline void GenPredicate(Reg::MaskReg& preg, uint32_t maskReg)
{
...
__aicore__ inline void ReduceCommonCall(
...
__aicore__ inline void ReduceAlignCall(
...
__aicore__ inline void ReduceUnalignCall(
...
template <typename T>
__aicore__ inline void ReduceB64SumImpl(
...
__aicore__ inline void ReduceNoIndexTemplate(
    __ubuf__ T* dstLocal, __ubuf__ T* srcLocal, __ubuf__ T* workLocal, uint32_t count, const int32_t srcRepStride,
    T initValue)
{
    constexpr uint16_t oneRepSize = GetVecLen() / sizeof(T);
...
__aicore__ inline void ReduceIndexTemplate(
    __ubuf__ T* dstLocal, __ubuf__ T* srcLocal, __ubuf__ T* workLocal, uint32_t count, const int32_t srcRepStride,
    T initValue)
{
    constexpr uint16_t oneRepSize = GetVecLen() / sizeof(T);
