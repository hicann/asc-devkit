...
#pragma message( \
    "impl/basic_api/dav_v516/kernel_operator_vec_unary_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_vec_intf.h\"\" and use public functions or variables defined in interface headers files.")
    ...
    const UnaryRepeatParams& repeatParams)
{
    ...
    if (Internal::IsCounterMode()) {
        ...
        VF_CALL<VecUnaryLevel0VFImpl<func, isSetMask, isMaskBitMode, false, T>>(
        ...
        VF_CALL<VecUnaryLevel0VFImpl<func, isSetMask, isMaskBitMode, true, T>>(
            dst, src, maskArray, maskCount, repeatTime, repeatParams, maskBuf);
...
namespace RegRsqrt {
template <typename T, typename RegT, bool precisionMode = false>
__aicore__ inline void Rsqrt(RegT& dstReg, RegT& srcReg, Reg::MaskReg& mask)
{
    Reg::MaskReg cmpMask;
