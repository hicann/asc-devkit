...
#pragma message( \
    "impl/basic_api/dav_v516/kernel_operator_vec_template_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_vec_intf.h\"\" and use public functions or variables defined in interface headers files.")
...
__aicore__ inline uint32_t VecMicroGetCount(
...
__aicore__ inline void VecBinaryVFImpl(
    __ubuf__ T* dst, __ubuf__ U* src0, __ubuf__ U* src1, const uint64_t maskArray[], const uint64_t maskCount,
    const uint8_t repeatTime, const BinaryRepeatParams& repeatParams, __ubuf__ uint64_t* maskBuf);
    ...
    const uint8_t repeatTime, const BinaryRepeatParams& repeatParams)
{
    ...
    if (Internal::IsCounterMode()) {
        ...
        VF_CALL<VecBinaryVFImpl<func, isSetMask, isMaskBitMode, false, funcMode, T, U>>(
        ...
        VF_CALL<VecBinaryVFImpl<func, isSetMask, isMaskBitMode, true, funcMode, T, U>>(
            dst, src0, src1, maskArray, maskCount, repeatTime, repeatParams, maskBuf);
