 ...
 * \brief
 */
#ifndef IMPL_UTILS_DEBUG_NPU_ARCH_3002_ASC_DEBUG_UTILS_H
#define IMPL_UTILS_DEBUG_NPU_ARCH_3002_ASC_DEBUG_UTILS_H
...
{
    // keep the same block index rule as the dump tensor ring buffer of 3002
    constexpr uint32_t dumpCoreNums = 75;
    return (get_block_idx() & 0x00FF) % dumpCoreNums;
}

__aicore__ inline uint64_t asc_debug_get_block_idx_impl() { return static_cast<uint64_t>(get_block_idx()); }
...
#endif // IMPL_UTILS_DEBUG_NPU_ARCH_3002_ASC_DEBUG_UTILS_H
