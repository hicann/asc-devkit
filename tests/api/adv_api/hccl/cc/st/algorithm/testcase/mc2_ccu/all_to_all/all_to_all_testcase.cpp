...
// ===== 拓扑泛化（FP16, CcuAlltoAllMesh1D）=====
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Fp16_100B)
{
    TopoMeta topo{{{{0, 1}}}};
    CcuStScenario scenario = MakeScenario(topo, HCCL_DATA_TYPE_FP16, 100);
    scenario.expectedAlgName = "CcuAlltoAllMesh1D";
    VerifyScenario(scenario);
}

TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_4Rank_SingleDie_Fp16_64B)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_8Rank_SingleDie_Fp16_64B)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Fp32_100B)
{
    TopoMeta topo{{{{0, 1}}}};
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Int8_100B)
{
    TopoMeta topo{{{{0, 1}}}};
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Int32_100B)
{
    TopoMeta topo{{{{0, 1}}}};
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Bfp16_100B)
{
    TopoMeta topo{{{{0, 1}}}};
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Fp16_1KB)
{
    TopoMeta topo{{{{0, 1}}}};
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_1B)
{
    TopoMeta topo{{{{0, 1}}}};
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_MemSliceMinus1)
{
    TopoMeta topo{{{{0, 1}}}};
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_MemSlice)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_MemSlicePlus1)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_LoopSizeMinus1)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_LoopSize)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_LoopSizePlus1)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_2xLoopSize)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_2xLoopSizePlus1)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_GroupCopy_Boundary_LoopSizePlusMemSlice)
{
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Fp16_1MB)
{
    TopoMeta topo{{{{0, 1}}}};
...
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Fp16_10MB)
{
    TopoMeta topo{{{{0, 1}}}};
...
// ===== 边界条件 =====
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_2Rank_SingleDie_Fp16_0B)
{
    TopoMeta topo{{{{0, 1}}}};
...
// ===== 强制算法配置 =====
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_ForcedAlg_2Rank_SingleDie_Fp16_100B)
{
    TopoMeta topo{{{{0, 1}}}};
    CcuStScenario scenario = MakeScenario(topo, HCCL_DATA_TYPE_FP16, 100);
    scenario.algConfig = "CcuAlltoAllMesh1D";
    scenario.expectedAlgName = "CcuAlltoAllMesh1D";
    VerifyScenario(scenario);
}

// ===== 日志级别动态控制验证 =====
TEST_F(CcuStAllToAll, CcuAlltoAllMesh1D_LogLevel_Control_2Rank_SingleDie_Fp16_100B)
{
    TopoMeta topo{{{{0, 1}}}};
