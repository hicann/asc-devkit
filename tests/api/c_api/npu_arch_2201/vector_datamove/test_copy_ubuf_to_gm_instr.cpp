...
#define TEST_VECTOR_DATAMOVE_COPY_UBUF_TO_GM_INSTR(class_name, c_api_name, cce_name)                                   \
    ...
    void cce_name##_uint8_uint16_uint16_uint16_uint16_Stub(                                                            \
        __gm__ void* dst, __ubuf__ void* src, uint8_t sid, uint16_t burst_count, uint16_t burst_len, uint16_t src_gap, \
        uint16_t dst_gap)                                                                                              \
    {                                                                                                                  \
    ...
    {                                                                                                                  \
        ...
        uint16_t dst_gap = static_cast<uint64_t>(0);                                                                   \
                                                                                                                       \
        MOCKER_CPP(cce_name, void(__gm__ void*, __ubuf__ void*, uint8_t, uint16_t, uint16_t, uint16_t, uint16_t))      \
            .times(1)                                                                                                  \
            .will(invoke(cce_name##_uint8_uint16_uint16_uint16_uint16_Stub));                                          \
                                                                                                                       \
        c_api_name(dst, src, burst_count, burst_len, src_gap, dst_gap);                                                \
