...
#define TEST_VECTOR_COMPUTE_BINARY_INSTR(class_name, c_api_name, cce_name, data_type)                               \
    ...
    void cce_name##_##data_type##_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_Stub(                     \
        __ubuf__ data_type* dst, __ubuf__ data_type* src0, __ubuf__ data_type* src1, uint8_t repeat,                \
    ...
    {                                                                                                               \
        ...
        MOCKER_CPP(                                                                                                 \
            cce_name, void(                                                                                         \
                          __ubuf__ data_type*, __ubuf__ data_type*, __ubuf__ data_type*, uint8_t, uint8_t, uint8_t, \
...
TEST_VECTOR_COMPUTE_BINARY_INSTR(And, asc_and, vand, int16_t);
TEST_VECTOR_COMPUTE_BINARY_INSTR(And, asc_and, vand, uint16_t);
