...
#define TEST_VECTOR_COMPUTE_REDUCE_INSTR(class_name, c_api_name, cce_name, data_type)                               \
    ...
    namespace {                                                                                                     \
                                                                                                                    \
    void cce_name##_##data_type##_uint8_t_uint16_t_uint16_t_uint16_t_Stub(                                          \
    ...
    {                                                                                                               \
        ...
        uint8_t repeat = 1;                                                                                         \
                                                                                                                    \
        MOCKER_CPP(cce_name, void(__ubuf__ data_type*, __ubuf__ data_type*, uint8_t, uint16_t, uint16_t, uint16_t)) \
            .times(1)                                                                                               \
...
TEST_VECTOR_COMPUTE_REDUCE_INSTR(DataBlockReduceSum, asc_datablock_reduce_sum, vcgadd, half);
TEST_VECTOR_COMPUTE_REDUCE_INSTR(DataBlockReduceSum, asc_datablock_reduce_sum, vcgadd, float);

TEST_VECTOR_COMPUTE_REDUCE_INSTR(DataBlockReduceMax, asc_datablock_reduce_max, vcgmax, half);
TEST_VECTOR_COMPUTE_REDUCE_INSTR(DataBlockReduceMax, asc_datablock_reduce_max, vcgmax, float);

TEST_VECTOR_COMPUTE_REDUCE_INSTR(DataBlockReduceMin, asc_datablock_reduce_min, vcgmin, half);
TEST_VECTOR_COMPUTE_REDUCE_INSTR(DataBlockReduceMin, asc_datablock_reduce_min, vcgmin, float);
