...
TEST(RegConvertPositionOverloads, AcceptAllLegalPositionArguments)
{
    ...
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_int4x22int16, vector_int16_t, vector_int4x2_t);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_int4x22half, vector_half, vector_int4x2_t);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_int4x22bfloat16, vector_bfloat16_t, vector_int4x2_t);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_rd, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_rd_sat, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_rn, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_rn_sat, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_rna, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_rna_sat, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_ru, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_ru_sat, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_rz, vector_int4x2_t, vector_half);
    CHECK_QUARTER_POSITION_ARGUMENTS(asc_half2int4x2_rz_sat, vector_int4x2_t, vector_half);
