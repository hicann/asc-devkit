...
TEST_F(Tensor_Api_Frame_Layout, NDAndDNGroupIntegralConstantTrait)
{
    ...
    auto ndLayout = MakeFrameLayout<NDLayoutPtn, _16>(8, 16);
    auto dnLayout = MakeFrameLayout<DNLayoutPtn, _16>(8, 16);
    auto ndExtLayout = MakeFrameLayout<NDExtLayoutPtn, _16>(8, 16);
    auto dnExtLayout = MakeFrameLayout<DNExtLayoutPtn, _16>(8, 16);
...
TEST_F(Tensor_Api_Frame_Layout, OtherGroupIntegralConstantTrait)
{
    ...
    auto nzLayout = MakeFrameLayout<NZLayoutPtn, _16>(32, 64);
    auto znLayout = MakeFrameLayout<ZNLayoutPtn, _16>(32, 64);
    auto zzLayout = MakeFrameLayout<ZZLayoutPtn, _16>(32, 64);
    auto nnLayout = MakeFrameLayout<NNLayoutPtn, _2>(16, 32);
