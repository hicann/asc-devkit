...
// squeeze must preserve the original layout's Pattern/trait_type. A batch NZ layout (batch_value,
// ((16,m_value),(16,n_value))) with batch_value=1, squeezed on the batch axis, must keep nz_layout_ptn on the result
// (mode 1 by index).
