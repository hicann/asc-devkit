...
TEST_F(tensor_api_cube_copy_l1_to_l0scaleb_3510, copy_l1_to_l0scaleb_routes_to_cube_arch_copy)
{
    ...
    run_copy_call_paths<copy_l1_to_l0scaleb, copy_l1_to_l0scaleb_trait_default>(l0b_tensor, l1_tensor);
    run_copy_with_paths<copy_l1_to_l0scaleb, copy_l1_to_l0scaleb_trait_default>(l0b_tensor, l1_tensor);
...
TEST_F(tensor_api_cube_copy_l1_to_l0scaleb_3510, copy_l1_to_l0scaleb_batch)
{
    ...
    copy(copy_atom<copy_traits<copy_l1_to_l0scaleb, copy_l1_to_l0scaleb_trait_default>>{}, l0b_tensor, l1_tensor);
