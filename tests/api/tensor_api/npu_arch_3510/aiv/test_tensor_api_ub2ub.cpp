...
TEST_F(tensor_api_vector_copy_3510, copy_ub_to_ub_nd_to_nd)
{
    ...
    run_copy_call_paths<copy_ub_to_ub, copy_ub_to_ub_trait_default>(dst_tensor, src_tensor);
    run_copy_with_paths<copy_ub_to_ub, copy_ub_to_ub_trait_default>(dst_tensor, src_tensor);
