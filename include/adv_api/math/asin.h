...
/*!
 * \file asin.h
 * \brief Defines a series of interface used to do elementwise math arcsin calculation.
 * Formula: Asin(x) = arcsin(x)
...
#error "asin.h cannot be used with compile flag --enable-simt enabled."
#endif
...
/*!
 * \ingroup Asin
 * \brief compute Asin elementwisely
 * \tparam T: half/float
 ...
 *             whose required space size should refer to corresponding tiling API, which is defined at asin_tiling.h.
...
/*!
 * \ingroup Asin
 * \brief compute Asin elementwisely for whole source tensor
 * \tparam T: half/float
 * \tparam isReuseSource: whether allows API to modify source data, usually for performance reason
 * \param [out] dstTensor: output LocalTensor
 * \param [in] srcTensor: input LocalTensor
