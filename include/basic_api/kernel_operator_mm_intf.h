...
#error "kernel_operator_mm_intf.h cannot be used with compile flag --enable-simt enabled."
#endif
...
#if defined(__NPU_ARCH__) && ((__NPU_ARCH__ == 3510) || (__NPU_ARCH__ == 5102) || (__NPU_ARCH__ == 5161) || \
